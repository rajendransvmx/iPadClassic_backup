...
ChatterDelegate,
SFWToolBarDelegate,RefreshSyncStatusButton,AssetsImageDelegate>
{
...
@property (nonatomic, retain) AssetsImageController *imageAsset;
@property (nonatomic, retain) UIPopoverController *imagePickerPopover;
@property (nonatomic , retain) IBOutlet UIView *attachmentEditView;
@property (nonatomic , retain) IBOutlet UIImageView *attachmentEditImageView;
@property (nonatomic , retain) IBOutlet UITextField *attachmentEditTextField;
@property (nonatomic , retain) IBOutlet UILabel *attachmentEditSize;
...
#define SHOW_ALL_CAMERA                     6 //Camera
#define SHOW_CAMERA_ROW                     7 //Camera 
