...
@interface CalendarDatabase : NSObject
{
    ...
    BOOL didAttachmentSuccessful;
    BOOL didAttachmentSuccessfulSent;
}
...
- (void) getSFIdForCameraAttachment:(NSString *)localId objectName:(NSString *)objectName;
- (void) sendAttachmentToSFDC:(NSString *)SFId withFileName:(NSString *)name fileType:(NSString *)fileType;
