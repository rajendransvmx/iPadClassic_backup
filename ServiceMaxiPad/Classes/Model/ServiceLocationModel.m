...
- (id)initWithAddressDictionary:(NSDictionary*)dictionary {
    ...
    if (self)
    {
        self.street            = (([dictionary objectForKey:kWorkOrderSTREET]!=[NSNull null])? [dictionary objectForKey:kWorkOrderSTREET]:@"");
        self.city              = (([dictionary objectForKey:kWorkOrderCITY]!=[NSNull null])? [dictionary objectForKey:kWorkOrderCITY]:@"");
        self.state             = (([dictionary objectForKey:kWorkOrderSTATE]!=[NSNull null])? [dictionary objectForKey:kWorkOrderSTATE]:@"");
        self.country           = (([dictionary objectForKey:kWorkOrderCOUNTRY]!=[NSNull null])? [dictionary objectForKey:kWorkOrderCOUNTRY]:@"");
        self.zip               = (([dictionary objectForKey:kWorkOrderZIP]!=[NSNull null])? [dictionary objectForKey:kWorkOrderZIP]:@"");
        self.serviceLocation   = [self serviceLocationAddress];
