...
- (void)reachabilityStatus
{
    ...
    NSString* internetStatusString;
    internetStatusString = ( inetStatus == ReachableViaWWAN) ? @"Reachable WWAN" : ( ( inetStatus == ReachableViaWiFi) ? @"Reachable WiFi" : @"Access Not Available");
    ...
    NSString *hostStatusString;
    hostStatusString = (hostStatus == ReachableViaWWAN) ? @"Reachable WWAN" : ( ( hostStatus == ReachableViaWiFi) ? @"Reachable WiFi" : @"Access Not Available");
...
- (void)initializeNetworkStatus
{
     SXLogDebug(@"Initialize NetworkStatus ");
 // Reachability check for internet
    if (self.internetReach == nil)
    {
        self.internetReach = [Reachability reachabilityForInternetConnection];
