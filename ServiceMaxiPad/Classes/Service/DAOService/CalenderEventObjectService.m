...
- (NSArray*)getRecordsFromTheQuery:(DBRequestSelect *)selectQuery
{
    ...
    SXLogInfo(@"CalenderEventObject query: %@", selectQuery.query);
    ...
    [queue inTransaction:^(SMDatabase *db, BOOL *rollback) {
        ...
        while ([resultSet next]) {
            ...
            model.eventObject = selectQuery.tableName;
...
- (NSArray *)fetchDataForObject:(NSString *)objectName  fields:(NSArray *)fieldNames expression:(NSString *)advancaeExpression criteria:(NSArray *)criteria
{
    ...
    NSArray * detailsArray = [self getRecordsFromTheQuery:selectQuery];
    return detailsArray;
}
...
- (TransactionObjectModel *)getRecordForSalesforceId:(NSString *)salesforceId {
    ...
    if (model.objectName != nil) {
        ...
        DBCriteria * innerCriteria = [[DBCriteria alloc] initWithFieldName:@"Id" operatorType:SQLOperatorLike andFieldValue:salesforceId];
...
-(NSString *)getObjectName:(NSString *)salesforceId {
...
-(BOOL)updateEachRecord:(NSDictionary *)dictionary  withFields:(NSArray *)fieldsArray withCriteria:(NSArray *)criteriaArray withTableName:(NSString *)tableName
{
    ...
    SXLogInfo(@"update query: %@",[updatequery query]);
