...
- (void)insertIntoDBWithObjectName:(NSString *)objectName andSfIdArray:(NSArray *)sfIdArray
{
    for(NSString *sfId in sfIdArray)
    {
        ...
        DBRequestInsert *insert = [[DBRequestInsert alloc] initWithTableName:@"ProductManual" andFieldNames:array];
...
{
    DBRequestSelect * requestSelect = [[DBRequestSelect alloc] initWithTableName:@"ProductManual" andFieldNames:fieldNames whereCriteria:criteria];
...
- (NSArray *)getTheProductIdDetailsForTheProductId:(NSString *)productMId;
{
    ...
    DBRequestSelect *selectQuery = [[DBRequestSelect alloc]
                                    initWithTableName:@"ProductManual"
