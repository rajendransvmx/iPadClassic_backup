...
{
    // PCRD-73 #82
    // update 'Purge Data' button status when there is change in network connectivity status.
...
- (void)loadPurgeButton
{
    if ([[SNetworkReachabilityManager sharedInstance] isNetworkReachable])
    {
        ...
        [self.purgeDataNowButton setBackgroundColor:[UIColor getUIColorFromHexValue:@"#FF6633"]];
        [self.purgeDataNowButton setTitleColor:[UIColor getUIColorFromHexValue:@"#FFFFFF"] forState:UIControlStateNormal];
    }
    else
    {
        self.purgeDataNowButton.userInteractionEnabled = NO;
        self.purgeDataNowButton.layer.borderColor      =[UIColor getUIColorFromHexValue:@"#AEAEAE"].CGColor;
        [self.purgeDataNowButton setBackgroundColor:[UIColor getUIColorFromHexValue:@"#AEAEAE"]];
        [self.purgeDataNowButton setTitleColor:[UIColor getUIColorFromHexValue:@"#FFFFFF"] forState:UIControlStateNormal];
    }
}
