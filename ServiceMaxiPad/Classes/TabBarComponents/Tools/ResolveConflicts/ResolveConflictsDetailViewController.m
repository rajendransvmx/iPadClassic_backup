...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    headerLbl.text     = [@"" stringByAppendingFormat:@"%@ (%ld)", [[TagManager sharedInstance] tagByName:kTag_SyncConflicts],(long)self.conflictsArray.count];
...
- (void)navigateToObjectForConflict:(SyncErrorConflictModel *)conflict {
    ...
    UIBarButtonItem *backButton = [[UIBarButtonItem alloc] initWithTitle:[[TagManager sharedInstance] tagByName:kTag_ResolveConflicts] style:UIBarButtonItemStyleBordered target:nil action:nil];
    ...
    SFMPageViewManager *pageManager = [[SFMPageViewManager alloc] initWithObjectName:conflict.objectName
