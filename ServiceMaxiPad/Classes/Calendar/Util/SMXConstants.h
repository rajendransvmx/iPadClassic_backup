...
#define dictWeekNumberName @{@1:[[TagManager sharedInstance]tagByName:Tag_CAL_SUN], @2:[[TagManager sharedInstance]tagByName:Tag_CAL_MON], @3:[[TagManager sharedInstance]tagByName:Tag_CAL_TUE], @4:[[TagManager sharedInstance]tagByName:Tag_CAL_WED], @5:[[TagManager sharedInstance]tagByName:Tag_CAL_THU], @6:[[TagManager sharedInstance]tagByName:Tag_CAL_FRI], @7:[[TagManager sharedInstance]tagByName:Tag_CAL_SAT]}

#define arrayWeekAbrev @[[[TagManager sharedInstance]tagByName:kTag_s], [[TagManager sharedInstance]tagByName:kTag_m], [[TagManager sharedInstance]tagByName:kTag_t], [[TagManager sharedInstance]tagByName:kTag_w], [[TagManager sharedInstance]tagByName:kTag_thur], [[TagManager sharedInstance]tagByName:kTag_f], [[TagManager sharedInstance]tagByName:kTag_sat]]
//#define arrayWeekAbrevWithThreeChars @[@"Sun", @"Mon", @"Tue", @"Wed", @"Thu", @"Fri", @"Sat"]

#define arrayWeekAbrevWithThreeChars @[[[TagManager sharedInstance]tagByName:Tag_CAL_SUN], [[TagManager sharedInstance]tagByName:Tag_CAL_MON], [[TagManager sharedInstance]tagByName:Tag_CAL_TUE], [[TagManager sharedInstance]tagByName:Tag_CAL_WED], [[TagManager sharedInstance]tagByName:Tag_CAL_THU], [[TagManager sharedInstance]tagByName:Tag_CAL_FRI], [[TagManager sharedInstance]tagByName:Tag_CAL_SAT]]
