...
- (id)initWithEvent:(SMXEvent *)eventInit {
    ...
    UIViewController  *popoverContentTemp = [UIViewController new];
    popoverContentTemp.view = viewEditar;
    popoverContentTemp.preferredContentSize = size;
    
    self = [super initWithContentViewController:popoverContentTemp];
    
    if (self)
    {
        popoverContent = popoverContentTemp;
    }
