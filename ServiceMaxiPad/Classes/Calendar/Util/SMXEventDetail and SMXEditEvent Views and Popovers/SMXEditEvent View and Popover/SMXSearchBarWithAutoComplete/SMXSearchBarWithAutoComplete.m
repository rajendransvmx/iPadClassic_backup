//
//  SMXSearchBarWithAutoComplete.m
/**
 *  @file   FILE_NAME.m
 *  @class  CLASS_NAME
 *
...
@interface SMXSearchBarWithAutoComplete () <UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate>
@property (nonatomic, strong) NSMutableArray *arrayWithAllClients;
@end

@implementation SMXSearchBarWithAutoComplete
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [[UITextField appearanceWhenContainedIn:[SMXSearchBarWithAutoComplete class], nil] setFont:[UIFont systemFontOfSize:18.]];
        [[UITextField appearanceWhenContainedIn:[SMXSearchBarWithAutoComplete class], nil] setTextAlignment:NSTextAlignmentCenter];
    }
    return self;
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    int intRows = (int)[arrayOfTableView count];
