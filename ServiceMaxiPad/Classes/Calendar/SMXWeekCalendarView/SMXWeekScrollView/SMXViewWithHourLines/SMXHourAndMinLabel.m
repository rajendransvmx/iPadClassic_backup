...
- (void)showText {
    ...
    NSAttributedString *string = [self getString:[NSString stringWithFormat:@"%02ld:00", lHour]year:lAmPm];
...
-(void)showAttributedText{
    ...
    //[self setText:[NSString stringWithFormat:@"%02d:%02d %@", lHour, comp.minute, lAmPm]];
    [self setAttributedText:[self getString:[NSString stringWithFormat:@"%02d:%02d", (int)lHour, (int)comp.minute] year:lAmPm]];
}
