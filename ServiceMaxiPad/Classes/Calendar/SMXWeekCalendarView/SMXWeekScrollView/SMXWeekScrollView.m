...
- (void)setDictEvents:(NSMutableDictionary *)_dictEvents {
    ...
    if (!viewWithHourLines) {
        ...
        collectionViewWeek.weekCalendarDelegate=weekCalendarDelegate;
        ...
        [self addSubview:viewWithHourLines.currentTimeLayer];
        [self addSubview:labelWithActualHour];
        currentPatch=viewWithHourLines.currentTimeLayer;
        labelGrayWithActualHour = viewWithHourLines.labelWithSameYOfCurrentHour;
        [labelGrayWithActualHour setAlpha:1.];
        [labelWithActualHour setAlpha:0.];
        [viewWithHourLines.currentTimeLayer setAlpha:0.];
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [collectionViewWeek reloadIfNeeded];
