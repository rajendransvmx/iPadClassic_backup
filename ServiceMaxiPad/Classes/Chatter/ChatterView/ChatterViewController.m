...
- (void)updateLabelText:(UILabel *)label
{
    ...
    label.textColor = [UIColor getUIColorFromHexValue:@"#262626"];
}
...
{
    if (image != nil) {
        self.leftImageView.layer.borderColor = [UIColor getUIColorFromHexValue:kSeperatorLineColor].CGColor;
        self.leftImageView.layer.borderWidth = 1.0f;
        self.leftImageView.image = image;
        
        self.topImageView.layer.borderColor = [UIColor getUIColorFromHexValue:kSeperatorLineColor].CGColor;
