...
- (BOOL)shouldDoInsensitiveSearchForOperator:(NSString *) operatorString andDBCriteria:(DBCriteria *)criteria;
            ...
            for (int counter = 0; counter < [adavncedExpr length]; counter++) {
                ...
                if (![aCharacter isEqualToString:@""] && ![aCharacter isEqualToString:@" "]) {
                    ...
                    if (someIntValue > 0 && (counter + 1) < [adavncedExpr length]) {
                        ...
                        if ([self isNumber:aSecCharacter] || [aSecCharacter isEqualToString:@"0"]) {
...
- (NSString *)getExpressionForCriteriaObject:(DBCriteria *)dbCriteria {
    ...
    BOOL caseInsensitiveSearch = [self shouldDoInsensitiveSearchForOperator:operatorString andDBCriteria:dbCriteria];
    NSString *collateNocase = @"";
    if (caseInsensitiveSearch) {
        collateNocase = (NSString *)kSQLCollateNocase;
    }
...
//    if ([operatorString isEqualToString:(NSString *)kSqlOperatorEqual] || [operatorString isEqualToString:(NSString *)kSqlOperatorNotEqual]
//        || [operatorString isEqualToString:(NSString *)kSqlOperatorGreaterThan]  || [operatorString isEqualToString:(NSString *)kSqlOperatorGreaterThanEqualTo] || [operatorString isEqualToString:(NSString *)kSqlOperatorLessThan]  || [operatorString isEqualToString:(NSString *)kSqlOperatorLessThanEqualTo] ) {
//        caseInsensitive = YES;
//    }
    
    if ([operatorString isEqualToString:(NSString *)kSqlOperatorEqual] || [operatorString isEqualToString:(NSString *)kSqlOperatorNotEqual] || [operatorString isEqualToString:(NSString *)kSqlOperatorIn] || [operatorString isEqualToString:(NSString *)kSqlOperatorNotIn]
       )
    {
        caseInsensitive = YES;
    }
