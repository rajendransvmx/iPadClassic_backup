...
-(void)getDeviceInfo:(NSString *)params
{
    ...
    //Setting expected Dummy Output
    /*NSMutableDictionary *deviceInfoDict = [[NSMutableDictionary alloc] init];
    [deviceInfoDict setObject:@"False" forKey:@"barcode-enabled"];
    [deviceInfoDict setObject:@"Mobile" forKey:@"client-type"];
    [deviceInfoDict setObject:@"iOS" forKey:@"device-platform"];
     */
    //MobileDataUsageExecuter *mdExecuter = [MobileDataUsageExecuter getInstance];
    //[resp setObject:[mdExecuter getDeviceInfo] forKey:@"deviceInfo"];
...
-(void)getErrorDetails:(NSString *)params
{
    ...
    //[resp setObject:appDelegate.syncErrorDataArray forKey:@"error"];
    ...
    */
    ...
    [resp setObject:@"someErrorDict" forKey:@"exceptions"];
