...
+(BOOL)validateOrg:(NSDictionary *)APNSDict
{
    ...
    if ([orgID isEqualToString:[APNSDict objectForKey:kPulseNotificationOrgId]])
    {
        ...
        {
            UIAlertView *alert  = [[UIAlertView alloc]initWithTitle:@"Login Alert" message:[NSString stringWithFormat:@"Please login with User ID: %@ used for Pulse App", [APNSDict objectForKey:kPulseNotificationUserId]] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
            [alert show];
            isValidUser = NO;
        }
    }
    ...
    {
        UIAlertView *alert  = [[UIAlertView alloc]initWithTitle:@"Login Alert" message:[NSString stringWithFormat:@"Please login with Org Id: %@ used for Pulse App", [APNSDict objectForKey:kPulseNotificationUserId]] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
        [alert show];
        isValidUser = NO;
    }
