//
//  SFMPageUrlFieldCollectionViewCell.m
//  ServiceMaxiPad
//
...
@implementation SFMPageUrlFieldCollectionViewCell
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _hyperLinkButton =  [[UIButton alloc]initWithFrame:CGRectZero];
        [self.contentView addSubview:_hyperLinkButton];
        ...
        [_moreButton setTitleColor:[UIColor getUIColorFromHexValue:kOrangeColor] forState:UIControlStateNormal];
        [_moreButton setTitleColor:[UIColor getUIColorFromHexValue:kOrangeColor] forState:UIControlStateSelected];
...
- (void)setFrameForSubViews
{
    ...
    self.hyperLinkButton.frame = fieldValueLabelFrame;
