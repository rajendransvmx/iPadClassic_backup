...
@property(nonatomic, strong) UIImageView *lineSeparator;
...
- (void)layoutSubviews
{
    ...
    self.sectionTitle.frame = CGRectMake(15, containerFrame.origin.y + 5, containerFrame.size.width/2 + 40, containerFrame.size.height-10);
    self.rightButton.frame = CGRectMake(CGRectGetMidX(self.bounds) + 55, containerFrame.origin.y+5, containerFrame.size.width/2- 60, containerFrame.size.height-10);
