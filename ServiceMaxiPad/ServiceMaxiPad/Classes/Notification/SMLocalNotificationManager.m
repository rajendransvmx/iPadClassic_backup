...
- (void)scheduleLocalNotificationOfType:(SMLocalNotificationType)notificationType on:(NSDate *)fireDate {
    ...
    LocalNotificationModel *model = [SMLocalNotificationHelper getParametersForLocalNotificationType:notificationType];
    if (model && fireDate) {
...
- (void)handleReceivedLocalNotification:(UILocalNotification*)notification triggeredWhenAppIsRunning:(BOOL)status{
    ...
    [SMLocalNotificationHelper handleReceivedLocalNotification:notification
                                                        ofType:type
