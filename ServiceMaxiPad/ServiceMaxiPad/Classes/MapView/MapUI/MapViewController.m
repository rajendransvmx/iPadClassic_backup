...
- (void)flowStatus:(id)status
{
    if([status isKindOfClass:[WebserviceResponseStatus class]])
    {
           ...
           responseStatus.category == CategoryTypeTechnicianAddress)
        {
            ...
            {
                [self removeActivityAndLoadingLabel];
                [[AlertMessageHandler sharedInstance] showCustomMessage:[responseStatus.syncError errorEndUserMessage] withDelegate:nil title:[NSString stringWithFormat:@"%@ \n %@", KMapNoTechAddress,[[TagManager sharedInstance]tagByName:kTagSyncErrorMessage]] cancelButtonTitle:[[TagManager sharedInstance]tagByName:kTagAlertErrorOk] andOtherButtonTitles:nil];
