...
- (void)loadView 
{
    ...
    if ([[[LocationManager sharedInstance] locManager] respondsToSelector:@selector(requestWhenInUseAuthorization)]) {
        [[[LocationManager sharedInstance] locManager] requestWhenInUseAuthorization];
    }
...
- (void)directionsDidUpdateDirections:(UICGDirections *)cgdirections
{
    ...
    // TODO : Add start annotation and end annotation
