...
+ (NSArray*) eventsOfCurrentDay:(NSDate*)selectedDate {
    ...
    NSDate *startDate = [DateUtil dateWithOutTimeInGMT:selectedDate];
    NSDate *endDate = [DateUtil dateWithOutTimeInGMT:[selectedDate dateByAddingDays:1]];
...
+ (NSMutableDictionary*)objectValueMapDictionary:(WorkOrderSummaryModel*)workOrder {
    ...
    if (![workOrder.localScheduleDateTime length]) {
