...
- (void)drawTitle:(NSString *)title
{
    ...
    titleLabel.backgroundColor = [UIColor colorWithHexString:kPageViewMasterBGColor];
...
- (void)drawCancelButtonAndOtherButton:(NSString*)cancelButtonTitle otherButtonTitle:(NSString*)otherButtonTitle
{
    if (cancelButtonTitle != nil)
    {
        ...
        cancelButton.layer.borderColor = [UIColor colorWithHexString:kOrangeColor].CGColor;
        
        cancelButton.titleLabel.font = [UIFont fontWithName:kHelveticaNeueRegular size:kFontSize15];
        
        [cancelButton setBackgroundColor:[UIColor clearColor]];
        [cancelButton setTitleColor:[UIColor colorWithHexString:kOrangeColor] forState:UIControlStateNormal];
    ...
    if(otherButtonTitle!=nil)
    {
        ...
        otherButton.titleLabel.font = [UIFont fontWithName:kHelveticaNeueRegular size:kFontSize15];
        
        otherButton.layer.borderColor = [UIColor whiteColor].CGColor;
        otherButton.backgroundColor = [UIColor colorWithHexString:kOrangeColor];
