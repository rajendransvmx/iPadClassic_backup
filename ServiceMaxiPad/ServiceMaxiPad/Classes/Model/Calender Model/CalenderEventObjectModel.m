...
-(void)explainMe
{
    NSLog(@"Id: %@, location : %@, durationInMinutes: %@, subject : %@, activityDate: %@, description: %@, activityDateTime: %@, StartDateTime: %@, EndDateTime : %@, ownerId : %@, whatID :%@, localID : %@", Id, location, durationInMinutes, subject, activityDate, description, activityDateTime, startDateTime, endDateTime, ownerId, WhatId, localId);
}
@end
