...
+ (NSDictionary *) getMappingDictionary {
    ...
    NSDictionary *mapDictionary = [[NSDictionary alloc] initWithObjectsAndKeys:kSourceUpdateId,@"Id",kSSourceUpdateProcessId,@"process",kSSourceUpdateSettingId,@"settingId",kSSourceUpdateAction,@"action",kSSourceUpdateConfigType,@"configurationType",kSSourceUpdateDisplayValue,@"displayValue",kSSourceUpdateSrcFieldName,@"sourceObjectName",kSSourceUpdatetargetFieldName,@"targetObjectName", nil];
    return mapDictionary;
}
@end