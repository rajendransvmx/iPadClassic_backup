        ...
        else
        {
           ...
           self.masterViewController .productDetailsArray = self.productDetailsArray;
            ...
            else
            {
                ...
                UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:[[TagManager sharedInstance]tagByName:kTagAlertTitleError] message:@"Product manual not present" delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
                [alertView show];
            }
