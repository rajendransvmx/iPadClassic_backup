                  ...
                  AndProductManualID:(NSString *)ProductManualId
{
    ...
    else
    {
        ...
        {
            UIAlertView * alertview = [[UIAlertView alloc] initWithTitle:title message:@"The product Not Found " delegate:self cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
