...
#import "UserGPSLogServiceLayer.h"
    ...
    @synchronized([self class]) {
        ...
        switch (categoryType) {
            ...
            case CategoryTypeJobLog: {
                ...
                break;
            case CategoryTypeUserGPSLog: {
                baseServiceLayer = [[UserGPSLogServiceLayer alloc]initWithCategoryType:categoryType requestType:requestType];
            }
                break;
            default:
