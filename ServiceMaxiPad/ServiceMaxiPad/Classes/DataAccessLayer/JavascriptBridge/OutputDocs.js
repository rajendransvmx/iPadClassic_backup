...
function DocDetailsAfterMediaResources(media_res_array,media_res_json_array,templateId, callbackFunction,gObjectData)
{
        ...
        templateRecord=templateRecord.replace("media_resources","SVCMAX__Media_Resources__c");
        ...
        $DAL.executeQuery(dtdObj,dtdfields,dtdcriteria,null,null,function(request)
                          ...
                          templateDetailsRecord=templateDetailsRecord.replace(/fields/g,"SVCMAX__Fields__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/object_name/g,"SVCMAX__Object_Name__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/alias/g,"SVCMAX__Alias__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/type/g,"SVCMAX__Type__c");
...
var doc1 = {};
doc1.object_name = "SVCMAX__Service_Order__c";
...
var doc2 = {};
doc2.object_name = "SVCMAX__Service_Order__c";
