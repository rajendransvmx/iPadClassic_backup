  ...
  $DAL.executeQuery(objectName,fieldNames,criteria,null,null,function(request){
    if(request.response.statusCode != '1') {
      ...
      if(objectData.length > 0) {
        ...
        processSfid = processObj.process_sfid;
...
function DocDetailsAfterMediaResources(media_res_array,media_res_json_array,templateId, callbackFunction,gObjectData)
{
        ...
        var dtdfields = [{fieldName:'docTemplateDetailId',fieldType:'TEXT'},{fieldName:'fields',fieldType:'TEXT'},{fieldName:'objectName',fieldType:'TEXT'},{fieldName:'alias',fieldType:'TEXT'},{fieldName:'type',fieldType:'TEXT'}];
...
//                          alert("DocDetailsAfterMediaResources check 2"+templateDetailsRecord);
                          ...
                          templateDetailsRecord=templateDetailsRecord.replace(/object_name/g,current_org_name_space+"__Object_Name__c");
...
//                          alert("Final response stringify " + finalResponseString);
...
//    alert("GetDataForTemplateDetailsRecord");
   // 8980 : need local_id and also sfid with conditional OR
    ...
    alert("DocTemplateDetailId : " + dtd_Id);
    ...
    $DAL.executeQuery(objectName,fieldNames,criteria,null,null,function(request)
                      ...
                      alert(JSON.stringify(processCompObj));
                      ...
                      $DAL.executeQuery(exptblName,fields,criterion,null,null,function(request)
                                        ...
                                        var fieldNames = [{fieldName:'componentSequenceNumber',fieldType:'TEXT'},{fieldName:'componentLHS',fieldType:'TEXT'},{fieldName:'componentRHS',fieldType:'TEXT'},{fieldName:'operatorValue',fieldType:'TEXT'}];
...
//                                        alert("Found!! Now break :)");
                                        ...
                                        $DAL.executeQuery(tablename,fields,criteria,null,null,function(request)
                                                          ...
                                                          alert(" Data from " + tablename + " : " + local_id_obj);
