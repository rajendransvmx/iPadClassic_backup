...
//
//- (void)updateTargetSfpage:(SFPage *)currentPage
...
//                          intoRecordField:(RecordField *)recordField
...
//    if ( ![SMXiPhone_Utility isStringNotNULL:newFieldValue]) {
//        newFieldValue = @"";
//    }
//    
...
//    
//    if ([SMXiPhone_Utility  isStringEmpty:newFieldValue] || ![SMXiPhone_Utility isStringNotNULL:newFieldValue]) {
//    }
...
//        
//        NSString *replacedString =  [SMXiPhone_DateUtility replaceSpaceinDateByT:newFieldValue];
//        finalValue = replacedString;
//        finalDisplayValue = replacedString;
//    }
//    else if ([fieldType isEqualToString:BOOLEAN]){
//        finalValue = ([SMXiPhone_Utility isItTrue:newFieldValue])?kTrue:kFalse;
...
//        }
//        if (![SMXiPhone_Utility isStringNotNULL:fieldValue1]) {
//            fieldValue1 = @"";
//        }
//        
//        finalValue = newFieldValue;
...
//                    if ( ![SMXiPhone_Utility isStringNotNULL:newValue]) {
//                        newValue = @"";
//                    }
//                    
...
//                        
//                        RecordField *aField = [pageDetailDictionary objectForKey:fieldName];
//                        if (aField == nil) {
//                            
//                            aField = [[RecordField alloc] initWithFieldName:fieldName value:nil andDisplayValue:nil];
...
//               
//                RecordField *aField = [page.headerRecord objectForKey:fieldName];
//                if (aField == nil) {
//                    
//                    aField = [[RecordField alloc] initWithFieldName:fieldName value:nil andDisplayValue:nil];
...
//                                        fromsfPage:(SFPage *)sfPage {
//    
//    NSArray *recordsArray = [sfPage.detailRecord    objectForKey:processCompId];
