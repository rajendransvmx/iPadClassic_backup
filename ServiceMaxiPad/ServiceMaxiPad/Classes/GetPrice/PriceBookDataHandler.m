...
//        if (![SMXiPhone_Utility isStringEmpty:__Entitled_By_Service__c]) {
...
//        if ([SMXiPhone_Utility isItTrue:__Entitled_Within_Threshold__c] ) {
//            self.contractIdServiceCovered = @"COVERED";
//        }
//        
//        
//        /* Wo comes under warranty then get warranty_id */
//        if (![SMXiPhone_Utility isStringEmpty:warrantyId]) {
//            [self fillUpWarrantyRecordWithId:warrantyId intoPriceBook:priceBookObject];
//        }
//        else if(![SMXiPhone_Utility isStringEmpty:contractId]){
...
- (void)getCurrencyAndPartsActivityInfoFromTargetDictionary:(NSDictionary *)currentContext {
    ...
    self.targetRecordLocalId = [self getValueFOrKey:kLocalId FromArray:headerFieldArray];
...
//            if (![SMXiPhone_Utility  isStringEmpty:default_Parts_Price_Book__c]) {
...
//            if (![SMXiPhone_Utility isStringEmpty:__Service_Pricebook__c]) {
...
- (void)fillUpTagsInto:(NSMutableArray *)priceBookArray {
    ...
    NSString * message = @"Price not calculated, because entitlement check has not been performed";
    if (message != nil) {
...
//  
//    dataArray =  [self.dbService getRecordWhereColumnNamesAndValues:columnNames andTableName:[SMXiPhone_Utility appendOrgNameSpaceToString:@"__Zone_Pricing__c"]];
...
//        NSString  *nameExpressionId = [tempDictionary objectForKey:[SMXiPhone_Utility appendOrgNameSpaceToString:@"__Named_Expression__c"]];
//        if (![SMXiPhone_Utility isStringEmpty:nameExpressionId]) {
