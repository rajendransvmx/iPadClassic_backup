...
- (void)addButtonsWithArray:(NSArray *)array {
    ...
    if (array) {
        ...
        for (SMXEvent *event in array) {
            ...
            _button.eventName.text = (event.cWorkOrderSummaryModel ? (event.cWorkOrderSummaryModel.companyName.length ? event.cWorkOrderSummaryModel.companyName : event.stringCustomerName) : event.stringCustomerName);
