...
- (void)addLines {
    ...
    [self addSubview:[self graydashLine:CGRectMake(0,y,self.frame.size.width+1,1)]];
}
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex;
{
    if (buttonIndex == 0) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:RELOAD_CALENDAR_WEEK object:nil];
    }
    else
    {
        [UIView animateWithDuration:0.50
