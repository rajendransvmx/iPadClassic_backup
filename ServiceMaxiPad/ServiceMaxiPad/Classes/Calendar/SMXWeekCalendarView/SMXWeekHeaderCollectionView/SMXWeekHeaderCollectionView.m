...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.label setTextColor:[UIColor colorWithHexString:@"434343"]];
    [cell.label setText:[NSString stringWithFormat:@"%@", [arrayWeekAbrevWithThreeChars objectAtIndex:compDateOfLabel.weekday-1]]];
    
    [cell.label setAttributedText:[self getStringHighlighted:[NSString stringWithFormat:@"%@", [arrayWeekAbrevWithThreeChars objectAtIndex:compDateOfLabel.weekday-1]] date:[NSString stringWithFormat:@"%i",compDateOfLabel.day]]];
   // [cell.dateLabel setText:[NSString stringWithFormat:@"%i",compDateOfLabel.day]];
    
    if (compDateOfLabel.weekday == 1) {
        [cell.label setTextColor:[UIColor colorWithHexString:@"797979"]];
        firstdayOfTheWeek=compDateOfLabel.day;
    }else if(compDateOfLabel.weekday == 7){
        [cell.label setTextColor:[UIColor colorWithHexString:@"797979"]];
    }
    
    if ([NSDate isTheSameDateTheCompA:compDateOfLabel compB:[NSDate componentsOfCurrentDate]]) {
        [cell.label setTextColor:[UIColor colorWithHexString:@"e15001"]];
