...
-(void)dayEventSelected:(NSNotification *)pNotification
{
    ...
    SMXEvent *eventData = (SMXEvent *)pNotification.object;
...
-(void)addCalender{
    if (grayCalenderBkView==nil) {
        ...
        monthCalender.view.frame=CGRectMake(38, 0, 432, 389);
...
-(void)calenderButton{
    ...
    grayCalenderBkView.frame = CGRectMake(0,0, self.view.frame.size.width,self.view.frame.size.height-0);
