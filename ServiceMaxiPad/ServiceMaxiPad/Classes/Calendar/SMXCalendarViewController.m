...
- (void)viewDidLoad {
   ...
   // NSLog(@"Documents Directory%@",[[[NSFileManager defaultManager] URLsForDirectory:NSDocumentDirectory inDomains:NSUserDomainMask] lastObject]);
    ...
    //TimeZoneChange
    [[NSNotificationCenter defaultCenter] removeObserver:self name:CHECK_FOR_TIMEZONE_CHANGE object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(checkForTimeZoneChange:) name:CHECK_FOR_TIMEZONE_CHANGE object:nil];
...
//    BOOL syncStatus = [lSyncManager syncInProgress];
    ...
    if(syncStatus)
    {
        ...
        //[self performSelectorInBackground:@selector(eventRescheduled:) withObject:nil];
    }
    //[self loadWizardData];
