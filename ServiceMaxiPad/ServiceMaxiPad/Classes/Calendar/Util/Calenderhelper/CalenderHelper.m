...
//TODO: Working on conflict Identification
...
+(BOOL)isConflicted:(NSString *)lWhatId
{
    ...
    NSLog(@"lChildModelArray : %@", lChildModelArray);
    ...
    for (TransactionObjectModel *lTransModel in lDataArray)
    {
        ...
        NSLog(@"model objectAPIName: %@", lTransModel.objectAPIName);
        NSLog(@"[model recordLocalId] : %@", [lTransModel recordLocalId]);
