...
- (void)addLabelCustomerNameWithViewSize:(CGSize)sizeView {
    ...
    labelCustomerName = [[UILabel alloc] initWithFrame:CGRectMake(gap , buttonDetailPopover.frame.origin.y - 5, sizeView.width-3*gap-buttonDetailPopover.frame.size.width, buttonDetailPopover.frame.size.height)];
    labelCustomerName.backgroundColor = [UIColor clearColor];
    [labelCustomerName setText:(event.cWorkOrderSummaryModel ? event.cWorkOrderSummaryModel.companyName : event.stringCustomerName)];
...
-(void)addLabelPhoneNumber
{
    ...
    phoneTitleLabel.text = kCalDetailPhone;
...
-(void)addLabelPriority
{
    ...
    priorityTitleLabel.text = kCalDetailPriority;
...
-(void)addLabelBillingType
{
    ...
    billingTypeTitleLabel.text = kCalDetailBillingType;
...
-(void)addLabelServiceLocation
{
    ...
    serviceLocationTitleLabel.text = kMapServiceLocation;
...
-(void)addLabelOrderStatus
{
    ...
    orderStatusTitleLabel.text = kCalDetailOrderStatus;
...
-(void)addLabelPurposeOfVisit
{
    ...
    purposeOfVisitTitleLabel.text = kMapPurposeOfVisit;
...
-(void)addProblemDescription
{
    ...
    problemDescriptionTitleLabel.text = kMapProblemDescription;
...
-(void)addProductsAtLocation
{
    ...
    productsAtThisLocationTitleLabel.text = kCalDetailProductsAtLocation;
