...
//    TODO:Working on making the contact a link
        [contactNameLabel setTextColor:[UIColor colorWithHexString:kOrangeColor]];
        UITapGestureRecognizer *tapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(buttonEditPopoverAction:)];
