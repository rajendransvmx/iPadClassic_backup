...
-(void)buttonEmailAction:(id)sender
{
    ...
    {
        UIAlertView *lAlert = [[UIAlertView alloc] initWithTitle:@"Warning!!!" message:@"You currently cannot send email." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
...
-(void)buttonChatAction:(id)sender
{
    ...
    {
        UIAlertView *lAlert = [[UIAlertView alloc] initWithTitle:@"Warning!!!" message:@"Your device does not support sending sms." delegate:nil cancelButtonTitle:@"OK" otherButtonTitles: nil];
