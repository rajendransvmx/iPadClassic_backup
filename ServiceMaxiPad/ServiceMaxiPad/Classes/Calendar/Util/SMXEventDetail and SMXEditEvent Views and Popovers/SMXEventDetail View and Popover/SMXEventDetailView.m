...
- (void)addLabelDateWithViewSize:(CGSize)sizeView {
    ...
    if (event.isMultiDayEvent) {
        beginDate = [NSDate stringDayOfDate:event.dateTimeBegin WithTime:event.dateTimeStart_Multi];
        endDate = [NSDate stringDayOfDate:event.dateTimeEnd WithTime:event.dateTimeEnd_Multi];
    }else{
        beginDate = [NSDate stringDayOfDate:event.dateTimeBegin WithTime:event.dateTimeBegin];
        endDate = [NSDate stringDayOfDate:event.dateTimeEnd WithTime:event.dateTimeEnd];
    }
