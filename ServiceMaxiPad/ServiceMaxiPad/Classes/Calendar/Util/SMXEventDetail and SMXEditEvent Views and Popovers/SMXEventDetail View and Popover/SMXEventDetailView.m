...
- (void)addButtonDetailPopoverWithViewSize:(CGSize)sizeView {
    ...
    buttonDetailPopover = [[UIButton alloc] initWithFrame:CGRectMake(sizeView.width-width-gap, 5, width, height)];

    [buttonDetailPopover setTitleColor:[UIColor colorWithHexString:kOrangeColor] forState:UIControlStateNormal];
    [buttonDetailPopover setTitle:@"Detail" forState:UIControlStateNormal];
    ...
    [buttonDetailPopover setAutoresizingMask:UIViewAutoresizingFlexibleLeftMargin];
...
//    UIImage *lImage = [UIImage imageNamed:@"Section_right_arrow.png"];
//    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(buttonDetailPopover.frame.origin.x + buttonDetailPopover.frame.size.width + 10, buttonDetailPopover.frame.origin.y + 10, lImage.size.width, lImage.size.height)];
...
- (void)addButtonReschedulePopoverWithViewSize:(CGSize)sizeView {
   ...
   // UIColor *lCustomOrangeColor = [UIColor colorWithRed:225.0/255.0 green:80.0/255.0 blue:1.0/255.0 alpha:1.0];
    ...
    [buttonReschedulePopover setTitle:@"Reschedule" forState:UIControlStateNormal];
...
//    [buttonReschedulePopover setImage:[UIImage imageNamed:@"Section_right_arrow.png"] forState:UIControlStateNormal];
...
//    buttonReschedulePopover.imageEdgeInsets = UIEdgeInsetsMake(0, buttonReschedulePopover.titleLabel.frame.size.width, 0, -buttonReschedulePopover.titleLabel.frame.size.width -5);

    
    
//    UIImage *lImage = [UIImage imageNamed:@"Section_right_arrow.png"];
//    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(buttonReschedulePopover.frame.origin.x + buttonReschedulePopover.frame.size.width + 10, buttonReschedulePopover.frame.origin.y + 10, lImage.size.width, lImage.size.height)];
//    imageView.image = lImage;
//    [imageView setAutoresizingMask:UIViewAutoresizingFlexibleLeftMargin];
//    
//    [self addSubview:imageView];
...
- (void)addLabelCustomerNameWithViewSize:(CGSize)sizeView {
    ...
    labelCustomerName = [[UILabel alloc] initWithFrame:CGRectMake(gap
                                                                  , buttonDetailPopover.frame.origin.y - 5, sizeView.width-3*gap-buttonDetailPopover.frame.size.width, buttonDetailPopover.frame.size.height)];
...
- (void)addLabelDateWithViewSize:(CGSize)sizeView {
    ...
    appointmentLabel = [[UILabel alloc] initWithFrame:CGRectMake(gap
                                                                 , labelCustomerName.frame.origin.y+labelCustomerName.frame.size.height + 5, 150, labelCustomerName.frame.size.height - 20 )];
    ...
    labelDate = [[UILabel alloc] initWithFrame:CGRectMake(gap
                                                          , appointmentLabel.frame.origin.y+appointmentLabel.frame.size.height -10, 500., labelCustomerName.frame.size.height - 10 )];
...
-(void)addLabelContactName
{
    ...
    contactTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(gap
                                                                  , 15, appointmentLabel.frame.size.width, appointmentLabel.frame.size.height)];
    ...
    contactNameLabel = [[SMXLable alloc] initWithFrame:CGRectMake(gap
                                                                 , contactTitleLabel.frame.origin.y+contactTitleLabel.frame.size.height, SMXLableWidth-50, contactTitleLabel.frame.size.height)];
    [contactNameLabel setText:cContactModel.contactName];
...
-(void)addEmailAndChatButtons
{
    ...
    buttonEmail = [[UIButton alloc] initWithFrame:CGRectMake(contactNameLabel.frame.origin.x + contactNameLabel.frame.size.width +50, contactNameLabel.frame.origin.y, lImage.size.width, lImage.size.height)];
...
-(void)addLabelBillingType
{
    ...
    billingTypeTitleLabel.text = @"billing type";
    ...
    [billingTypeLabel setText:@"Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty Warrenty "];
...
-(void)addLabelServiceLocation
{
    ...
    serviceLocationTitleLabel.text = @"service location";
...
-(void)addLabelOrderStatus
{
    ...
    orderStatusTitleLabel.text = @"order status";
...
-(void)addLabelPurposeOfVisit
{
    ...
    purposeOfVisitTitleLabel.text = @"purpose of visit";
...
-(void)addProblemDescription
{
    ...
    problemDescriptionTitleLabel.text = @"problem description";
...
//       NSString *lProblemDescription = @"One of the flayrods has gone out of skew on the treddle. The malfunction started this morning when the milling machine was restarted. It was making a strange sound yesterday and the status light on the top of the housing was flashing red. It appears that another rod was thrown as well because there is a hole in the manifold where the doohickey connects";
 
//    NSString *lProblemDescription = @"UX9600 Laser Milling Machine\nRhino-Grip Can Opener and Food Processor\nT-850 Series 1 Terminator";
    ...
    [problemDescriptionLabel setText:event.cWorkOrderSummaryModel.problemDescription];
    ...
    /*
    CGSize theSize = [self dynamicHeightOfLabel:problemDescriptionLabel];
    
    CGRect newFrame = problemDescriptionLabel.frame;
    newFrame.size.height = theSize.height;
    problemDescriptionLabel.frame = newFrame;
...
-(void)addProductsAtLocation
{
    ...
    productsAtThisLocationTitleLabel.text = @"products at this location";
...
-(void)setUpNonWorkOrderDetailsView
{
    ...
    lEventNameTitleLabel.text = @"event name";
    ...
    lEventDescriptionTitleLabel.text = @"Description";
    ...
    lframe.size.height = (lDescriptionSize.height == 20 ? lDescriptionSize.height :  lDescriptionSize.height - 20);
