...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.button setTitle:[NSString stringWithFormat:@"%li", (long)compDateOfLabel.day] forState:UIControlStateNormal];//anish todo
...
- (void)scrollToDate:(NSDate *)date {
    ...
    int x = 0;
    for (int i=(int)(1-(componentsFirstDayOfMonth.weekday-1)),j= (int)(7*[[[SMXDateManager sharedManager] currentDate] numberOfWeekInMonthCount]-(componentsFirstDayOfMonth.weekday-1)); i<=j; i++) {
