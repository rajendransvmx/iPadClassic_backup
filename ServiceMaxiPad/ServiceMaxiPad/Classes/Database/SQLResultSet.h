...
@property (atomic, strong) SQLStatement *statement;
...
+ (instancetype)resultSetWithStatement:(SQLStatement *)statement usingParentDatabase:(DatabaseManager*)aDB;

/** Close result set */

- (void)close;

- (void)setParentDB:(DatabaseManager *)newDb;
