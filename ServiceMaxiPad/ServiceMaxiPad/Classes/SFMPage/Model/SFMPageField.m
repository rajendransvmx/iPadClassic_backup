...
- (id)initWithDictionary:(NSDictionary *)pageFieldDict
{
    ...
    if (self) {
        ...
        _sourceObjectField = [pageFieldDict objectForKey:kPageFieldContextSourceObject];
        _allowOverRide = [pageFieldDict objectForKey:kPageFieldOverrideRelatedLookup];
        
        _fieldMappingId = [pageFieldDict objectForKey:kPageFieldMapping];
