...
- (void)seeMoreClicked
{
    ...
    if (self.historyInfoType == HistoryTypeAccount) {
        [self startAccountHistoryRequstOnline];
    }
...
- (void)startAccountHistoryRequstOnline
{
...
- (NSString *)titleForHeaderInSection
{
    ...
    if (self.historyInfoType == HistoryTypeAccount) {
        title = kTag_AccountHistory_Records;//[[TagManager sharedInstance] tagByName:kTag_AccountHistory];
    }
    else if (self.historyInfoType == HistoryTypeProduct){
