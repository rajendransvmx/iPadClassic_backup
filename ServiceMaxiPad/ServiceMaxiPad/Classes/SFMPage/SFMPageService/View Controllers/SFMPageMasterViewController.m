    ...
    switch (indexPath.section) {
        ...
        case SFMPageMasterSectionTypeHistory:/*Additional Info*/
            if (headerLayout.enableProductHistory &&  headerLayout.enableAccountHistory) {
                if (indexPath.row == 0) {
                    title = [tagManager tagByName:kTag_AccountHistory];
                }
            ...
            {
                title = [tagManager tagByName:kTag_ProductHistory_Records];
            }
...
- (BOOL)isAccountHistory:(NSIndexPath *)indexPath
{
    ...
    NSString *title = [[TagManager sharedInstance] tagByName:kTag_AccountHistory];
