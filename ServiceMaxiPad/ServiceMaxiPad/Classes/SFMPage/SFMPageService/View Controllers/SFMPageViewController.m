...
- (void)viewDidAppear:(BOOL)animated
{
   ...
   // SFMPageLayoutViewController *sfmPageLayOutViewController = (SFMPageLayoutViewController*) detailViewController.pageDetailChildViewController;
        
    
   // [sfmPageLayOutViewController resetViewPage:self.sfmPageView];
}
