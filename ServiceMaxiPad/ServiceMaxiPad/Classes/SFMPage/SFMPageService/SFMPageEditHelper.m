...
+ (NSMutableArray *)getPicklistValuesForField:(NSString *)fieldApiName  objectName:(NSString *)objectName
{
    ...
    picklistArray = (NSMutableArray *)[picklistService fetchSFPicklistInfoByFields:[NSArray arrayWithObjects:kfieldname,klabel,kvalue,kindexValue,kvalidFor, nil] andCriteria:criteriaObjects andExpression:@"(1 AND 2)"];
...
- (BOOL)insertRecord:(NSMutableDictionary *)record
   ...
   return [transObjectService  saveRecordModel:aModel];
}
