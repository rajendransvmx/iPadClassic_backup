...
- (BOOL)saveHeaderRecord:(SFMPage *)page {
    ...
    NSString *modifiedFieldAsJsonString = [self getJsonStringAfterComparisionForObject:page.objectName recordId:page.recordId andSfid:headerSfid];
...
//    }
    ...
    if (recordUpdatedSuccessFully && canUpdate) {
        ...
        else if ([syncRecord.operation isEqualToString:kModificationTypeUpdate] && [page.objectName isEqualToString:kEventObject]) {
...
- (BOOL)saveDetailRecords:(SFMPage *)sfmPage {
    ...
    for(NSString * processCompId in allDetailProcessComponents)
    {
        ...
        for (NSMutableDictionary * eachDetailDict in detailRecordsArray)
        {
            ...
            NSString *modifiedFieldAsJsonString = [self getJsonStringAfterComparisionForObject:processComponent.objectName recordId:localIdField.internalValue andSfid:idField.internalValue];
            ModifiedRecordModel * syncRecord = [[ModifiedRecordModel alloc] init];
