...
-(void)showAlert
{
    [[AlertMessageHandler sharedInstance] showAlertMessageWithType:AlertMessageTypeRequiredFieldWarning];
}
...
- (void)calculatePrice {
        ...
        //TO DO:Shr
//    if (![SMXiPhone_Utility canPerformGetPrice]) {
//        NSString *message =; @"Data required for price calculation is not available. Please try when online or contact ServiceMax administrator.";
...
- (void)showPriceAlertView:(NSString *)message {
    ...
    UIAlertView * _alert = [[UIAlertView alloc] initWithTitle:buttonText message:message delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil];
