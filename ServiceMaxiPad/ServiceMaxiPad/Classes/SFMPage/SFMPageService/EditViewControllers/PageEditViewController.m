...
- (void)barButtonTapped:(id)sender
{
    ...
    //do proper action based on eventcallbackType
}
#pragma mark -End
...
//        [self.editViewControllerDelegate loadReadableViewForRecordId:self.sfmPage.recordId andObjectName:self.sfmPage.objectName];
//        self.sfmPage = nil;
//    }
//    else if([self isStandAloneCreateProcess])
//    {
//        [self dismissviewController:NO];
//        [self.editViewControllerDelegate loadReadableViewForRecordId:self.sfmPage.recordId andObjectName:self.sfmPage.objectName];
//        self.sfmPage = nil;
...
- (BOOL)validatePageData {
    ...
    BOOL validateHeader = [self fieldValidationForHeaderRecord];
