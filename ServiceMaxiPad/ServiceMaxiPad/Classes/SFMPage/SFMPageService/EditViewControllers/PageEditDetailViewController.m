...
-(void)setUpBizRuleLabel{
    ...
    NSString *cannotsave = @"Cannot Save: ";
    NSString * confirmMsg = @"Issues Need Resolution";
    NSString *finalText = [[NSString alloc] initWithFormat:@"%@ %d %@",cannotsave,[self.bizRulesErrors count],confirmMsg];
    ...
    self.bizRuleLabel.center = self.bizRuleButton.center;
