...
@interface PageEditDetailViewController : UIViewController <PageEditViewControllerDelegate,UITableViewDataSource,UITableViewDelegate,SMSplitViewControllerDelegate,ChildEditViewControllerDelegate> {
