...
//    UIBarButtonItem *action = [[UIBarButtonItem alloc] initWithTitle:
//                                  [[TagManager sharedInstance]tagByName:kTagActions]
//                                                                   style:UIBarButtonItemStyleBordered
//                                                                  target:self
//                                                                  action:nil];
    
    UIBarButtonItem *productManual = [[UIBarButtonItem alloc] initWithTitle:[[TagManager sharedInstance]tagByName:kTag_ProductManual]
                                                                  style:UIBarButtonItemStyleBordered
                                                                 target:self
                                                                 action:@selector(showProductManual)];
...
- (void)showProductManual
{
    ...
    UIBarButtonItem *backButton = [[UIBarButtonItem alloc] initWithTitle:[[TagManager sharedInstance]tagByName:kTag_Troubleshooting] style:UIBarButtonItemStyleBordered target:nil action:nil];
