...
//                                                                  action:nil];
    ...
    UIBarButtonItem *productManual = [[UIBarButtonItem alloc] initWithTitle:@"ProductManual"
                                                                  style:UIBarButtonItemStyleBordered
                                                                 target:self
...
- (void)showProductManual
{
    ...
    UIBarButtonItem *backButton = [[UIBarButtonItem alloc] initWithTitle:@"Troubleshoot" style:UIBarButtonItemStyleBordered target:nil action:nil];
