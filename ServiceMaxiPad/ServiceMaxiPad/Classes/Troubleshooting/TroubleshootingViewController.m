...
- (void)loadProductmanual
{
    ...
    {
        UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:[[TagManager sharedInstance]tagByName:kTagAlertTitleError]
                                                           message:@"Product manual not present."//[[TagManager sharedInstance]tagByName:kTagTroubleShootingError]
                                                          delegate:self
                                                 cancelButtonTitle:[[TagManager sharedInstance]tagByName:kTagAlertErrorOk ]
                                                 otherButtonTitles:nil, nil];
        [alertView show];
...
- (void)loadTableViewAndWebView
{
    ...
    [self.masterViewController tableView:self.masterViewController.troubleshootTableView didSelectRowAtIndexPath:firstRowPath];
