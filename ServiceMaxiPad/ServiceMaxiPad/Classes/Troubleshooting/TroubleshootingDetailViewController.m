...
- (void)getBodyFromApplicationAndLoadWebView
{
    ...
    else
    {
        ...
        UIAlertView *alertView = [[UIAlertView alloc]initWithTitle:@"Data Corrupted" message:@"The file has been not uploaded properly" delegate:nil cancelButtonTitle:[[TagManager sharedInstance]tagByName:kTagAlertErrorOk] otherButtonTitles:nil, nil];
        [alertView show];
