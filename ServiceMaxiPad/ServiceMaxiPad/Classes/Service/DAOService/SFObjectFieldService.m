...
-(NSArray *)getSFObjectFieldsForObject:(NSString *)objectName
{
    ...
    NSArray * fieldsArray = [self fetchSFObjectFieldsInfoByFields:[NSArray arrayWithObjects:@"objectName",@"fieldName",@"type",@"referenceTo",@"label", nil] andCriteria:criteria];
