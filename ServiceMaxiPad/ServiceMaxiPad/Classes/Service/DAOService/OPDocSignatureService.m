...
- (NSArray*)getSignaturesForHTMLFile:(NSString*)htmlFilename
{
    ...
    DBCriteria *criteria = [[DBCriteria alloc] initWithFieldName:kOPDocFileName operatorType:SQLOperatorEqual andFieldValue:htmlFilename];
...
- (void)updateHTMLFilenameInSignature:(OPDocSignature*)model
{
    ...
    NSLog(@"Update %d signature file %@ :: %@",status, model.Name, model.HTMLFileName);
}
