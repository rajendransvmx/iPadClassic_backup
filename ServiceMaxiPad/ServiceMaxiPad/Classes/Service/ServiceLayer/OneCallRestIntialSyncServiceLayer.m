    ...
    switch (getPriceDataType) {
        ...
        case RequestGetPriceDataTypeTwo: {
            ...
            if ([valuesLabour count]) {
                [valueMaps addObject:[NSDictionary dictionaryWithObject:valuesLabour forKey:@"Labour"]];
            }
            
            if ([valuesIsoCurrency count]) {
                [valueMaps addObject:[NSDictionary dictionaryWithObject:valuesIsoCurrency forKey:@"CurrencyISO"]];
            }
        ...
        default:
            NSLog(@"Invalid post body parama for unidentified get price request");
            break;
    }
