...
-(void)addCustomElements
{
    ...
    //HS new
    btn2 = [UIBuilder getTabBarButton:theFrame withImage:[[TagManager sharedInstance]tagByName:kTagHomeCalendar] withSelectedImage:@"Calendar" withTitle:[[TagManager sharedInstance]tagByName:kTagHomeCalendar]];
   ...
   // btn2.contentHorizontalAlignment = UIControlContentHorizontalAlignmentCenter;
    ...
    theFrame.origin.x = theFrame.origin.x + theFrame.size.width + spaceMargin +5 ;
    btn3 = [UIBuilder getTabBarButton:theFrame withImage:@"Explore" withSelectedImage:@"Explore" withTitle:@"Explore"];
    ...
    theFrame.origin.x = theFrame.origin.x + theFrame.size.width + spaceMargin +5 ;
    btn4 = [UIBuilder getTabBarButton:theFrame withImage:@"Task" withSelectedImage:@"Task" withTitle:@"Tasks"];
    ...
    theFrame.origin.x = theFrame.origin.x + theFrame.size.width + spaceMargin +5 ;
    btn5 = [UIBuilder getTabBarButton:theFrame withImage:@"NewItem" withSelectedImage:@"NewItem" withTitle:@"New Item"];
   // btn5.imageEdgeInsets = UIEdgeInsetsMake(0, 13, 58,0);
    ...
    theFrame.origin.x = theFrame.origin.x + theFrame.size.width + spaceMargin +5 ;
    btn6 = [UIBuilder getTabBarButton:theFrame withImage:@"Recents" withSelectedImage:@"Recents" withTitle:@"Recently Created"];
...
//    [btn7 setTag:6];
    ...
    theFrame.origin.x = theFrame.origin.x + theFrame.size.width + spaceMargin +5 ;
    btn7 = [UIBuilder getTabBarButton:theFrame withImage:@"Tools" withSelectedImage:@"Tools" withTitle:@"Tools"];
