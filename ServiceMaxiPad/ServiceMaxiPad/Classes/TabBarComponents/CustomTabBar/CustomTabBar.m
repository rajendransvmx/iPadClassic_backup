...
-(void)addCustomElements
{
    ...
    theFrame = btn1.frame;
    theFrame.origin.x = theFrame.origin.x + theFrame.size.width + spaceMargin   ;
    ...
    //HS new
    btn2 = [UIBuilder getTabBarButton:theFrame withImage:@"Calendar" withSelectedImage:@"Calendar" withTitle:@"Calendar"];
