...
@interface DODViewController ()<UITableViewDelegate,UITableViewDataSource,FlowDelegate,UIPopoverControllerDelegate>
...
- (void)setupUI {
    ...
    self.titleLabel.textColor = [UIColor colorWithHexString:kEditableTextFieldColor];
...
- (NSString *)getCellTitleStringForIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *titleString = [self.fieldLabelDict objectForKey:[fieldModel getDisplayField]];
    if (titleString) {
