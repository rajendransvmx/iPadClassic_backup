...
@property(nonatomic,retain)NSMutableArray *standAloneObjects;
@property(nonatomic,retain)NSMutableArray *standAloneUniqueObjects;

@property(nonatomic,retain)NSMutableDictionary *standAloneProcessDict;
...
-(void)getStandAloneProcessDict
{
    ...
    NSLog(@"Final Dict is %@",self.standAloneProcessDict);
