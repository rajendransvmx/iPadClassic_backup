...
-(void)loadDetailViewControllerForIndex:(NSInteger)index
{
    ...
    PageEditViewController *editController = [[PageEditViewController alloc]initWithProcessId:processModel.processId withObjectName:self.objectModel.objectName andRecordId:nil];
