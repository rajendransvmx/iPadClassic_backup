...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if (self) {
        ...
        self.priorityTableDataSource = @[[[TagManager sharedInstance]tagByName:kTagAddTaskPriorityHigh],[[TagManager sharedInstance]tagByName:kTagAddTaskPriorityNormal],[[TagManager sharedInstance]tagByName:kTagAddTaskPriorityLow]];
...
- (void)showAddNewTaskScreen {
    ...
    self.taskModel = [[SFMTaskModel alloc]initWithLocalId:nil
                                              description:[[TagManager sharedInstance]tagByName:kTag_TextGoes]
