...
- (void)showAddNewTaskScreen {
    ...
    self.taskModel = [[SFMTaskModel alloc]initWithLocalId:nil
                                              description:nil
                                                 priority:[self.priorityDataSource objectAtIndex:self.selectedPriorityIndex]
                                                 recordId:nil
...
- (void)showEditTaskScreenForTask:(SFMTaskModel *)task {
    ...
    self.selectedPriorityIndex = [self.priorityDataSource indexOfObject:self.taskModel.priority];
...
- (IBAction)cancelButtonClicked:(UIBarButtonItem *)sender {
    ...
    self.taskModel.priority = [self.priorityDataSource objectAtIndex:self.selectedPriorityIndex];
