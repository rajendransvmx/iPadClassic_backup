...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    if (!count) {
        ...
        if (!self.noRecordsInfoLabel) {
            ...
            self.noRecordsInfoLabel = [[UILabel alloc]initWithFrame:self.view.bounds];
            self.noRecordsInfoLabel.text = @"No tasks found. Try adding new task.";
            self.noRecordsInfoLabel.font = [UIFont fontWithName:@"HelveticaNeue-LightItalic" size:16.0];
            self.noRecordsInfoLabel.textColor =[UIColor colorWithRed:121.0/255.0
                                                               green:121.0/255.0
                                                               blue:121.0/255.0
                                                               alpha:1.0];
            
            self.noRecordsInfoLabel.textAlignment = NSTextAlignmentCenter;
            
            self.noRecordsInfoLabel.autoresizingMask = UIViewAutoresizingFlexibleHeight
