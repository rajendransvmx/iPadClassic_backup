...
//    self.navigationItem.titleView = titleLabel;
    ...
    SyncMasterViewController *masterVC = [[SyncMasterViewController alloc]initWithNibName:@"SyncMasterViewController" bundle:nil];
    masterVC.smSplitViewController = self;
    
    SyncStatusDetailViewController *detailVC = [[SyncStatusDetailViewController alloc]initWithNibName:@"SyncStatusDetailViewController" bundle:nil];
