...
- (void)viewDidLoad
{
    ...
    [purgeDataBtn setTitle:[[TagManager sharedInstance]tagByName:kTagPurgeData] forState:UIControlStateNormal];
    [purgeDataBtn setExclusiveTouch:YES];

    [self setDefaultBgForBtn:purgeDataBtn];
    
    [pushLogBtn setTitle:[[TagManager sharedInstance]tagByName:kTagPushLogs] forState:UIControlStateNormal];
    ...
    [aboutBtn setTitle:[[TagManager sharedInstance]tagByName:kTagAbout] forState:UIControlStateNormal];
