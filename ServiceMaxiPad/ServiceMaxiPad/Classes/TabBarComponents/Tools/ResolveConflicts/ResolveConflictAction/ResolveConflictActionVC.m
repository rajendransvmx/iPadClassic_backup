...
- (void)setupUI {
    ...
    [titleView setTitle:@"Sync Conflict Resolution"
    ...
    self.resolutionTableView.layer.borderColor = [UIColor colorWithHexString:kActionBgColor].CGColor;
    ...
    self.saveBarButton.title       = @"Apply";
    ...
    self.objectNameLabel.textColor = [UIColor colorWithHexString:kOrangeColor];
    ...
    self.objectLabel.text     = [self.conflictModel.objectLabel stringByAppendingString:@" number"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(35, 0, 300, 35)];
    ...
    CheckBox *checkBox  = [[CheckBox alloc]initWithFrame:CGRectMake(-5, 3, 44, 35)];
...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    ...
    footerLbl.text     = @"Resolution will be applied at next sync";
