...
- (void)viewDidLoad
{
    ...
    self.smSplitViewController.navigationItem.titleView = [UILabel navBarTitleLabel:@"About"];
...
- (void)updateAboutScreenData
{
    ...
    NSAttributedString *attrSignedIntoString = [[NSAttributedString alloc] initWithString:@"Signed into "
    ...
    NSAttributedString *attrAsString = [[NSAttributedString alloc] initWithString:@" as "
                                                                       attributes:attrsDictionaryType2];
