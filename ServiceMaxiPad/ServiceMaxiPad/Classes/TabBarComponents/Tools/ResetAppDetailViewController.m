...
- (void)viewDidLoad
{
    ...
    self.smSplitViewController.navigationItem.titleView = [UILabel navBarTitleLabel:@"Reset App"];
...
- (void)showResetApplicationConfirmationMessage
{
    ...
    NSString *otherButtonTittle = @"Reset App";
...
{
    NSString *tittle   = @"Profile Validation in prgress";
    NSString *message1 = @"Please do not switch to another application or press the home button during this progress.";
    NSString *message2 = @"Doing so will cancel or interrupt the validating profile.";
