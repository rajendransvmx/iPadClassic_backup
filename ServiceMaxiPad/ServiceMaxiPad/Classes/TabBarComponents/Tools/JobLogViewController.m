...
- (IBAction)pushLogClicked:(UIButton *)sender {
    ...
    if (![self isLogSettingsON]) {
        ...
        [[AlertMessageHandler sharedInstance] showCustomMessage:@"Application Level Log Setting is OFF." withDelegate:nil tag:89 title:nil cancelButtonTitle:[[TagManager sharedInstance]tagByName:kTagAlertErrorOk] andOtherButtonTitles:nil];
        return;
    }
    ...
    else
    {
        ...
        [[AlertMessageHandler sharedInstance] showCustomMessage:@"No logs to push." withDelegate:nil tag:89 title:nil cancelButtonTitle:[[TagManager sharedInstance]tagByName:kTagAlertErrorOk] andOtherButtonTitles:nil];
