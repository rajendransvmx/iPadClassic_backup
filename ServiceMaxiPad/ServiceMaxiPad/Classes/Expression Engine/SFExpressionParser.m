...
- (SQLOperator) sqlOperatorForSFOperator:(NSString *)sfOperator fieldType:(NSString *)fieldType
{
    ...
    if([sfOperator isEqualToString:@"eq"])
    {
        sqlOperator = SQLOperatorEqual;
    }
    else if([sfOperator isEqualToString:@"gt"])
    {
        sqlOperator = SQLOperatorGreaterThan;
    }
    else if([sfOperator isEqualToString:@"lt"])
    {
        sqlOperator = SQLOperatorLessThan;
    }
    else if([sfOperator isEqualToString:@"Less or Equal To"])
    {
        sqlOperator = SQLOperatorLessThanEqualTo;
    }
    else if ([sfOperator isEqualToString:@"ne"])
    {
    ...
    else if ([sfOperator isEqualToString:@"ge"])
    {
        sqlOperator = SQLOperatorGreaterThanEqualTo;
    }
    else if ([sfOperator isEqualToString:@"le"])
    {
        sqlOperator = SQLOperatorLessThanEqualTo;
    }
    ...
    else if([sfOperator isEqualToString:@"contains"])
    {
...
- (NSArray *) refereceFieldCriteriasForExpComponent:(SFExpressionComponentModel *)expComp
{
    ...
    NSString *nameFieldValue = [self nameFieldForObject:self.objectName];
