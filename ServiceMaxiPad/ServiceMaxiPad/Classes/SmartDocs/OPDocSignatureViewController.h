...
@property (nonatomic, assign) NSData                            *encryptedImageData; /*!< Encrypted signature data */
...
@property (nonatomic, assign) OPDocViewController               *parent; /*!< Parent view controller of the Signature view controller */

@property (nonatomic, assign) id <OPDocSignatureDelegate>       delegate; /*!< Delegate to signature vc */
@property (nonatomic, assign) id <OPDocSignatureDataSource>     dataSource; /*!< Data source for signature vc */
