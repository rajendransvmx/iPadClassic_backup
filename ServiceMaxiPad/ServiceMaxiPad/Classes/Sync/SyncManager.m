...
- (void)currentInitialSyncFailedWithError:(NSError *)error
{
    ...
    if (error) {
        ...
        //Try to get new access token and retrigger sync. Ideally this should happen within flow node.
        //}
        [[AlertMessageHandler sharedInstance] showCustomMessage:[error errorEndUserMessage] withDelegate:self tag:alertViewTagForInitialSync title:@"Error" cancelButtonTitle:nil andOtherButtonTitles:@[@"Retry",@"Sign Out"]];
    }
}
