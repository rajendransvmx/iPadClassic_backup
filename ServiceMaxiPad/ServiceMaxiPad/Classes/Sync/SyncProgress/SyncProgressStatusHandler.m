        ...
        @autoreleasepool
        {
            switch (responseStatus.syncProgressState)
            {
                ...
                case SyncStatusDownloadingEvents:
                    message =   [[TagManager sharedInstance]tagByName:kTag_Downloading_Event_RelatedRecord];
                    currentStep = @"4";
                    progress = @"60";
                    break;
                ...
                case SyncStatusCompleted:
                    message =   [[TagManager sharedInstance]tagByName:kTag_DownloadComplete];
                    currentStep = @"6";
                    progress = @"100";
                    break;
    ...
    @synchronized([self class])
    {
        ...
        @autoreleasepool
        {
            switch (responseStatus.syncProgressState)
            {
                ...
                case SyncStatusCompleted:
                    message =   [[TagManager sharedInstance]tagByName:kTag_DownloadComplete];//[[SMXTagsManager sharedTagManager]getTagForId:Tag_Downloading_Data];
                    currentStep = @"4";
                    progress = @"100";
                    break;
