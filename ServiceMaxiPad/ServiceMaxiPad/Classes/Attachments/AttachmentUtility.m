...
{
    NSString *messageTitle = [[TagManager sharedInstance] tagByName:kTagDocDeleteConfirmation];
    NSString *messageDescription = [[TagManager sharedInstance] tagByName:kTagDeleteLocallyAction];
