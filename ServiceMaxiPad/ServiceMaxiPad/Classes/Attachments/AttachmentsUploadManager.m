...
{
    if ([[SNetworkReachabilityManager sharedInstance] isNetworkReachable] && self.cUploadAttachmentLstArray.count)
    {
...
- (void)startAttachmentFileUploadProcess
{
    ...
    if (self.cUploadAttachmentLstArray.count && !self.uploadAttachmentModel)
    {
