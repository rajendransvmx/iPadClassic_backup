...
- (IBAction)deleteAttachment:(id)sender
{
    ...
    [[AlertMessageHandler sharedInstance] showCustomMessage:[[TagManager sharedInstance]tagByName:kTag_TheSelectedAttachementWillBeRemoved] withDelegate:self tag:kDeleteButton title:@"" cancelButtonTitle:cancel andOtherButtonTitles:[NSArray arrayWithObject:delete]];
