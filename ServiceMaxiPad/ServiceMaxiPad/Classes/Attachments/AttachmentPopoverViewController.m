...
- (void)viewDidLoad
{
    ...
    /*if (![addFromCamera length]) {
        addFromCamera = @"Add from Camera Roll";
    }*/
    NSString *takeNewPicture = [[TagManager sharedInstance] tagByName:kTagTakeNewPic];
    /*if (![takeNewPicture length]) {
        takeNewPicture = @"Capture a New Picture";
    }*/
    NSString *takeNewVideo = [[TagManager sharedInstance] tagByName:kTagTakeNewVideo];
    /*if (![takeNewVideo length]) {
        takeNewVideo = @"Capture a New Video for 2 min";
    }*/
