...
+ (void)saveAccessTokenGeneratedTime
{
    ...
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setInteger:time forKey:kPersistanceStoreTokenStoredTime];
    [userDefaults synchronize];
}
...
{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    return  [userDefaults integerForKey:kPersistanceStoreTokenStoredTime];
...
+ (void)saveApplicationInstalledTime
{
    ...
    if (storedTime < 1)
    {
        ...
        NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
        [userDefaults setInteger:time forKey:kPersistanceStoreAppInstallTime];
        [userDefaults synchronize];
    }
}
...
{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    return  [userDefaults integerForKey:kPersistanceStoreAppInstallTime];
}
...
+ (void)saveApplicationWakeupTime
{
    ...
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setInteger:time forKey:kPersistanceStoreAppWakeUpTime];
    [userDefaults synchronize];
}
...
{
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    return  [userDefaults integerForKey:kPersistanceStoreAppWakeUpTime];
}
...
+ (void)saveApplicationUpdatedTime
{
    ...
    NSUserDefaults *userDefaults = [NSUserDefaults standardUserDefaults];
    [userDefaults setInteger:time forKey:kPersistanceStoreAppUpdatedTime];
    [userDefaults synchronize];
}
...
+ (void)storeObjectName:(NSString *)objectName
    ...
    if (localId != nil && objectName != nil) {
        NSMutableDictionary *whatIdToObjectNameDictionary = [[NSUserDefaults standardUserDefaults] objectForKey:kEventWhatIdToObjectName];
        if (whatIdToObjectNameDictionary == nil) {
            whatIdToObjectNameDictionary = [[NSMutableDictionary alloc] init];
