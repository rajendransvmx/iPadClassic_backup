    ...
    @synchronized([self class]){
        @autoreleasepool {
            ...
            for(NSString * eachObject in objectsArray)
            {
                ...
                DBCriteria *aCriteria1 = [[DBCriteria alloc] initWithFieldName:kLocalId operatorType:SQLOperatorLessThanEqualTo andFieldValue: [[NSString alloc] initWithFormat:@"%d",lastIndex]];
