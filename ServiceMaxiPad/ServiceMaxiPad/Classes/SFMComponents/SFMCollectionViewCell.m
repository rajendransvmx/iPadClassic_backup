...
{
   // ((UITextField*)self.valueField).keyboardType = keyboardType;
}
...
- (NSAttributedString *)getAttributedString:(NSString *)stringValue {
    ...
    NSMutableAttributedString *attributedFieldName = [[NSMutableAttributedString alloc] initWithString:stringValue attributes:attributeDictionary];
