...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    tableViewHeader.text = [[NSString alloc] initWithFormat:@"  %@(%lu)",@"Search Results",(unsigned long)[self.lookUpObject.dataArray count]];
...
- (IBAction)addFilters:(id)sender {
    ...
    self.popOverController.popoverLayoutMargins = UIEdgeInsetsMake(0, 0, 0, 180);
