...
NSString *const kTextTask       =   @"Tasks";
...
NSString *const kTextAlertOk               =  @"OK";


//MapView
//TODO: Add these keys to mapview tag constants
NSString *const kMapWONumber               = @"number";
NSString *const kMapAccount                = @"account";
NSString *const kMapServiceLocation        = @"service location";
NSString *const kMapAppointment            = @"appointment";
NSString *const kMapContact                = @"contact";
NSString *const kMapPurposeOfVisit         = @"purpose of visit";
NSString *const kMapProblemDescription     = @"problem description";
NSString *const KMapNoValidAddress         = @"No address found for workorder Hence not shown in map";
NSString *const KMapNoValidAddresses       = @"No address found for workorders Hence not shown in map";
NSString *const KMapNoTechAddress          = @"Unable to fetch Technician address";
NSString *const KMapNoNetwork              = @"No Network";
//NSString *const kTagDayTitle               = @"Day";
//NSString *const KTagMonthTitle             = @"Month";
//NSString *const kTagWeekTitle              = @"Week";
NSString *const kTagAddEventTitle          = @"+ Add Event";
