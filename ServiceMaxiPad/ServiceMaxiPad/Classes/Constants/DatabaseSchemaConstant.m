...
NSString *const kTableLinkedSFMProcessSchema = @"CREATE TABLE IF NOT EXISTS 'LINKED_SFMProcess' ('local_id' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, 'Id' VARCHAR, 'source_header' VARCHAR, 'source_detail' VARCHAR, 'target_header' VARCHAR )";
...
NSString *const kTableObjectNameFieldValueSchema = @"CREATE TABLE IF NOT EXISTS ObjectNameFieldValue ('Id' PRIMARY KEY  NOT NULL  UNIQUE, 'value' VARCHAR)";
...
NSString *const kTableOnDemandDownloadSchema = @"CREATE TABLE IF NOT EXISTS on_demand_download ('object_name' VARCHAR, 'sf_id' VARCHAR PRIMARY KEY NOT NULL UNIQUE, 'time_stamp' DATETIME, 'local_id' VARCHAR, 'record_type' VARCHAR, 'json_record' VARCHAR)";
...
NSString *const kTableProductImageSchema = @"CREATE TABLE IF NOT EXISTS ProductImage ('local_id' INTEGER PRIMARY KEY NOT NULL DEFAULT (0), 'productId' VARCHAR, 'productImage' VARCHAR)";
...
NSString *const kTableSFNamedSearchFiltersSchema = @"CREATE TABLE IF NOT EXISTS SFNamedSearchFilters ('local_id' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE, 'Id' TEXT, 'name' TEXT, 'named_search_id' VARCHAR, 'rule_type' VARCHAR, 'parent_object_criteria' VARCHAR, 'source_object_name' VARCHAR, 'field_name' VARCHAR, 'sequence' VARCHAR, 'advanced_expression' VARCHAR, 'allow_override' BOOLEAN, 'default_on' BOOLEAN, 'description' TEXT)";
...
NSString *const kTableOPDocHtmlDataSchema = @"CREATE TABLE IF NOT EXISTS OPDocHTML ('local_id' INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL UNIQUE DEFAULT (0), 'process_id' VARCHAR, 'record_id' VARCHAR, 'objectName' VARCHAR, 'Name' VARCHAR, 'sfid' VARCHAR)";
...
NSString *const kTableSYNCErrorConflictSchema = @"CREATE TABLE IF NOT EXISTS SyncErrorConflict ('sfId' VARCHAR, 'localId' VARCHAR, 'objectName' VARCHAR, 'recordType' VARCHAR, 'syncType' VARCHAR, 'errorMessage' VARCHAR, 'operationType' VARCHAR, 'errorType' VARCHAR, 'overrideFlag' VARCHAR, 'className' VARCHAR, 'methodName' VARCHAR, 'customWsError' VARCHAR, 'requestId' VARCHAR)";
...
NSString *const kTableTroubleshootDataSchema = @"CREATE TABLE IF NOT EXISTS troubleshootdata ('local_id' INTEGER PRIMARY KEY NOT NULL DEFAULT (0), 'ProductId' VARCHAR, 'ProductName' VARCHAR, 'Product_Doc' BLOB, 'DocId' VARCHAR, 'prod_manual_Id' VARCHAR, 'prod_manual_name' VARCHAR, 'productmanbody' VARCHAR)";
...
NSString *const kTableUserImagesSchema = @"CREATE TABLE IF NOT EXISTS UserImages ('local_id' INTEGER PRIMARY KEY NOT NULL DEFAULT (0), 'username' VARCHAR, 'userimage' BLOB)";
