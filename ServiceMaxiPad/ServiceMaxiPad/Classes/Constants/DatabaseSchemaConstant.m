...
NSString *const kTableSFOPDocHtmlDataSchema = @"CREATE TABLE IF NOT EXISTS SFOPDocHtmlData ('local_id' VARCHAR,'object_api_name' VARCHAR, 'opdoc_data' TEXT, 'sf_id' TEXT, 'WorkOrderNumber' VARCHAR, 'doc_name' TEXT, 'process_id' TEXT)";
