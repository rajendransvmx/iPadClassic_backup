...
static NSInteger kNumberOfRecordsToSendPerBatch = 2000;
...
if (SMLogHandler && SMLogLevel>=minLevel) SMLogHandler(4, SMLogSourceFileName, SMLogSourceLineNumber, SMLogSourceMethodName, format, ##__VA_ARGS__);
 ...
 */
void SMLogSetLogLevel(NSUInteger logLevel);
