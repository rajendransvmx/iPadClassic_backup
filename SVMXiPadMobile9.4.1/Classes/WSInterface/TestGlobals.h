...
#define gFIELD_RELATED_OBJECT_SEARCH_ID                 @"SVMXCX1__Named_Search__c"
...
#define gSLA_CLOCK                                      @"SVMXCX1__Use_For_SLA_Clock__c"
#define gFIELD_OVERRIDE_RELATED_LOOKUP                  @"SVMXCX1__Override_Related_Lookup__c"
