...
- (void)explainMe
{
    SXLogInfo(@"recordLocalId : %@ \n sfId : %@ \n recordType : %@ \n operation : %@ \n  objectName : %@ \n parentObjectName : %@ \n parentLocalId : %@ \n  recordSent : %@ \n webserviceName : %@ \n className : %@ \n syncType : %@ \n headerLocalId : %@ \n  requestData : %@ \n requestId : %@ \n timeStamp : %@",  recordLocalId,sfId, recordType,operation,objectName, parentObjectName,parentLocalId,recordSent,webserviceName,className,syncType,headerLocalId,requestData,requestId,timeStamp);
}
@end