...
@interface SMXEditEventView () <UIGestureRecognizerDelegate>
...
@implementation SMXEditEventView
...
- (void)addButtonCancel {
    ...
    [self customLayoutOfButton:buttonCancel withTitle:[[TagManager sharedInstance]tagByName:kTagAddTaskCancelButton] action:@selector(buttonCancelAction:) frame:CGRectMake(20, 0, 80, BUTTON_HEIGHT+30)];
...
- (void)addButtonDate {
    ...
    buttonDate = [[SMXButtonWithDatePopover alloc] initWithFrame:CGRectMake(0, searchBarCustom.frame.origin.y+searchBarCustom.frame.size.height+2, self.frame.size.width, BUTTON_HEIGHT) date:event.ActivityDateDay];
...
- (void)addButtonTimeBegin {
    ...
    buttonTimeBegin = [[SMXButtonWithHourPopover alloc] initWithFrame:CGRectMake(0, buttonDate.frame.origin.y+buttonDate.frame.size.height+BUTTON_HEIGHT, self.frame.size.width, BUTTON_HEIGHT) date:event.dateTimeBegin];
...
- (void)addButtonTimeEnd {
    ...
    buttonTimeEnd = [[SMXButtonWithHourPopover alloc] initWithFrame:CGRectMake(0, buttonTimeBegin.frame.origin.y+buttonTimeBegin.frame.size.height+2, self.frame.size.width, BUTTON_HEIGHT) date:event.dateTimeEnd];
...
- (void)addButtonDelete {
    ...
    [self customLayoutOfButton:buttonDelete withTitle:[[TagManager sharedInstance]tagByName:kTag_DeleteEvent] action:@selector(buttonDeleteAction:) frame:CGRectMake(0, self.frame.size.height-2*BUTTON_HEIGHT, self.frame.size.width, 2*BUTTON_HEIGHT)];
...
- (void)addtableViewGuests {
    ...
    tableViewGuests = [[SMXGuestsTableView alloc] initWithFrame:CGRectMake(0, y, self.frame.size.width,buttonDelete.frame.origin.y-y-BUTTON_HEIGHT)];
