...
-(void)openViewProcessForContact:(id)sender
{
    ...
    [[SMXCalendarViewController sharedInstance] eventSelectedShare:event userInfor:@{@"contactID":cContactModel.localId, @"objectName":objectModel.objectName}];
}
...
-(void)addLabelPriority
{
    ...
    [priorityLevelLabel setText:cWOModel.priorityString];
...
-(void)addLabelBillingType
{
    ...
    [billingTypeLabel setText:([cWOModel.billingType length] > 0 ? cWOModel.billingType: @"--")];
...
-(void)addLabelOrderStatus
{
    ...
    [orderStatusLabel setText:([cWOModel.orderStatus length] > 0 ? cWOModel.orderStatus: @"--")];
...
-(void)addLabelPurposeOfVisit
{
    ...
    [purposeOfVisitLabel setText:([cWOModel.purposeOfVisit length] > 0 ? cWOModel.purposeOfVisit: @"--")];
