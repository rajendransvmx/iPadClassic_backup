...
{
    self.configLastModifiedDate  = [Utility getDatetimeFromString:lastServerConfigTime];
        ...
        for (SMObjectRelationModel * relationModel in childObjects) //9936 Defect Fix
        {
            if (relationModel != nil)
            {
                ...
                if (purgeModel != nil && purgeModel.isPurgeable)
                {
                    ...
                    NSMutableArray * childIds = [SMDataPurgeHelper getAllChildIdsForObject:relationModel parentId:Ids parentName:parentObject];
