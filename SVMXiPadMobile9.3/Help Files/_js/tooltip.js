...
config. BgColor			= '#FFFFFF' //'#E2E7FF'	// Background colour (HTML colour value, in quotes)
config. BgImg			= ''		// Path to background image, none if empty string ''
config. BorderColor		= '#B7C2CF'
config. BorderStyle		= 'solid'	// Any permitted CSS value, but I recommend 'solid', 'dotted' or 'dashed'
config. BorderWidth		= 1
config. BorderRadius  = 60
config. MozBorderRadius  = 60
config. WebkitBorderRadius = 60
