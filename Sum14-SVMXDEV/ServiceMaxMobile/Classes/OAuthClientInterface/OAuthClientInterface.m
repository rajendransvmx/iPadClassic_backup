...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType;
{
	...
	{
        //011758 Any navigation item in the web view clicked should take the control to next screen.
        //except for 
...
- (BOOL)refreshAccessToken:(NSString *)refresh_Token isInvokeByBackgroundProcess:(BOOL)isBackgroundProcess
{
	...
	if ( dict && [dict valueForKey:@"access_token"] )
	{
        ...
        /** remove remote access revoked as we have new valid session */
