...
var GetDataForTemplateDetailsRecord = function(inputObj, templateDetailRecords, localId, index, callbackFunction)
{
...
//                                                            alert("Data base error ");
                                                          ...
                                                          advCriteriaExpression = advCriteriaExpression + " and " + numOfCriteriaFields;
                                                          }
...
//                                                          alert(JSON.stringify(templateDetailRecords[index]));
                                                          ...
                                                          if(templateDetailRecords.length > nextIndex)
                                                            GetDataForTemplateDetailsRecord(inputObj, templateDetailRecords, localId, nextIndex, callbackFunction);
                                                          else {
                      ...
                      /* Update template_details_record data */
                      templateDetailRecords[index].criteria = [{fieldName:hdr_ref_fld,fieldValue:ref_fld_Id,operator:'='}];
                      templateDetailRecords[index].advancedExpression = null;
...
//                                        alert("Found!! Now break :)");
                                        ...
                                        var fields = [{fieldName:'local_id',fieldType:'TEXT'}];
                                        var criteria = [{fieldName:tdRecord.header_ref_fld,fieldValue:recordId,operator:'='}];
                                        $DAL.executeQuery(tablename,fields,criteria,null,null,function(request)
                                                          ...
                                                          wo_local_id = local_id_obj.local_id;
                                                        
                                                          
                                                          // Recursive function here
                                                          GetDataForTemplateDetailsRecord(inputObj, templateDetailRecords, wo_local_id, 0, function(result)
                                                                                          {
