...
@property (nonatomic,assign) BOOL didUpdateTechnicianLocation;
@property (nonatomic, retain) CLLocationManager *locationManager;
@property (nonatomic, assign) int locationPingTimerValue;
@property (nonatomic,assign) BOOL isLocationPingEnabled;
@property (nonatomic,assign) BOOL didQueryTechnician;
@property (nonatomic,assign) BOOL didQueryActiveTechnician;
// Reachability
