...
- (IBAction) createPDF;
{
    ...
    if(enable_summary_generation)
    {
        ...
        [self presentModalViewController:pdfCreator animated:YES];
    }
}
...
{    
	...
	switch (indexPath.section)
	{
		...
		case 1:
		{
            ...
            SMLog(@"Parts Formatted Cost = %@",[self getFormattedCost:totalCost]);
		...
		case 2:
		{
            ...
            SMLog(@"Labor Formatted Cost = %@",[self getFormattedCost:totalCost]);
			 LblTotalCost.text = [NSString stringWithFormat:@"%@%@", AppDelegate.workOrderCurrency, [self getFormattedCost:totalCost]];
		...
		case 3:
		{
            ...
            SMLog(@"Expenses Formatted Cost = %@",[self getFormattedCost:totalCost]);
			LblTotalCost.text = [NSString stringWithFormat:@"%@%@",AppDelegate.workOrderCurrency, [self getFormattedCost:totalCost]];
			view = expensecell;
			break;
		}
