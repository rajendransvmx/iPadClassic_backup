...
function DocDetailsAfterMediaResources(media_res_array,media_res_json_array,templateId, callbackFunction,gObjectData)
{
        ...
        templateRecord=templateRecord.replace("media_resources","SPR14__Media_Resources__c");
        ...
        $DAL.executeQuery(dtdObj,dtdfields,dtdcriteria,null,null,function(request)
                          ...
                          templateDetailsRecord=templateDetailsRecord.replace(/fields/g,"SPR14__Fields__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/object_name/g,"SPR14__Object_Name__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/alias/g,"SPR14__Alias__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/type/g,"SPR14__Type__c");
...
var doc1 = {};
doc1.object_name = "SPR14__Service_Order__c";
...
var doc2 = {};
doc2.object_name = "SPR14__Service_Order__c";
