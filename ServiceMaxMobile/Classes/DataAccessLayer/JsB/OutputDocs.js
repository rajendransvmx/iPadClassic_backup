...
function DocDetailsAfterMediaResources(media_res_array,media_res_json_array,templateId, callbackFunction,gObjectData)
{
        ...
        templateRecord=templateRecord.replace("media_resources","SVMXDEV__Media_Resources__c");
        ...
        $DAL.executeQuery(dtdObj,dtdfields,dtdcriteria,null,null,function(request)
                          ...
                          templateDetailsRecord=templateDetailsRecord.replace(/fields/g,"SVMXDEV__Fields__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/object_name/g,"SVMXDEV__Object_Name__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/alias/g,"SVMXDEV__Alias__c");
                          templateDetailsRecord=templateDetailsRecord.replace(/type/g,"SVMXDEV__Type__c");
...
var doc1 = {};
doc1.object_name = "SVMXDEV__Service_Order__c";
...
var doc2 = {};
doc2.object_name = "SVMXDEV__Service_Order__c";
