...
ChatterDelegate,
SFWToolBarDelegate,RefreshSyncStatusButton,ZBarReaderDelegate,databaseInterfaceProtocol,JSExecuterDelegate, SFMEditDetailDelegate, SFMChildViewDelegate, UIAlertViewDelegate,ImageViewControllerDelegate,UIImagePickerControllerDelegate> //Radha :- Implementation  for  Required Field alert in Debrief UI
{
