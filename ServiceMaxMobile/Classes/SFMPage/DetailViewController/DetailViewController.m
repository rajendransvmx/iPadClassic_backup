                    ...
                    if([key isEqualToString:filed_api_name])
                    {
                        ...
                        else if([field_data_type isEqualToString:@"currency"]) //10346
                        {
                            ...
                            if (scale >= 0)
                            {
                                ...
                                {
                                    field_value = field_key;
                                    NSMutableString * scalingString = [NSMutableString stringWithFormat:@"%@", field_key];
                ...
                for(int m = 0 ; m < [eachArray count];m++)
                {
                    ...
                    else if ([[fieldDataType objectForKey:api_name] isEqualToString:@"currency"]) //10346
                    {
                        ...
                        if (scale >= 0)
                        {
                            if ([value length] > 0)
                            {
                                NSMutableString * scalingString = [NSMutableString stringWithFormat:@"%@", value];
                        ...
                        if([field_key length] != 0)
                        {
                            ...
                            else if ([field_data_type isEqualToString:@"currency"]) //10346
                            {
                                ...
                                if (scale >= 0)
                                {
                                    ...
                                    {
                                        NSMutableString * scalingString = [NSMutableString stringWithFormat:@"%@", field_value];
                ...
                for (int i=0;i<[header_sections count];i++)
                {
                    ...
                    for (int j=0;j<[section_fields count];j++)
                    {
                        ...
                        else if ([dataType isEqualToString:@"currency"]) //10346
                        {
                            ...
                            {
                                value = [formattedNumber stringByReplacingOccurrencesOfString:@"," withString:@""];
