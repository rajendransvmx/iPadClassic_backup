...
- (void) didSwitchProcess:(NSDictionary *)objectDictionary
{
    ...
    else
    {
        ...
        NSLog(@"Exception Name databaseInterfaceSfm :didSwitchProcess %@",exp.name);
        NSLog(@"Exception Reason databaseInterfaceSfm :didSwitchProcess %@",exp.reason);
...
- (void)viewDidLoad
{
    ...
    if (!isInEditDetail)
    {
        ...
        [self didReceivePageLayoutOffline];
		NSLog(@"%@", CGRectCreateDictionaryRepresentation(self.navigationController.navigationBar.frame));
        // ################ BACK BUTTON HERE ################# //
...
- (void) didInternetConnectionChange:(NSNotification *)notification
{
    ...
    if (isReachable)
    {
        NSLog(@"DetailViewController Internet Reachable");
    }
    else
    {
        NSLog(@"DetailViewController Internet Not Reachable");
...
//        [details_api_keys release];
    ...
    if([process_type isEqualToString:@"VIEWRECORD"] )
    {
        ...
        if(!Entry_criteria)
        {
            ...
            NSLog(@"***************** process_exists: %d process_id: %@",processInfo.process_exists,processInfo.process_id);
...
//            [details_api_keys release];
    ...
    appDelegate.didsubmitModelView = TRUE;
        ...
        NSLog(@"Exception Name DetailViewController :fillSFMdictForOfflineforProcess %@",exp.name);
        NSLog(@"Exception Reason DetailViewController :fillSFMdictForOfflineforProcess %@",exp.reason);
         [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
     }
...
//            [popover presentPopoverFromRect:CGRectMake(900, 21, 67, 20) inView:appDelegate.sfmPageController.view permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
        ...
        NSLog(@"Exception Name DetailViewController :action %@",exp.name);
        NSLog(@"Exception Reason DetailViewController :action %@",exp.reason);
        [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
...
{    
       ...
       if([appDelegate.syncThread isExecuting])
        {
            while (CFRunLoopRunInMode(kCFRunLoopDefaultMode, kRunLoopTimeInterval, YES))
            {
                ...
                NSLog(@"DetailViewController.m : didInvokeWebService: GetPrice1");
#endif
    ...
    if ([appDelegate.metaSyncThread isExecuting])
    {
        ...
        {
#ifdef kPrintLogsDuringWebServiceCall
            NSLog(@"DetailViewController.m : didInvokeWebService: GetPrice2");
#endif
    ...
    else
    {
        ...
        if ([appDelegate.event_thread isExecuting])
        {
            ...
            {
#ifdef kPrintLogsDuringWebServiceCall
                NSLog(@"DetailViewController.m : didInvokeWebService: GetPrice3");
#endif
        ...
        if ([appDelegate isInternetConnectionAvailable])
        {
            ...
            {
#ifdef kPrintLogsDuringWebServiceCall
                NSLog(@"DetailViewController.m : didInvokeWebService: customwebservicecall");
#endif
        ...
        NSLog(@"Exception Name DetailViewController :didInvokeWebService %@",exp.name);
        NSLog(@"Exception Reason DetailViewController :didInvokeWebService %@",exp.reason);
        [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
...
- (void) startSummaryDataFetch
{
    ...
    [(SFMPageController *)delegate presentViewController:navController animated:YES completion:nil];
        ...
        NSLog(@"Exception Name DetailViewController :startSummaryDataFetch %@",exp.name);
        NSLog(@"Exception Reason DetailViewController :startSummaryDataFetch %@",exp.reason);
        [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
    @finally {
    [activity stopAnimating];
...
- (NSString *) getObjectNameFromHeaderData:(NSDictionary *)dictionary forKey:(NSString *)key
{
    ...
    for (NSString * _key in allKeys)
    {
        ...
        NSLog(@"Exception Name DetailViewController :getObjectNameFromHeaderData %@",exp.name);
        NSLog(@"Exception Reason DetailViewController :getObjectNameFromHeaderData %@",exp.reason);
        [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
...
- (void) showChatter
{
    ...
    [_chatter release];
        ...
        NSLog(@"Exception Name DetailViewController :showChatter %@",exp.name);
        NSLog(@"Exception Reason DetailViewController :showChatter %@",exp.reason);
        [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
    @finally
    {
...
- (void) animation1DidStop:(NSString *)animationID finished:(NSNumber *)finished context:(void *)context
{
    ...
    @catch (NSException *exception) {
        ...
        NSLog(@"Exception Name DetailViewController :animation1DidStop %@",exception.name);
        NSLog(@"Exception Reason DetailViewController :animation1DidStop %@",exception.reason);
...
- (void) getExpenses:(ZKQueryResult *)result error:(NSError *)error context:(id)context
{
	...
	for (int i = 0; i < [array count]; i++)
    {
        ...
        NSLog(@"Exception Name DetailViewController :getExpenses %@",exp.name);
        NSLog(@"Exception Reason DetailViewController :getExpenses %@",exp.reason);
        [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
...
//                                }
    ...
    else
    {
        ...
        {
#ifdef kPrintLogsDuringWebServiceCall
            NSLog(@"DetailViewController.m : offlineActions: customAction");
#endif
        ...
        if(performSync && !(appDelegate.connection_error))
        {
            ...
            {
                NSLog(@"Wait For Data Sync to Finish");
                while (CFRunLoopRunInMode( kCFRunLoopDefaultMode, kRunLoopTimeInterval, FALSE))
                {
#ifdef kPrintLogsDuringWebServiceCall
                    NSLog(@"DetailViewController.m : offlineActions: datasync thread status check");
#endif
            ...
            {
#ifdef kPrintLogsDuringWebServiceCall
                NSLog(@"DetailViewController.m : offlineActions: datasync thread status check 2");
#endif

                if (![appDelegate isInternetConnectionAvailable])
                {
                    [activity stopAnimating];
                    NSLog(@"Data Sync stopper due to Internet Connection Failure");
                    return;
                }
...
- (BOOL) executeBizRules
{
    ...
    {
        NSLog(@"Biz Rule related Tables/Fields are missing. Not executing Biz Rule.Please do Meta Sync.");
    ...
    if(ruleFieldsCount)
    {
        ...
        NSLog(@"Rules = %@",rulesString);
        NSLog(@"Fields = %@",fieldsString);
        NSLog(@"Data To Validate = %@",dataToValidateString);
        ...
        activity.hidden = YES;
        [activity stopAnimating];
        NSLog(@"bizRuleResult Warnings = %@",[bizRuleResult objectForKey:@"warnings"]);
        NSLog(@"bizRuleResult Errors = %@",[bizRuleResult objectForKey:@"errors"]);
    ...
    {
        NSLog(@"No Business Rule Found for Header and Detail");
        [childObjectNamesArray release];
        childObjectNamesArray = nil;
        [jsonWriter_ release];
        jsonWriter_ = nil;
                                ...
                                withParentObject:(NSString *)parentObjectName
{
    ...
    for(NSDictionary *sectionDict in headerArray)
    {
        ...
        NSLog(@" New Record. Get the key and value from the SFMPage");
    }
    ...
    for(NSDictionary *childDict in childObjectsArray)
    {
        ...
        {
            NSLog(@"Child Relationship is not found");
            [detailArray release];
            [detailDict release];
            continue;
        }
        ...
        if(!columnName)
        {
            NSLog(@"Column Name is not there");
            [detailArray release];
            [detailDict release];
            continue;
        }
...
- (BOOL) bizRuleResourcesAvailable
{
    ...
    for(NSString *library in resourceList)
    {
        ...
        if (![[NSFileManager defaultManager] fileExistsAtPath:dataPath])
        {
            NSLog(@"Resource %@ is not available",dataPath);
...
- (void) SeeMoreButtonClicked:(id)sender
{
    ...
    if ([appDelegate.syncThread isExecuting])
    {
        ...
        {
#ifdef kPrintLogsDuringWebServiceCall
            NSLog(@"DetailViewController.m : seeMoreButtonsClicked: checkfor Data Sync");
#endif
    ...
    if ([appDelegate.metaSyncThread isExecuting])
    {
        ...
        {
#ifdef kPrintLogsDuringWebServiceCall
            NSLog(@"DetailViewController.m : seeMoreButtonsClicked: checkfor Meta Sync");
#endif
    ...
    if ([appDelegate.event_thread isExecuting])
    {
        ...
        {
#ifdef kPrintLogsDuringWebServiceCall
            NSLog(@"DetailViewController.m : seeMoreButtonsClicked: checkfor Event Sync");
#endif
    ...
    if (button.tag == 1)
    {
        ...
        {
#ifdef kPrintLogsDuringWebServiceCall
            NSLog(@"DetailViewController.m : seeMoreButtonsClicked: product History");
#endif
    ...
    else if (button.tag == 2)
    {
        ...
        {
#ifdef kPrintLogsDuringWebServiceCall
            NSLog(@"DetailViewController.m : seeMoreButtonsClicked: account history");
#endif
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex;
{
    ...
    if(alertTag >= 1000)
    {
        if(buttonIndex)
        {
            ...
            NSLog(@"[Alert %d] Confirm Message Cancelled",alertView.tag);
        }
        else
        {
            alertViewStatus = kBizRuleConfirmMessageSaved;
            NSLog(@"[Alert %d] Confirm Message Saved",alertView.tag);
        }
    }
    else
    {
...
- (void)eventOccured:(NSString *)eventName andParameter:(NSString *)jsonParameterString {
    NSLog(@"Event name is %@ and %@",eventName,jsonParameterString);
    ...
    else if ([eventName isEqualToString:@"bizruleresult"])
    {
        ...
        NSLog(@"Data  = %@",jsonParameterString);
    }
}
