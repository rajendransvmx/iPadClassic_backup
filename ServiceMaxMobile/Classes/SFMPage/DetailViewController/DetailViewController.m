...
-(void) displayAttachmentSharingView:(NSArray *)dataSource viewName:(NSString *)view
{
    ...
    [sharingView setCompletionHandler:^(NSString *activityType, BOOL completed) {
        ...
        if (activityType == UIActivityTypeMail)
        {
            ...
            {
                UIAlertView *mailErrorAlert = [[UIAlertView alloc]initWithTitle:[appDelegate.wsInterface.tagsDictionary objectForKey:alert_application_error] message:@"Please configure a valid mail account." delegate:nil cancelButtonTitle:[appDelegate.wsInterface.tagsDictionary objectForKey:ALERT_ERROR_OK] otherButtonTitles:nil];
                [mailErrorAlert show];
