...
-(void)updateParentSfidInAttachmentTrailer
{
    ...
    NSString *selectQuery=[NSString stringWithFormat:@"SELECT parent_localid,objectName,attachment_id,type FROM SFAttachmentTrailer where  (parent_sfid ='' OR parent_sfid is null )"];
