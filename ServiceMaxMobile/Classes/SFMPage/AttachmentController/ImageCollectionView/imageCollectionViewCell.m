...
;
    ...
    else if([type isEqualToString:LAST_MOD_DATE])
    {
        ...
        self.lastModifiedDate = [[UILabel alloc] initWithFrame:[self getrectFor:LAST_MOD_DATE]];
...
{
    UIImage * selectionImage = [UIImage imageNamed:@"check.png"];
...
{
    UIImage * selectionImage = [UIImage imageNamed:@"uncheck.png"];
    CGRect rect =  CGRectMake(0, 0, 48, 48);;
    UIImageView * selectionImg = [[UIImageView alloc]initWithImage:selectionImage];
    selectionImg.frame = rect;
