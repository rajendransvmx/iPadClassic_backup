...
-(void)tapSpinner:(id)sender
{
	@try{
        ...
        {
            contentView.spinnerData = [ appDelegate.databaseInterface  getRTPicklistValuesForFieldApiName:parent.fieldAPIName objectApiName:SFM_ObjectName recordTypeId:RecordTypeId];
