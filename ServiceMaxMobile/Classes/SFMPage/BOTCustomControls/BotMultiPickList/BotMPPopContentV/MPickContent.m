...
- (void)viewDidLoad
{
    ...
    {
            NSLog(@"Exception Name MPickContent :viewDidLoad %@",exp.name);
            NSLog(@"Exception Reason MPickContent :viewDidLoad %@",exp.reason);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   static NSString * identifier = @"cellidentifier";
	...
	NSLog(@"Exception Name MPickContent :cellForRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason MPickContent :cellForRowAtIndexPath %@",exp.reason);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSLog(@"Exception Name MPickContent :didSelectRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason MPickContent :didSelectRowAtIndexPath %@",exp.reason);
