...
- (void) setLookupData:(NSDictionary *)lookupDictionary
{
    ...
    if(appDelegate.isWorkinginOffline)
    {
        ...
        NSLog(@"Exception Name LookupView :setLookupData %@",exp.name);
        NSLog(@"Exception Reason LookupView :setLookupData %@",exp.reason);
...
{    
    ...
    @try{
        ...
        NSLog(@"Exception Name LookupView :accessoryButtonTappedForRowWithIndexPath %@",exp.name);
        NSLog(@"Exception Reason LookupView :accessoryButtonTappedForRowWithIndexPath %@",exp.reason);
        [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.accessoryType = UITableViewCellAccessoryDetailDisclosureButton;
        ...
        NSLog(@"Exception Name LookupView :cellForRowAtIndexPath %@",exp.name);
        NSLog(@"Exception Reason LookupView :cellForRowAtIndexPath %@",exp.reason);
        [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
    return cell;
}
...
- (BOOL)isCriteriaSupportedOnLookup {
    ...
    NSLog(@"Lookup filters is supported %@",currentServerPkgVersion);
    return YES;
}
