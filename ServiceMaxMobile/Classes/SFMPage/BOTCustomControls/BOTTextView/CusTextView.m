...
//        [self setAccessibilityIdentifier:@"required"];
        /*Accessibility changes*/
        [self setAccessibilityIdentifier:kAccRequiredField];

        
        [self addSubview:imgView];
        [self sendSubviewToBack:imgView];
        
        [[self.subviews objectAtIndex:0] setIsAccessibilityElement:YES];
//        [[self.subviews objectAtIndex:0] setAccessibilityIdentifier:@"required"];
        /*Accessibility changes*/
        [[self.subviews objectAtIndex:0] setAccessibilityIdentifier:kAccRequiredField];
        [imgView release];
    }
}
