...
- (void)viewDidLoad
{
	...
	NSLog(@"Exception Name SFWToolBar :viewDidLoad %@",exp.name);
	NSLog(@"Exception Reason SFWToolBar :viewDidLoad %@",exp.reason);
    }
...
-(void)showIpadOnlyButtons;
{
    ...
    for (int i = 0 ; i <[ipad_only_array count] ; i++) 
    {
        ...
        NSLog(@"Exception Name SFWToolBar :showIpadOnlyButtons %@",exp.name);
        NSLog(@"Exception Reason SFWToolBar :showIpadOnlyButtons %@",exp.reason);
    }
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section;
{
	...
	NSLog(@"Exception Name SFWToolBar :numberOfRowsInSection %@",exp.name);
	NSLog(@"Exception Reason SFWToolBar :numberOfRowsInSection %@",exp.reason);
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
	...
	NSLog(@"Exception Name SFWToolBar :cellForRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason SFWToolBar :cellForRowAtIndexPath %@",exp.reason);
    }
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section;
{
   ...
   // NSString * wizard_description = [dict objectForKey:WIZARD_DESCRIPTION];
	...
	NSLog(@"Exception Name SFWToolBar :titleForHeaderInSection %@",exp.name);
	NSLog(@"Exception Reason SFWToolBar :titleForHeaderInSection %@",exp.reason);
    }
