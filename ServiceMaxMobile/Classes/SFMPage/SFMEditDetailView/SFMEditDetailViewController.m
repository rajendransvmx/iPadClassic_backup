                ...
                if(view.tag == 1)
                {
                    ...
                    for(int l = 0; l < [detailValue count]; l++)
                    {
                        ...
                        if ([fieldType isEqualToString:[dict objectForKey:gVALUE_FIELD_API_NAME]])
                        {
                            ...
                            else if ([control_type isEqualToString:@"currency"]) //10346
                            {
                                NSString * detailObjectName = [detail objectForKey:gDETAIL_OBJECT_NAME];
                                ...
                                if ([fieldValue length] > 0)
                                {
                                    ...
                                    {
                                        NSString * string = [formattedNumber stringByReplacingOccurrencesOfString:@"," withString:@""];
                                        
                                        NSMutableString * scalingString = [NSMutableString stringWithFormat:@"%@", string];
...
- (UITableViewCell *)tableView:(UITableView *)tableView1 cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //10346
    if ([control_type isEqualToString:@"currency"])
    {
