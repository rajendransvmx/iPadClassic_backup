...
{
    NSString * rootpath_SYNHIST = [[[UIApplication sharedApplication] delegate] getAppCustomSubDirectory]; // [NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) objectAtIndex:0];
