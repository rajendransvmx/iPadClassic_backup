...
- (void)viewDidLoad
{
	...
	NSLog(@"Exception Name SelectProcessController :viewDidLoad %@",exp.name);
	NSLog(@"Exception Reason SelectProcessController :viewDidLoad %@",exp.reason);
    }
...
- (void) buttonClicked:(id)sender
{
	...
	NSLog(@"Exception Name SelectProcessController :buttonClicked %@",exp.name);
	NSLog(@"Exception Reason SelectProcessController :buttonClicked %@",exp.reason);
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSLog(@"Exception Name SelectProcessController :cellForRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason SelectProcessController :cellForRowAtIndexPath %@",exp.reason);
    }
