...
- (void)viewDidLoad
{
	...
	NSLog(@"Exception Name SyncStatusView :viewDidLoad %@",exp.name);
	NSLog(@"Exception Reason SyncStatusView :viewDidLoad %@",exp.reason);
    }
...
-(void)refreshMetaSyncStatus
{
	...
	NSLog(@"Exception Name SyncStatusView :refreshMetaSyncStatus %@",exp.name);
	NSLog(@"Exception Reason SyncStatusView :refreshMetaSyncStatus %@",exp.reason);
    }
