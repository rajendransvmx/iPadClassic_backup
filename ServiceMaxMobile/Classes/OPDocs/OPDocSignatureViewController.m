...
{
    _cancelButt.isAccessibilityElement = YES;
    [_cancelButt setAccessibilityIdentifier:kAccSignatureCancel];
    
    done_button.isAccessibilityElement = YES;
    [done_button setAccessibilityIdentifier:kAccSignatureDone];
    
    erase.isAccessibilityElement = YES;
    [erase setAccessibilityIdentifier:kAccSignatureErase];
    
    watermark.isAccessibilityElement = YES;
    [watermark setAccessibilityIdentifier:kAccWaterMark];
    
    drawImage.isAccessibilityElement = YES;
