...
- (void) sendLogsToServer
{
    ...
    while (CFRunLoopRunInMode(kCFRunLoopDefaultMode, kRunLoopTimeInterval, YES))
    {
        ...
        {
            //10312
            [self updateLastPushLogStausInPlist:PUSH_LOG_LABEL withValue:[self getFormattedDate]];
...
- (void) syncLogsToServer
{
    @try
    {
        ...
        NSDictionary *typeDict = [NSDictionary dictionaryWithObject:@"SPR14__SVMX_Job_Logs__c" forKey:@"type"];
...
//10312
-(void) updatePlist:(NSDictionary *)plistdict
{
    @try
    {
        ...
        {
            NSString * key = [[plistdict allKeys] objectAtIndex:0];
            NSString * value = [[plistdict allValues] objectAtIndex:0];
...
{
    NSArray *columns = [NSArray arrayWithObjects:@"SPR14__Log_Timestamp__c",@"SPR14__Log_level__c",@"SPR14__Log_Context__c",@"SPR14__Message__c",@"SPR14__Type__c",@"SPR14__Profile_Id__c",@"SPR14__Group_Id__c",@"SPR14__Log_Category__c",@"SPR14__Operation__c", nil];
    NSArray *logsArray = [appDelegate.dataBase getAllRecordsFromTable:@"SPR14__SVMX_Job_Logs__c"
                                                           forColumns:columns
...
- (void) operation:(INTF_WebServicesDefBindingOperation *)operation completedWithResponse:(INTF_WebServicesDefBindingResponse *)response
{
    ...
    @try {
        ...
        if(status)
        {
            ...
            NSString *jobLogTableName = @"SPR14__SVMX_Job_Logs__c";
            AppDelegate * appDelegate = (AppDelegate *)[[UIApplication sharedApplication] delegate];
