...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    if(appDelegate.IsLogedIn == ISLOGEDIN_TRUE)
    {
        ...
        //Data Purge - //TODO  - Uncomment once SPR14 patch is released
        //BOOL serverSupportPurge = ([appDelegate doesServerSupportsModule:kMinPkgForDataPurge])
        
        BOOL serverSupportPurge = YES; //TODO  - Remove once spr14 patch is released
...
-(void)doMetaSync
{
    ...
    @autoreleasepool
    {
        ...
        serverSupportPurge = YES; //TODO  - Remove once spr14 patch is released
