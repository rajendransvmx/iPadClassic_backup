...
@property (nonatomic, retain)NSMutableDictionary *partialExecutedValuesDict;
//NStimer to watch the sync activities - Defect - 10168
@property (nonatomic, retain)NSTimer             *syncWatchDogTimer;
