...
-(void) resetTableview
{
    ...
    if (dataPurgeDueView != nil)
    {
        ...
        CGFloat YAxis = 0.0;
        YAxis = dataPurgeDueView.frame.size.height + 30;
        self._tableView.frame = CGRectMake(0, YAxis, self._tableView.frame.size.width, self.view.frame.size.height-100);
    }
    else
    {
...
- (void) moveTableView
{
    if (syncDueView != nil && dataPurgeDueView != nil)
    {
        ...
        YAxis = height + height1 + 40;
        
        self._tableView.frame = CGRectMake(self._tableView.frame.origin.x, YAxis, self._tableView.frame.size.width, self.view.frame.size.height-100);
    }
    else
    {
        CGFloat YAxis = 0.0;
        if (syncDueView != nil)
            YAxis = syncDueView.frame.size.height + 30;
...
//    textViewFrame.size.height = 50;
    ...
    UITextView * textview = [[UITextView alloc] initWithFrame:CGRectMake(220, 3, size1.width + XAxisPadding, 50)];
    textview.backgroundColor = [UIColor clearColor];
...
- (void)addButtonsToDPDueView;
{
    ...
    CGSize size1 = [title sizeWithFont:[UIFont systemFontOfSize:19] constrainedToSize:CGSizeMake(CGRectGetMaxX(dataPurgeDueView.frame), 9999)];
    
    frame.origin.x = 210;
    frame.origin.y = 40;
    frame.size.width = size1.width + 24;
    ...
    [continueButton.titleLabel setFont:[UIFont boldSystemFontOfSize:19.0]];
    ...
    [removeButton.titleLabel setFont:[UIFont boldSystemFontOfSize:19.0]];
