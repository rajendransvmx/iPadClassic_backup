...
/*Radha - Data Purge - Delegate to present progress */
@protocol manualDataSyncDetailView;
...
@interface ManualDataSyncDetail : UIViewController <UIPopoverControllerDelegate, UITableViewDelegate, UITableViewDataSource, UISplitViewControllerDelegate, MyPopoverDelegate, ManualDataSyncRootDelegate, RefreshSyncUIStatusButton, ReloadSyncTable, UIAlertViewDelegate>
{
    ...
    /*Radha - Data Purge*/
    UIImageView * dataPurgeDueView;
    SMProgressBar * progressBar;
    id <manualDataSyncDetailView> detailDelagate;
}
/*Radha - Data Purge*/
@property(nonatomic, retain) id <manualDataSyncDetailView> detailDelagate;
...
@end
//Data Purge - Delegate implementation
@protocol manualDataSyncDetailView <NSObject>

- (void) addTranspertViewAndPresentProgressBar;
- (void) removeTransperentView;
