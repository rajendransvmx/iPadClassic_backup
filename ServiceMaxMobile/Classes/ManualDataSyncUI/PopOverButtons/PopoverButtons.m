...
- (void)loadView
{
    ...
    BOOL supportDataPurge =   YES; //TODO  - Remove once spr14 patch is released  //[appDelegate doesServerSupportsModule:kMinPkgForDataPurge];
...
- (void)dataPurge
{
    ...
    NSLog(@"Before data purge started");
...
//	[delegate disableControls];
    ...
    @try {
        ...
        if (YES)//TODO  - Remove once spr14 patch is released
        {
            /*********** Data Purge - Radha *************/
