...
- (void) layout
{
    ...
    @try{
        ...
        NSLog(@"Exception Name RecentObjectDetail :viewDidLoad %@",exp.name);
        NSLog(@"Exception Reason RecentObjectDetail :viewDidLoad %@",exp.reason);
    }
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
	...
	NSLog(@"Exception Name RecentObjectDetail :numberOfRowsInSection %@",exp.name);
	NSLog(@"Exception Reason RecentObjectDetail :numberOfRowsInSection %@",exp.reason);
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSLog(@"Exception Name RecentObjectDetail :cellForRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason RecentObjectDetail :cellForRowAtIndexPath %@",exp.reason);
    }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSLog(@"Exception Name RecentObejctDetail :didSelectRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason RecentObejctDetail :didSelectRowAtIndexPath %@",exp.reason);
    }
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(processId == nil || [processId length] == 0){
        ...
        NSLog(@"Exception Name RecentObejctDetail :accessoryButtonTappedForRowWithIndexPath %@",exp.name);
        NSLog(@"Exception Reason RecentObejctDetail :accessoryButtonTappedForRowWithIndexPath %@",exp.reason);
    }
    @finally {
        [activity stopAnimating];
    }
...
- (void) didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSLog(@"Exception Name RecentObjectDetail :didSelectRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason RecentObjectDetail :didSelectRowAtIndexPath %@",exp.reason);
    }
