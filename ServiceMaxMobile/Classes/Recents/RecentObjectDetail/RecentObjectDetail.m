...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString * date = @"";
    NSDate * savedDate = nil;
    if ([[dict objectForKey:gDATE_TODAY] isKindOfClass:[NSString class]])
    {
        savedDate = [Utility getDateFromStringFromPlist:[dict objectForKey:gDATE_TODAY] userRedable:YES];
    }
    else
    {
       savedDate = [dict objectForKey:gDATE_TODAY];
    }
    date = [Utility getStringFromDateForDeviceTime:savedDate];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString * processId = [dict objectForKey:@"SVMXDEV__ProcessID__c"];
    ...
    @try{
     if(processId == nil || [processId length] == 0)
     {
        ...
        {
            NSString * viewLayoutObjectName = [dict objectForKey:SVMXDEV_OBJECT_NAME];
