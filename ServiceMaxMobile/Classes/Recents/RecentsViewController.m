...
- (void) showSFMWithProcessId:(NSString *)processId recordId:(NSString *)recordId objectName:(NSString *)objectName
{
    ...
    {
        NSLog(@"Exception Name RecentsViewController :showSFMWithProcessId %@",exp.name);
        NSLog(@"Exception Reason RecentsViewController :showSFMWithProcessId %@",exp.reason);
    }
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    {
        NSLog(@"Exception Name RecentViewController :numberOfRowsInSection %@",exp.name);
        NSLog(@"Exception Reason RecentViewController :numberOfRowsInSection %@",exp.reason);
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        NSLog(@"Exception Name RecentsViewController :cellForRowAtIndexPath %@",exp.name);
        NSLog(@"Exception Reason RecentsViewController :cellForRowAtIndexPath %@",exp.reason);
    }
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        NSLog(@"Exception Name RecentsViewController :didSelectRowAtIndexPath %@",exp.name);
        NSLog(@"Exception Reason RecentsViewController :didSelectRowAtIndexPath %@",exp.reason);
    }
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        NSLog(@"Exception Name RecentsViewController :accessoryButtonTappedForRowWithIndexPath %@",exp.name);
        NSLog(@"Exception Reason RecentsViewController :accessoryButtonTappedForRowWithIndexPath %@",exp.reason);
    }
...
- (NSMutableArray *) getRecentsArrayFromObjectHistoryPlist
{
	...
	@catch (NSException *exp)
    {
        NSLog(@"Exception Name RecentViewController :getRecentsArrayFromObjectHistoryPlist %@",exp.name);
        NSLog(@"Exception Reason RecentViewController :getRecentsArrayFromObjectHistoryPlist %@",exp.reason);
    }
