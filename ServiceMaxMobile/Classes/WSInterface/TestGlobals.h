...
//  iService
//
//  Created by Pavamanaprasad Athani on 19/11/11.
//  Copyright (c) 2011 Bit Order Technologies. All rights reserved.
//

#ifndef iService_TestGlobals_h
#define iService_TestGlobals_h
...
#define gFIELD_RELATED_OBJECT_SEARCH_ID                 @"SVMXDEVX1__Named_Search__c"
...
#define gSLA_CLOCK                                      @"SVMXDEVX1__Use_For_SLA_Clock__c"
#define gFIELD_OVERRIDE_RELATED_LOOKUP                  @"SVMXDEVX1__Override_Related_Lookup__c"
