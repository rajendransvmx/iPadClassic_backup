...
//create Process
#define  SPR14_OBJECT_NAME                              @"SPR14__Source_Object_Name__c"

// View Layout Constants
#define gPROCESS_TYPE                                   @"SPR14__ServiceMax_Processes__c"
#define gPROCESS_ID                                     @"SPR14__ProcessID__c"
#define gPROCESS_NAME                                   @"SPR14__Name__c"
...
#define gBUTTON_TARGET_CALL                             @"SPR14__Target_Call__c"
#define gBUTTON_EVENT_CALL_TYPE                         @"SPR14__Event_Call_Type__c"
#define gBUTTON_EVENT_TYPE                              @"SPR14__Event_Type__c"
#define gBUTTON_EVENT_ENABLE                            @"Enable"
                                    
//sahana 1st Aug 2011
#define gEVENT_ID                                       @"SPR14__Event_Id__c"
#define gEVENT_TARGET_CALL                              @"SPR14__Target_Call__c"
#define gEVENT_CALL_TYPE                                @"SPR14__Event_Call_Type__c"
#define gEVENT_TYPE                                     @"SPR14__Event_Type__c"
#define gEVENT_NAME                                     @"Name"
#define gEVENT_LAYOUT_ID                                @"SPR14__Page_Layout__c"
...
#define gId                                             @"Id_"
#define gSPR14__Billing_Type__c                         @"SPR14__Billing_Type__c"
#define gSPR14__Clock_Paused_Forever__c                 @"SPR14__Clock_Paused_Forever__c"
#define gSPR14__Company__c                              @"SPR14__Company__c"
#define gSPR14__Customer_Down_Status__c                 @"SPR14__Customer_Down_Status__c"
#define gSPR14__Customer_Down__c                        @"SPR14__Customer_Down__c"
#define gSPR14__Order_Status__c                         @"SPR14__Order_Status__c"
#define gSPR14__Order_Type__c                           @"SPR14__Order_Type__c"
#define gSPR14__Problem_Description__c                  @"SPR14__Problem_Description__c"
#define gSPR14__SLA_Clock_Paused__c                     @"SPR14__SLA_Clock_Paused__c"
#define gSPR14__Service_Duration__c                     @"SPR14__Service_Duration__c"
#define gSPR14__Actual_Resolution__c                    @"SPR14__Actual_Resolution__c"
#define gSPR14__Actual_Restoration__c                   @"SPR14__Actual_Restoration__c"
#define gSPR14__Resolution_Customer_By__c               @"SPR14__Resolution_Customer_By__c"
#define gSPR14__Restoration_Customer_By__c              @"SPR14__Restoration_Customer_By__c"
#define gSPR14__Product__c                              @"SPR14__Product__c"
#define gSPR14__Product_Name__c                         @"SPR14__Product_Name__c"
...
#define gFIELD_RELATED_OBJECT_SEARCH_ID                 @"SPR14__Named_Search__c"
...
#define gSLA_CLOCK                                      @"SPR14__Use_For_SLA_Clock__c"
#define gFIELD_OVERRIDE_RELATED_LOOKUP                  @"SPR14__Override_Related_Lookup__c"
//Aparna: FORMFILL
#define gFIELD_MAPPING                                  @"SPR14__Field_Mapping__c"

//krishna : CONTEXT FILTER
#define gCONTEXTSOURCEOBJ                               @"SPR14__Context_Source_Object__c"
...
//Radha
#define gHEADER_SHOW_HIDE_QUICK_SAVE                    @"SPR14__Hide_Quick_Save__c"
#define gHEADER_SHOW_HIDE_SAVE                          @"SPR14__Hide_Save__c"
...
#define gSPR14__Product__r                              @"SPR14__Product__r"
#define gSPR14__Actual_Quantity2__c                     @"SPR14__Actual_Quantity2__c"
#define gPartsUsed                                      @"PartsUsed"
#define gSPR14__Work_Description__c                     @"SPR14__Work_Description__c"
#define gSPR14__Actual_Price2__c                        @"SPR14__Actual_Price2__c"
#define gSPR14__Discount__c                             @"SPR14__Discount__c"
...
#define gDETAILS_EVENT_INFO                             @"SPR14__SFM_Event__c"
...
#define gDetail_MULTIADD_CONFIG                         @"SPR14__Multi_Add_Configuration__c"
#define gDETAIL_MULTIADD_SEARCH                         @"SPR14__Multi_Add_Search_Field__c"
#define gDETAIL_MULTIADD_SEARCH_OBJECT                  @"SPR14__Multi_Add_Search_Object__c"
#define gDETAIL_SEQUENCE_NO                             @"SPR14__Sequence__c"
...
#define DEFAULT_LOOKUP_COLUMN                           @"SPR14__Default_Lookup_Column__c"
...
// What is a WorkOrder
#define WORKORDER                                       @"SPR14__Service_Order__c"


//Radha
#define gSPR14X1__Name__c                               @"SPR14X1__Name__c"
#define gSPR14X1__Page_Layout_ID__c                     @"SPR14X1__Page_Layout_ID__c"
