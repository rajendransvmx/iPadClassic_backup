...
//create Process
#define  SVMXDEV_OBJECT_NAME                              @"SVMXDEV__Source_Object_Name__c"

// View Layout Constants
#define gPROCESS_TYPE                                   @"SVMXDEV__ServiceMax_Processes__c"
#define gPROCESS_ID                                     @"SVMXDEV__ProcessID__c"
#define gPROCESS_NAME                                   @"SVMXDEV__Name__c"
...
#define gBUTTON_TARGET_CALL                             @"SVMXDEV__Target_Call__c"
#define gBUTTON_EVENT_CALL_TYPE                         @"SVMXDEV__Event_Call_Type__c"
#define gBUTTON_EVENT_TYPE                              @"SVMXDEV__Event_Type__c"
#define gBUTTON_EVENT_ENABLE                            @"Enable"
                                    
//sahana 1st Aug 2011
#define gEVENT_ID                                       @"SVMXDEV__Event_Id__c"
#define gEVENT_TARGET_CALL                              @"SVMXDEV__Target_Call__c"
#define gEVENT_CALL_TYPE                                @"SVMXDEV__Event_Call_Type__c"
#define gEVENT_TYPE                                     @"SVMXDEV__Event_Type__c"
#define gEVENT_NAME                                     @"Name"
#define gEVENT_LAYOUT_ID                                @"SVMXDEV__Page_Layout__c"
...
#define gId                                             @"Id_"
#define gSVMXDEV__Billing_Type__c                         @"SVMXDEV__Billing_Type__c"
#define gSVMXDEV__Clock_Paused_Forever__c                 @"SVMXDEV__Clock_Paused_Forever__c"
#define gSVMXDEV__Company__c                              @"SVMXDEV__Company__c"
#define gSVMXDEV__Customer_Down_Status__c                 @"SVMXDEV__Customer_Down_Status__c"
#define gSVMXDEV__Customer_Down__c                        @"SVMXDEV__Customer_Down__c"
#define gSVMXDEV__Order_Status__c                         @"SVMXDEV__Order_Status__c"
#define gSVMXDEV__Order_Type__c                           @"SVMXDEV__Order_Type__c"
#define gSVMXDEV__Problem_Description__c                  @"SVMXDEV__Problem_Description__c"
#define gSVMXDEV__SLA_Clock_Paused__c                     @"SVMXDEV__SLA_Clock_Paused__c"
#define gSVMXDEV__Service_Duration__c                     @"SVMXDEV__Service_Duration__c"
#define gSVMXDEV__Actual_Resolution__c                    @"SVMXDEV__Actual_Resolution__c"
#define gSVMXDEV__Actual_Restoration__c                   @"SVMXDEV__Actual_Restoration__c"
#define gSVMXDEV__Resolution_Customer_By__c               @"SVMXDEV__Resolution_Customer_By__c"
#define gSVMXDEV__Restoration_Customer_By__c              @"SVMXDEV__Restoration_Customer_By__c"
#define gSVMXDEV__Product__c                              @"SVMXDEV__Product__c"
#define gSVMXDEV__Product_Name__c                         @"SVMXDEV__Product_Name__c"
...
#define gFIELD_RELATED_OBJECT_SEARCH_ID                 @"SVMXDEV__Named_Search__c"
...
#define gSLA_CLOCK                                      @"SVMXDEV__Use_For_SLA_Clock__c"
#define gFIELD_OVERRIDE_RELATED_LOOKUP                  @"SVMXDEV__Override_Related_Lookup__c"
//Aparna: FORMFILL
#define gFIELD_MAPPING                                  @"SVMXDEV__Field_Mapping__c"

//krishna : CONTEXT FILTER
#define gCONTEXTSOURCEOBJ                               @"SVMXDEV__Context_Source_Object__c"
...
//Radha
#define gHEADER_SHOW_HIDE_QUICK_SAVE                    @"SVMXDEV__Hide_Quick_Save__c"
#define gHEADER_SHOW_HIDE_SAVE                          @"SVMXDEV__Hide_Save__c"
...
#define gSVMXDEV__Product__r                              @"SVMXDEV__Product__r"
#define gSVMXDEV__Actual_Quantity2__c                     @"SVMXDEV__Actual_Quantity2__c"
#define gPartsUsed                                      @"PartsUsed"
#define gSVMXDEV__Work_Description__c                     @"SVMXDEV__Work_Description__c"
#define gSVMXDEV__Actual_Price2__c                        @"SVMXDEV__Actual_Price2__c"
#define gSVMXDEV__Discount__c                             @"SVMXDEV__Discount__c"
...
#define gDETAILS_EVENT_INFO                             @"SVMXDEV__SFM_Event__c"
...
#define gDetail_MULTIADD_CONFIG                         @"SVMXDEV__Multi_Add_Configuration__c"
#define gDETAIL_MULTIADD_SEARCH                         @"SVMXDEV__Multi_Add_Search_Field__c"
#define gDETAIL_MULTIADD_SEARCH_OBJECT                  @"SVMXDEV__Multi_Add_Search_Object__c"
#define gDETAIL_SEQUENCE_NO                             @"SVMXDEV__Sequence__c"
...
#define DEFAULT_LOOKUP_COLUMN                           @"SVMXDEV__Default_Lookup_Column__c"
...
// What is a WorkOrder
#define WORKORDER                                       @"SVMXDEV__Service_Order__c"


//Radha
#define gSVMXDEVX1__Name__c                               @"SVMXDEVX1__Name__c"
#define gSVMXDEVX1__Page_Layout_ID__c                     @"SVMXDEVX1__Page_Layout_ID__c"
