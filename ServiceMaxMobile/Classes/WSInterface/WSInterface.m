        ...
        if([eventName isEqualToString:GET_PRICE_DATA] && [eventType  isEqualToString:SYNC])
        {
            ...
            if(([lastIndex isEqualToString:@"1"]) || ([lastIndex isEqualToString:@"2"]))
            {
                ...
                if([lastIndex isEqualToString:@"2"])
                {
                    ...
                    NSString *customPriceBook = @"SPR14__Service_Pricebook__c";
                    NSString *customPriceBookEntry = @"SPR14__Service_Pricebook_Entry__c";
                    ...
                    NSString *customPriceBookColumnName = @"SPR14__Price_Book__c";
                    ...
                    {
                        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14MapCurrency =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
                        ...
                        for(NSDictionary *priceBookDict in priceBookIds)
                        {
                            ...
                            {
                                INTF_WebServicesDefServiceSvc_SVMXMap * SPR14MapUniqueCurrency =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
                                SPR14MapUniqueCurrency.key  = @"PRICEBOOK_ID";
                                
                                SPR14MapUniqueCurrency.value = priceBookId;
                                [SPR14MapUniqueCurrency.values addObjectsFromArray:uniqueCurrencyArray];
                                [SPR14MapCurrency.valueMap addObject:SPR14MapUniqueCurrency];
                                currencyPresent = YES;
                            }
                        }
