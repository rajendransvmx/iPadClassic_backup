...
-(void)DoIncrementalDataSync
{
    ...
    //shrinivas : 
    //retVal = [[ZKServerSwitchboard switchboard] doCheckSession]; // Can comment as calling twice
    ...
    //OAuth.
//	[[ZKServerSwitchboard switchboard] doCheckSession]; // Can comment as already called
