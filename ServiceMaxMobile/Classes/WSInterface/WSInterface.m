...
-(void) PutAllTheRecordsForIds
{
    ...
    for(int i = 0 ; i < [allKeys count] ; i++)
    {
        ...
        if([object_api_name length] != 0 && ![object_api_name isEqualToString:@""])
        {
            ...
            SMLog(@"OBJECT = %@, COUNT + %D", object_api_name, [array_of_record_ids count]);
    ...
    SMLog(@" ------- PutAllTheRecordsForIds  Finished -----");
...
//	[appDelegate setCurrentSyncStatusProgress:SYNC_END optimizedSynstate:oSYNC_END];
 ...
 [autoreleasePool release];
    ...
    SMLog(@" [isync] DoIncrementalDataSync  - completed");
...
- (BOOL) checkForConflictsForId:(NSString *)record_id andObject_name:(NSString *)object_name
{
    ...
    SMLog(@"isconflict %d andSfId %@",isConflictExists,sf_id);
...
@try{
    ...
    SMLog(@" GetInsert ends....");
}

-(void)GetUpdate
{
    SMLog(@" GetUpdate started....");
...
@try{
    ...
    SMLog(@"GETDownloadCriteriaRecordsFor : %@ starts", event_name);
...
//    [svmxc_client.clientInfo addObject:@"R4B2"];
    ...
    SMLog(@"GETDownloadCriteriaRecordsFor : %@ ends...", event_name);
}
...
//            [record_dict release];
        ...
        SMLog(@"This is INTF_WebServicesDefBinding_INTF_SyncOverRide_WS");
    }
    ...
    if ([operation isKindOfClass:[INTF_WebServicesDefBinding_INTF_DataSync_WS class]])
    {
        ...
        else if ([wsResponse.result.eventName isEqualToString:@"TX_FETCH"])
        {
            ...
            //SMLog(@"Insertion duration at %f and sum  %f",totaltimeInSec,totalTimeTakenForInsertion);
