...
-(void)optimizedAggressiveSync:(NSMutableDictionary *)sync_record  method_name:(NSString *)sfmMethodName class_name:(NSString *)webServiceClass event_type:(NSString *)Event_type event_name:(NSString *)event_name request_id:(NSString *)request_id
{
    ...
    for(NSString * object_type in object_types)
    {
        ...
        for(NSString * object_name in allobjects)
        {
            ...
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14_valueMAp = [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14_valueMAp.key = object_type;
            SPR14_valueMAp.value = object_name;
            ...
            for(int i = 0 ; i< [fields_array count]; i++)
            {
                ...
                {
                    [SPR14_valueMAp.values addObject:field];
                }
            }
            ...
            if(additional_valuemap == nil && ![object_type isEqualToString:MASTER] && update_operation == nil && Delete_operation == nil  && Insert_operation == nil)
            {
                ...
                [SPR14_valueMAp addValueMap:additional_valuemap];
            ...
            if(update_operation != nil)
            {
                ...
                [SPR14_valueMAp addValueMap:update_operation];
                [update_operation release]; update_operation = nil;
            }
            if(Delete_operation!= nil)
            {
                [SPR14_valueMAp addValueMap:Delete_operation];
...
//                }
            ...
            if(Insert_operation != nil)
            {
                ...
                [SPR14_valueMAp addValueMap:Insert_operation];
                [Insert_operation release]; Insert_operation = nil;
            }
            
            [sfmRequest addValueMap:SPR14_valueMAp];
     ...
     if(![object_types containsObject:DETAIL])
     {
        ...
        for(NSString * child_object in FinalChild)
        {
            ...
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14_valueMAp = [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14_valueMAp.key = DETAIL;
            SPR14_valueMAp.value = child_object;
    ...
    //INTF_WebServicesDefServiceSvc_SPR14lient  * SPR14_client = [[[INTF_WebServicesDefServiceSvc_SPR14lient alloc] init]  autorelease];
    //SPR14_client.clientType = @"iPad";
    //[SPR14_client.clientInfo addObject:@"OS:iPadOS"];
    //[SPR14_client.clientInfo addObject:@"R4B2"];
    //[client_listMap.valueList addObject:SPR14_client];
    
    //[sfmRequest addClientInfo:SPR14_client];
    //Krishna client info
    INTF_WebServicesDefServiceSvc_SPR14lient  * SPR14_client =  [appDelegate getSPR14lientObject];
    [sfmRequest addClientInfo:SPR14_client];
    ...
    for(int i = 0 ; i < [allKeys count] ; i++)
    {
        ...
        if([object_api_name length] != 0 && ![object_api_name isEqualToString:@""])
        {
			...
			if ([object_api_name isEqualToString:@"LAST_BATCH"])
				continue;
            INTF_WebServicesDefServiceSvc_SVMXMap  * SPR14map = [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14map.key = @"TX_OBJECT" ;
            SPR14map.value = object_api_name; //object  api name
            ...
            for(NSString * record_id in array_of_record_ids)
            {
                ...
                [SPR14map.values addObject:record_id_str];
            }
            [sfmRequest.valueMap addObject:SPR14map];
            [SPR14map release]; SPR14map = nil;
        ...
        [dict release]; dict = nil;
    //ADD SPR14lient : changed krishna
        INTF_WebServicesDefServiceSvc_SPR14lient  * SPR14_client = [appDelegate getSPR14lientObject];
...
- (void)doGetPrice
{
    ...
    NSString *filterCriteria = [NSString stringWithFormat:@"object_api_name = 'SPR14__Service_Order_Line__c' and field_api_name = 'SPR14__Activity_Type__c'"];
...
@try{
    ...
    //ADD SPR14lient : krishna 10.4.404 change
    INTF_WebServicesDefServiceSvc_SPR14lient  * SPR14_client =  [appDelegate getSPR14lientObject];//[self getSPR14lientObject];
    
    [sfmRequest addClientInfo:SPR14_client];
    [datasync setRequest:sfmRequest];
    
    //    [[[INTF_WebServicesDefServiceSvc_SPR14lient alloc] init] autorelease];
    //
    //    SPR14_client.clientType = @"iPad";
    //    [SPR14_client.clientInfo addObject:@"OS:iPadOS"];
    //    [SPR14_client.clientInfo addObject:@"R4B2"];
...
@try{
    ...
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_lastModified =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
    SPR14Map_lastModified.key = @"LAST_SYNC_TIME";
    SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_INSERT_RESONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_INSERT_RESONSE_TIME];
    
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_startTime =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
    SPR14Map_startTime.key  = @"RANGE_START";
    SPR14Map_startTime.value = [self getSyncTimeStampWithTheIntervalof15days:START_TIME] == nil ? @"" :[self getSyncTimeStampWithTheIntervalof15days:START_TIME];
    
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_endTime =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
    SPR14Map_endTime.key  = @"RANGE_END";
    SPR14Map_endTime.value = [self getSyncTimeStampWithTheIntervalof15days:END_TIME]== nil ? @"" :[self getSyncTimeStampWithTheIntervalof15days:END_TIME];
    
    [sfmRequest.valueMap addObject:SPR14Map_lastModified];
    [sfmRequest.valueMap addObject:SPR14Map_startTime];
    [sfmRequest.valueMap addObject:SPR14Map_endTime];

    //ADD SPR14lient changed : kri 10.4.404
    //    INTF_WebServicesDefServiceSvc_SPR14lient  * SPR14_client = [[[INTF_WebServicesDefServiceSvc_SPR14lient alloc] init]  autorelease];
    //
    //    SPR14_client.clientType = @"iPad";
    //    [SPR14_client.clientInfo addObject:@"OS:iPadOS"];
...
-(void)GetUpdate
{
    ...
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_lastModified =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
    SPR14Map_lastModified.key = @"LAST_SYNC_TIME";
    SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_UPDATE_RESONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_UPDATE_RESONSE_TIME];
    ...
    [sfmRequest.valueMap addObject:SPR14Map_endTime];
        ...
        //    INTF_WebServicesDefServiceSvc_SPR14lient  * SPR14_client = [[INTF_WebServicesDefServiceSvc_SPR14lient alloc] init];
        //
        //    SPR14_client.clientType = @"iPad";
        //    [SPR14_client.clientInfo addObject:@"OS:iPadOS"];
        //    [SPR14_client.clientInfo addObject:@"R4B2"];
...
-(void)GetDelete
{
    ...
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_lastModified =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
    SPR14Map_lastModified.key = @"LAST_SYNC_TIME";
    SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_DELETE_RESPONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_DELETE_RESPONSE_TIME];
    
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_startTime =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
    SPR14Map_startTime.key  = @"RANGE_START";
    SPR14Map_startTime.value = [self getSyncTimeStampWithTheIntervalof15days:START_TIME] == nil ? @"" :[self getSyncTimeStampWithTheIntervalof15days:START_TIME];
    
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_endTime =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
    SPR14Map_endTime.key  = @"RANGE_END";
    SPR14Map_endTime.value = [self getSyncTimeStampWithTheIntervalof15days:END_TIME]== nil ? @"" :[self getSyncTimeStampWithTheIntervalof15days:END_TIME];
...
@try{
    ...
    {
        SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_DC_DELETE_RESPONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_DC_DELETE_RESPONSE_TIME];
    }
    else if ([event_name isEqualToString:GET_INSERT_DOWNLOAD_CRITERIA])
    {
        SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_DC_INSERT_RESPONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_DC_INSERT_RESPONSE_TIME];
    }
    else if ([event_name isEqualToString:GET_UPDATE_DOWNLOAD_CRITERIA])
    {
        SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_DC_UPDATE_RESPONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_DC_UPDATE_RESPONSE_TIME];
    }
    ...
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_last_index =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
    SPR14Map_last_index.key  = @"LAST_INDEX";
    SPR14Map_last_index.value = appDelegate.initial_Sync_last_index;
    [sfmRequest.valueMap addObject:SPR14Map_last_index];
  
    //SEND DOwnload Criteria Objects 
    
    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_dc_objects =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
    SPR14Map_dc_objects.key  = DOWNLOAD_CRITERIA_OBJECTS;
    NSDictionary * dict = [self getdownloadCriteriaObjects];
   /* NSAutoreleasePool * autoreleasePool = [[NSAutoreleasePool alloc] init];
    SBJsonWriter * writer = [[[SBJsonWriter alloc] init] autorelease];
    NSString * jsonstring = [[writer  stringWithObject:dict] retain];
    SPR14Map_dc_objects.value = jsonstring;
    [autoreleasePool release];*/
    ...
    for(NSString * object_name in allobjects)
    {
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_Object =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        SPR14Map_Object.key = object_name;
        SPR14Map_Object.value = [dict objectForKey:object_name];
        [SPR14Map_dc_objects.valueMap addObject:SPR14Map_Object];
        [SPR14Map_Object release]; SPR14Map_Object = nil;
    }
    ...
    [sfmRequest.valueMap addObject:SPR14Map_startTime];
    [sfmRequest.valueMap addObject:SPR14Map_endTime];
    [sfmRequest.valueMap addObject:SPR14Map_dc_objects];
...
@try{
   ...
   // event_name = @"PUT_INSERT";
    if([event_name isEqualToString:@"PUT_UPDATE"] && [event_type isEqualToString:@"SYNC"])//PUT_UPSATE
    {
      ...
      INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_lastModified =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init]  autorelease];
        SPR14Map_lastModified.key = @"SYNC_TIME_STAMP";
        SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_UPDATE_RESONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_UPDATE_RESONSE_TIME];
        
        [sfmRequest.valueMap addObject:SPR14Map_lastModified];
		
		//Radha - #defect 8227
		SMLog(kLogLevelVerbose,@"put_insert_time = %@", put_insert_time);
        ...
        for(int i = 0 ; i < [all_objects count]; i++)
        {
           ...
           // SPR14map.key = @"object_name" ;
            ...
            // ADD   FIELDS  method
            INTF_WebServicesDefServiceSvc_SVMXMap  * record_SPR14  = [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            
            record_SPR14.key = @"Fields";
            record_SPR14.value = field_string;
            ...
            for (NSDictionary * dict in info_dict) 
            {
                ...
                INTF_WebServicesDefServiceSvc_SVMXMap * testSPR14Map =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
                ...
                if(!check_id_exists)
                {
                    ...
                    {
                        testSPR14Map.key = @"CLIENT_OVERRIDE";
                    }
                    else 
                    {
                        testSPR14Map.key = time_stamp;
                    }
                    
                    testSPR14Map.value = json_record;
                    ...
                    [record_SPR14.valueMap addObject:testSPR14Map];
                    value_map_count++;
					[localJsonWriter release]; localJsonWriter = nil;
					[testSPR14Map release];
          ...
          /* // code to differentiate b/w the parent and child 
           ...
           if([Master_or_parent isEqualToString:MASTER])
            {
                SPR14map.key = @"Parent_Object";
            }
            else if([Master_or_parent isEqualToString:DETAIL])
            {
                SPR14map.key = @"Child_Object";
            }
            ...
            {
                [SPR14map.valueMap addObject:record_SPR14];
                [SPR14map.valueMap addObject:iscallBack];
                [sfmRequest.valueMap addObject:SPR14map];
            }
            [record_SPR14 release]; record_SPR14 = nil;
   ...
   else if([event_name isEqualToString:@"PUT_INSERT"] && [event_type isEqualToString:@"SYNC"])
   {
        ...
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_lastModified =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];         //sahana30April
        SPR14Map_lastModified.key = @"SYNC_TIME_STAMP";
        SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_INSERT_RESONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_INSERT_RESONSE_TIME];
        
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_startTime =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];            //sahana30April
        SPR14Map_startTime.key  = @"RANGE_START";
        SPR14Map_startTime.value = [self getSyncTimeStampWithTheIntervalof15days:START_TIME] == nil ? @"" :[self getSyncTimeStampWithTheIntervalof15days:START_TIME];
        
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_endTime =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];               //sahana30April
        SPR14Map_endTime.key  = @"RANGE_END";
        SPR14Map_endTime.value = [self getSyncTimeStampWithTheIntervalof15days:END_TIME]== nil ? @"" :[self getSyncTimeStampWithTheIntervalof15days:END_TIME];
                    ...
                    if([tempMasterOrDetail isEqualToString:object_name])
                    {
                        ...
                        for (NSDictionary * dict in info_dict) 
                        {
                           ...
                           BOOL  replaceSuccess = [self replaceReferenceLocalIdWithSfidForRecord:each_record isChild:isChild_object referenceTo:referenceTo parentColoumnName:parent_column_name ObjectName:object_name recordLocalId:local_id recordSfId:@""];
							...
							[testSPR14Map release]; testSPR14Map =  nil;
                        }
                        ...
                        [iscallBack release];
                        [record_SPR14 release];  //sahana30April
                        [SPR14map release];       //sahana30April
                        break;
                    }
...
//    svmxMap = NULL;
     ...
     //krishna
     INTF_WebServicesDefServiceSvc_SPR14lient * client = nil;//[[[INTF_WebServicesDefServiceSvc_SPR14lient alloc] init] autorelease];
    ...
    else
    {
        ...
        client = [appDelegate getSPR14lientObject];
        sfmRequest.value = @"";
        [sfmRequest.values addObjectsFromArray:values];
    }
    ...
    {
        INTF_WebServicesDefServiceSvc_SPR14lient * client_iPad_Version = [[INTF_WebServicesDefServiceSvc_SPR14lient alloc] init];
...
@try{
    ...
    //krishna
//    INTF_WebServicesDefServiceSvc_SPR14lient * client = [[[INTF_WebServicesDefServiceSvc_SPR14lient alloc] init] autorelease];
    ...
    [SPR14Map_startTime release];
    [SPR14Map_endTime release];
    //    client.clientType = @"iPad";
    //    [client.clientInfo addObject:@"OS:iPadOS"];
    //    [client.clientInfo addObject:@"R4B2"];
    ...
    //krishna 10.4.404
    INTF_WebServicesDefServiceSvc_SPR14lient * client = [appDelegate getSPR14lientObject];
//    [self addClientInfoForObject:client];
    ...
    {
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14ProcessID =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        SPR14ProcessID.key  = @"SearchProcessId";
        if([values objectAtIndex:0] != nil)
            SPR14ProcessID.value = [values objectAtIndex:0];
        else
            SPR14ProcessID.value = @"";
        [sfmRequest.valueMap addObject:SPR14ProcessID];
        [SPR14ProcessID release]; SPR14ProcessID = nil;
        
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Crtieria =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        SPR14Crtieria.key  = @"SEARCH_OPERATOR";
        if([values objectAtIndex:3] != nil)
            SPR14Crtieria.value = [values objectAtIndex:3];
        else
            SPR14Crtieria.value = @"";
        [sfmRequest.valueMap addObject:SPR14Crtieria];
        [SPR14Crtieria release]; SPR14Crtieria = nil;
        
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14UserFilterString =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        SPR14UserFilterString.key  = @"KeyWord";
        if([values objectAtIndex:4] != nil)
            SPR14UserFilterString.value = [values objectAtIndex:4];
        else
            SPR14UserFilterString.value = @"";
        [sfmRequest.valueMap addObject:SPR14UserFilterString];
        [SPR14UserFilterString release]; SPR14UserFilterString = nil;
        
        NSArray *objectList = [values objectAtIndex:1];
        for(int i=0; i<[objectList count]; i++)
        {
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Object =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            
            SPR14Object.key  = @"ObjectId";
            SPR14Object.value = [objectList objectAtIndex:i];
            /*
            for(int j=0; j< [resultsArray count]; j++)
            {
                [SPR14Object addValues:[resultsArray objectAtIndex:j]];
            }
             */
            [sfmRequest.valueMap addObject:SPR14Object];            
            [SPR14Object release]; SPR14Object = nil;
        }
         
        NSString *limit = [values objectAtIndex:2];
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14LimitObject =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        
        SPR14LimitObject.key  = @"RecordLimit";
        SPR14LimitObject.value = limit;
        [sfmRequest.valueMap addObject:SPR14LimitObject];
        [SPR14LimitObject release]; SPR14LimitObject = nil;
        
    }
    if([eventName isEqualToString:@"TECH_LOCATION_UPDATE"] && [eventType isEqualToString:SYNC])
    {
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Field =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        SPR14Field.key=@"Fields";
        SPR14Field.value=@"";
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Latitude =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        SPR14Latitude.key  = @"SPR14__Latitude__c";
        if([values objectAtIndex:0] != nil)
            SPR14Latitude.value = [values objectAtIndex:0];
        else
            SPR14Latitude.value = @"";
        [SPR14Field.valueMap addObject:SPR14Latitude];
        [SPR14Latitude release];
        
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Longitude =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        SPR14Longitude.key  = @"SPR14__Longitude__c";
        if([values objectAtIndex:1] != nil)
            SPR14Longitude.value = [values objectAtIndex:1];
        else
            SPR14Longitude.value = @"";
        [SPR14Field.valueMap addObject:SPR14Longitude];
        [SPR14Longitude release];
        [sfmRequest.valueMap addObject:SPR14Field];
        [SPR14Field release];
    ...
    else if([eventName isEqualToString:@"LOCATION_HISTORY"] && [eventType isEqualToString:SYNC])
    {
        ...
        {
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Field =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14Field.key=@"Record";
            SPR14Field.value=@"";
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14LocalID =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14LocalID.key  = @"localId";
            SPR14LocalID.value = [dict objectForKey:@"localId"];
            [SPR14Field.valueMap addObject:SPR14LocalID];
            [SPR14LocalID release];

            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Latitude =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14Latitude.key  = @"SPR14__Latitude__c";
            NSString *latitude = [dict objectForKey:@"SPR14__Latitude__c"];
            if(latitude != nil)
                SPR14Latitude.value = latitude;
            else
                SPR14Latitude.value = @"";
            ...
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Longitude =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14Longitude.key  = @"SPR14__Longitude__c";
            NSString *longitude = [dict objectForKey:@"SPR14__Longitude__c"];
            if(longitude != nil)
                SPR14Longitude.value = longitude;
            else
                SPR14Longitude.value = @"";
            [SPR14Field.valueMap addObject:SPR14Longitude];
            [SPR14Longitude release];

            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Status =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14Status.key  = @"SPR14__Status__c";
            SPR14Status.value = [dict objectForKey:@"SPR14__Status__c"];
            [SPR14Field.valueMap addObject:SPR14Status];
            [SPR14Status release];

            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14User =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14User.key  = @"SPR14__User__c";
            SPR14User.value = [dict objectForKey:@"SPR14__User__c"];
            [SPR14Field.valueMap addObject:SPR14User];
            [SPR14User release];
            
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14DeviceType =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14DeviceType.key  = @"SPR14__Device_Type__c";
            SPR14DeviceType.value = [dict objectForKey:@"SPR14__Device_Type__c"];
            [SPR14Field.valueMap addObject:SPR14DeviceType];
            [SPR14DeviceType release];
            
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14AdditionalInfo =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14AdditionalInfo.key  = @"SPR14__Additional_Info__c";
            SPR14AdditionalInfo.value = [dict objectForKey:@"SPR14__Additional_Info__c"];
            [SPR14Field.valueMap addObject:SPR14AdditionalInfo];
            [SPR14AdditionalInfo release];
            
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14TimeRecorded =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14TimeRecorded.key  = @"SPR14__Time_Recorded__c";
            SPR14TimeRecorded.value = [dict objectForKey:@"SPR14__Time_Recorded__c"];
            [SPR14Field.valueMap addObject:SPR14TimeRecorded];
            [SPR14TimeRecorded release];
                     ...
                     lastIndex:(NSString *)lastIndex
{
    @try{
        ...
        if([eventName isEqualToString:GET_PRICE_DATA] && [eventType  isEqualToString:SYNC])
        {
            ...
            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_last_index =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
            SPR14Map_last_index.key  = @"LAST_INDEX";
            SPR14Map_last_index.value = lastIndex;
            [sfmRequest.valueMap addObject:SPR14Map_last_index];
            
            if(appDelegate.dataSyncRunning)
            {
                INTF_WebServicesDefServiceSvc_SVMXMap * SPR14MapLastSyncTime =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
                SPR14MapLastSyncTime.key  = @"LAST_SYNC_TIME";
                
                //8581
                if([appDelegate shouldDoOneCallSync])
                {
                    SPR14MapLastSyncTime.value=[appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_OSC_TIMESTAMP] == nil ?@"":[appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_OSC_TIMESTAMP];
                }
                else
                {
                    SPR14MapLastSyncTime.value = [self get_SYNCHISTORYTime_ForKey:LAST_DC_INSERT_RESPONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_DC_INSERT_RESPONSE_TIME];
                }
                [sfmRequest.valueMap addObject:SPR14MapLastSyncTime];
                /*Mem Opt*/
                [SPR14MapLastSyncTime release];
            }
            ...
            if(([lastIndex isEqualToString:@"1"]) || ([lastIndex isEqualToString:@"2"]))
            {
                ...
                if([data count] > 1)
                {
                    ...
                    if((records != nil) && ([records count] == 2))
                    {
                        ...
                        {
                            INTF_WebServicesDefServiceSvc_SVMXMap * SPR14MapPartialObject =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
                            SPR14MapPartialObject.key  = @"PARTIAL_EXECUTED_OBJECT";
                            SPR14MapPartialObject.value = [partialObjectDict objectForKey:@"partialObject"];
                            NSString *criteria = [NSString stringWithFormat:@"sync_flag = 'false' AND object_name = '%@'",SPR14MapPartialObject.value];
                            ...
                            {
                                [SPR14MapPartialObject.values addObject:[recordID objectForKey:@"sf_id"]];
                            }

                            [sfmRequest.valueMap addObject:SPR14MapPartialObject];
                        }
                    }
                    if([records count] > 1)
                    {
                ...
                if([lastIndex isEqualToString:@"2"])
                {
                    ...
                    if([activityType count])
                    {
                        ...
                        SPR14Object.key  = @"Labor";
                        for(int i=0; i<[activityType count]; i++)
                        {
                            [SPR14Object.values addObject:[activityType objectAtIndex:i]];
                        }
                        [sfmRequest.valueMap addObject:SPR14Object];
                        [SPR14Object release];
                    }
                    ...
                    NSString *tableName = @"SPR14__Service_Order__c";
                    NSString *columnName = @"CurrencyIsoCode";
                    INTF_WebServicesDefServiceSvc_SVMXMap * SPR14MapCurrency =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
                    SPR14MapCurrency.key  = @"CurrencyISO";
                    ...
                    [SPR14MapCurrency.values addObjectsFromArray:uniqueCurrency];
                    [sfmRequest.valueMap addObject:SPR14MapCurrency];
                    [uniqueCurrency release];
                    [SPR14MapCurrency release];
        ...
        else if([eventName isEqualToString:@"ADV_DOWNLOAD_CRITERIA"] && [eventType  isEqualToString:SYNC])
        {
            ...
            if(appDelegate.dataSyncRunning)
            {
                ...
                if([appDelegate shouldDoOneCallSync])
                {
                    SPR14Map_lastModified.value=[appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_OSC_TIMESTAMP] == nil ?@"":[appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_OSC_TIMESTAMP];
                }
                else
                {
                    SPR14Map_lastModified.value = [self get_SYNCHISTORYTime_ForKey:LAST_DC_INSERT_RESPONSE_TIME] == nil ?@"":[self get_SYNCHISTORYTime_ForKey:LAST_DC_INSERT_RESPONSE_TIME];
            ...
            {
                SPR14Map_lastModified.value =@"";
            }
            [sfmRequest.valueMap addObject:SPR14Map_lastModified];
            [SPR14Map_lastModified release];
            
                      
            if ([lastIndex length]>0)
            {
               INTF_WebServicesDefServiceSvc_SVMXMap * SPR14MapPartialObject =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
                SPR14MapPartialObject.key = @"PARTIAL_EXECUTED_OBJECT";
                SPR14MapPartialObject.value =lastIndex; // Passing Object Name as LastIndex string
                NSString *criteria = [NSString stringWithFormat:@"sync_flag = 'false' AND object_name = '%@'",SPR14MapPartialObject.value];
                NSArray *columns = [NSArray arrayWithObjects:@"sf_id", nil];
...
- (void) savePageLayout
{
    ...
    INTF_WebServicesDefServiceSvc_SPR14__Page_Layout_Detail__c * detailPage = [[[INTF_WebServicesDefServiceSvc_SPR14__Page_Layout_Detail__c alloc] init] autorelease];
    
    detailPage.SPR14__Detail_Type__c = @"Field";
    detailPage.SPR14__Field_API_Name__c = @"AccountId";
    detailPage.SPR14__DataType__c
    = @"reference";
    detailPage.SPR14__Related_Object_Name__c = @"Account";
    detailPage.SPR14__Related_Object_Name_Field__c = @"Name";
    detailPage.SPR14__Named_Search__c = @"a0VA0000001AEp0MAG";
    detailPage.SPR14__Display_Row__c = [NSNumber numberWithInt:1];
    detailPage.SPR14__Display_Column__c = [NSNumber numberWithInt:1];
    detailPage.SPR14__Required__c = NO;
    detailPage.SPR14__Readonly__c = NO;
    detailPage.SPR14__Sequence__c = [NSNumber numberWithInt:1];
    detailPage.SPR14__Override_Related_Lookup__c = NO;
    ...
    INTF_WebServicesDefServiceSvc_SPR14__Page_Layout__c * objPageHeaderLayout = [[[INTF_WebServicesDefServiceSvc_SPR14__Page_Layout__c alloc] init] autorelease];
    objPageHeaderLayout.SPR14__Name__c = @"Created from the custom Webservice";
    objPageHeaderLayout.SPR14__Object_Name__c = @"Case";
    objPageHeaderLayout.SPR14__Page_Layout_ID__c = @"CustFromWEBService";
    objPageHeaderLayout.SPR14__Type__c = @"Header";
...
- (void) getLookUpFieldsWithKeyword:(NSString *)keyword forObject:(NSString *)objectName returnTo:(id)caller setting:(BOOL)idAvailable overrideRelatedLookup:(NSNumber *)Override_Related_Lookup lookupContext:(NSString *)Lookup_Context lookupQuery:(NSString *)Lookup_Query_Field
{
    ...
    if (idAvailable == false)
    {
        ...
        strMap.value = objectName; //@"SPR14__Service_Order__c";
    }
    else
    {
        strMap.key = RECORDID;
...
- (NSMutableDictionary *) getLookUpFromResponse:(INTF_WebServicesDefBindingResponse *)response
{
    ...
    INTF_WebServicesDefServiceSvc_SPR14__ServiceMax_Processes__c * namedSearchHdr = [namedSearchInfo namedSearchHdr];
    NSString * defaultLookupColumn = [namedSearchHdr SPR14X1__Default_Lookup_Column__c];
    ...
    {
        INTF_WebServicesDefServiceSvc_SPR14__ServiceMax_Config_Data__c * data = [fields objectAtIndex:j];
        NSString * family;
        NSNumber * sequence;
        NSString * type = data.SPR14__Search_Object_Field_Type__c;
        
        if ([type isEqualToString:@"Result"])
        {
            family = data.SPR14__Field_Name__c;
            sequence = data.SPR14__Sequence__c;
...
@try{
    ...
    for(NSString * object_name in allobjects)
    {
        INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_dcObject =  [[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init];
        SPR14Map_dcObject.key = object_name;
        SPR14Map_dcObject.value = [dict objectForKey:object_name];
        [sfmRequest.valueMap addObject:SPR14Map_dcObject];
        [SPR14Map_dcObject release];
    }
...
//		[appDelegate setCurrentSyncStatusProgress:CUSTOMSYNC_GETDATA optimizedSynstate:0];
        ...
        if (([wsResponse.result.eventName isEqualToString:@"PROCESS"] || [wsResponse.result.eventName isEqualToString:@"IGNORE"]) && [wsResponse.result.eventType isEqualToString:SYNC])
        {
            ...
            {
                INTF_WebServicesDefServiceSvc_SVMXMap * SPR14_map = [valueMap objectAtIndex:i];
                //level 1 MASTER/DETAIL
                NSString * record_type = SPR14_map.key;
                NSString * object_name = SPR14_map.value;
                ...
                NSArray * operation_SPR14_map = SPR14_map.valueMap;
                for(int j = 0; j < [operation_SPR14_map count]; j++)
                {
                    //level 2 UPDATE/INSERT/DELETE
                    INTF_WebServicesDefServiceSvc_SVMXMap * each_operation = [operation_SPR14_map objectAtIndex:j];
                    ...
                    for(int k=0; k<[objectInfo count]; k++) //4 objects
                    {
                        ...
                        for(int l=0; l< [detailsArray count]; l+=2)// 2 maps // object map, config data
                        {
                            ...
                            for(int m=0; m<[objectInfoArray count]; m++)
                            {
                                ...
                                if([objectInfo.key isEqualToString:@"SPR14__Advance_Expression__c"]) {
                ...
                for (int i = 0; i < [pageArray count]; i++)
                {
                    ...
                    for ( int j = 0; j < [details count]; j++)
                    {
                        ...
                        for (int k = 0; k < [pageDetail.fields count]; k++)
                        {
                            ...
                            /*Aparna: FORMFILL -> Added 'SPR14__Field_Mapping__c'*/
                            /*Krishna : CONTEXTLOOKUP -> Added 'SPR14__Context_Source_Object__c' */
                            ...
                            NSMutableArray * detailFieldObjects = [NSMutableArray arrayWithObjects:
                                                                   (detailUiField.fieldDetail.SPR14__Field_API_Name__c != nil)?detailUiField.fieldDetail.SPR14__Field_API_Name__c:@"",
                                                                   (detailUiField.fieldDetail.SPR14__Display_Column__c != nil)?detailUiField.fieldDetail.SPR14__Display_Column__c:@"",
                                                                   (detailUiField.fieldDetail.SPR14__Display_Row__c != nil)?detailUiField.fieldDetail.SPR14__Display_Row__c:@"",
                                                                   [NSNumber numberWithBool:detailUiField.fieldDetail.SPR14__Readonly__c.boolValue],
                                                                   [NSNumber numberWithBool:detailUiField.fieldDetail.SPR14__Required__c.boolValue],
                                                                   (detailUiField.fieldDetail.SPR14__Lookup_Context__c != nil)?detailUiField.fieldDetail.SPR14__Lookup_Context__c:@"",
                                                                   (detailUiField.fieldDetail.SPR14__Lookup_Query_Field__c != nil)?detailUiField.fieldDetail.SPR14__Lookup_Query_Field__c:@"",
                                                                   (detailUiField.fieldDetail.SPR14__Sequence__c != nil)?detailUiField.fieldDetail.SPR14__Sequence__c:@"",
                                                                   (detailUiField.fieldDetail.SPR14__Named_Search__c != nil)?detailUiField.fieldDetail.SPR14__Named_Search__c:@"",
                                                                   (detailUiField.fieldDetail.SPR14__Related_Object_Name__c != nil)?detailUiField.fieldDetail.SPR14__Related_Object_Name__c:@"",
                                                                   (detailUiField.fieldDetail.SPR14__DataType__c != nil)?detailUiField.fieldDetail.SPR14__DataType__c:@"",
                                                                   @"",
                                                                   @"",
                                                                   @"",
                                                                   [NSNumber numberWithInt:detailUiField.fieldDetail.SPR14__Override_Related_Lookup__c.boolValue],
                                                                   (detailUiField.fieldDetail.SPR14__Field_Mapping__c != nil)?detailUiField.fieldDetail.SPR14__Field_Mapping__c:@"",
                                                                   (detailUiField.fieldDetail.SPR14__Context_Source_Object__c != nil)?detailUiField.fieldDetail.SPR14__Context_Source_Object__c:@"",
                                                                   nil];
                        ...
                        NSString * detail_header_info = pageDetail.DetailLayout.SPR14__Header_Reference_Field__c;
                        NSString * detail_object_name = pageDetail.DetailLayout.SPR14__Object_Name__c;
                        NSString * detail_object_alias_name = pageDetail.DetailLayout.SPR14__Name__c;
                        NSString * detail_multi_add_config = pageDetail.DetailLayout.SPR14__Multi_Add_Configuration__c;
                        NSString * detail_multi_add_search_field = pageDetail.DetailLayout.SPR14__Multi_Add_Search_Field__c;
                        NSString * detail_mutlti_add_search_object = pageDetail.DetailLayout.SPR14__Multi_Add_Search_Object__c;
                        NSString * detail_page_layout_id = pageDetail.DetailLayout.SPR14__Page_Layout_ID__c;
                        ...
                        NSMutableArray * detailObjects = [NSMutableArray arrayWithObjects:
                                                          ...
                                                          [NSNumber numberWithBool:pageDetail.DetailLayout.SPR14__Allow_New_Lines__c.boolValue],
                                                          [NSNumber numberWithBool:pageDetail.DetailLayout.SPR14__Allow_Delete_Lines__c.boolValue],
                                                          (pageDetail.noOfColumns != nil)?pageDetail.noOfColumns:@"",
                                                          (pageDetail.DetailLayout.SPR14__Name__c != nil)?pageDetail.DetailLayout.SPR14__Name__c:@"",
                                                          detailValuesId,
                                                          (detail_header_info != nil)?detail_header_info:@"",
                                                          (detail_object_name != nil)?detail_object_name:@"",
                                                          (pageDetail.DetailLayout.SPR14__Sequence__c != nil) ? pageDetail.DetailLayout.SPR14__Sequence__c:@"",
                    ...
                    for ( INTF_WebServicesDefServiceSvc_INTF_UIButton * button in header.buttons)
                    {
                        ...
                        {
                            INTF_WebServicesDefServiceSvc_SPR14__SFM_Event__c * bEvent = [button.buttonEvents objectAtIndex:be];
                            ...
                            NSMutableArray * beObjects = [NSMutableArray arrayWithObjects:
                                                          (bEvent.SPR14__Target_Call__c != nil)?bEvent.SPR14__Target_Call__c:@"",
                                                          (bEvent.SPR14__Event_Call_Type__c != nil)?bEvent.SPR14__Event_Call_Type__c:@"",
                                                          (bEvent.SPR14__Event_Type__c != nil)?bEvent.SPR14__Event_Type__c:@"",
                                                          nil];
                        ...
                        NSMutableArray * buttonObjects = [NSMutableArray arrayWithObjects:
                                                          (button.buttonDetail.SPR14__Title__c != nil)?button.buttonDetail.SPR14__Title__c:@"",
                    ...
                    for (int i = 0; i < [header.sections count]; i++)
                    {
                        ...
                        for (int j = 0; j < [fields count]; j++)
                        {
                            ...
                            NSMutableArray * hdrSectionFieldValues = [NSMutableArray arrayWithObjects:
                                                                      ...
                                                                      (uiField.fieldDetail.SPR14__Field_API_Name__c != nil)?uiField.fieldDetail.SPR14__Field_API_Name__c:@"",
                                                                      (uiField.fieldDetail.SPR14__Display_Column__c != nil)?uiField.fieldDetail.SPR14__Display_Column__c:@"",
                                                                      (uiField.fieldDetail.SPR14__Display_Row__c != nil)?uiField.fieldDetail.SPR14__Display_Row__c:@"",
                                                                      [NSNumber numberWithBool:uiField.fieldDetail.SPR14__Readonly__c.boolValue],
                                                                      [NSNumber numberWithBool:uiField.fieldDetail.SPR14__Required__c.boolValue],
                                                                      (uiField.fieldDetail.SPR14__Lookup_Context__c != nil)?uiField.fieldDetail.SPR14__Lookup_Context__c:@"",
                                                                      (uiField.fieldDetail.SPR14__Lookup_Query_Field__c != nil)?uiField.fieldDetail.SPR14__Lookup_Query_Field__c:@"",
                                                                      (uiField.fieldDetail.SPR14__Sequence__c != nil)?uiField.fieldDetail.SPR14__Sequence__c:@"",
                                                                      (uiField.fieldDetail.SPR14__Named_Search__c != nil) ? uiField.fieldDetail.SPR14__Named_Search__c :@"",
                                                                      (uiField.fieldDetail.SPR14__Related_Object_Name__c != nil)?uiField.fieldDetail.SPR14__Related_Object_Name__c:@"",
                                                                      (uiField.fieldDetail.SPR14__DataType__c != nil)?uiField.fieldDetail.SPR14__DataType__c:@"",
                                                                      @"",
                                                                      @"",
                                                                      @"",
                                                                      [NSNumber numberWithBool:uiField.fieldDetail.SPR14__Use_For_SLA_Clock__c.boolValue],
                                                                      [NSNumber numberWithInt:uiField.fieldDetail.SPR14__Override_Related_Lookup__c.boolValue],
                                                                      (uiField.fieldDetail.SPR14__Field_Mapping__c != nil)?uiField.fieldDetail.SPR14__Field_Mapping__c:@"",
                                                                      (uiField.fieldDetail.SPR14__Context_Source_Object__c != nil)?uiField.fieldDetail.SPR14__Context_Source_Object__c:@"",
                        ...
                        NSMutableArray * hdrSectionValues = [NSMutableArray arrayWithObjects:
                                                             (section.sectionDetail.SPR14__No_Of_Columns__c != nil)?section.sectionDetail.SPR14__No_Of_Columns__c:@"",
                                                             (section.sectionDetail.SPR14__Title__c != nil)?section.sectionDetail.SPR14__Title__c:@"",
                                                             (section.sectionDetail.SPR14__Sequence__c != nil)?section.sectionDetail.SPR14__Sequence__c:@"",
                                                             (hdrSectionFields != nil)?hdrSectionFields:[NSMutableArray array],
                                                             [NSNumber numberWithBool:section.sectionDetail.SPR14__Use_For_SLA_Clock__c.boolValue],
                                                             nil];
                    ...
                    {
                        INTF_WebServicesDefServiceSvc_SPR14__SFM_Event__c * eventDetail = [pageLevelEvents objectAtIndex:i];
                        ...
                        [eventsDictionary setObject:((eventDetail.SPR14__Event_Type__c != nil)?eventDetail.SPR14__Event_Type__c:@"") forKey:gEVENT_TYPE];
                        [eventsDictionary setObject:((eventDetail.SPR14__Target_Call__c != nil)?eventDetail.SPR14__Target_Call__c:@"") forKey:gEVENT_TARGET_CALL];
                        [eventsDictionary setObject:((eventDetail.SPR14__Event_Id__c != nil)?eventDetail.SPR14__Event_Id__c:@"") forKey:gEVENT_ID];
                        [eventsDictionary setObject:((eventDetail.SPR14__Page_Layout__c != nil)?eventDetail.SPR14__Page_Layout__c:@"") forKey:gEVENT_LAYOUT_ID];
                    ...
                    NSMutableArray * hdrLayoutKeys = [NSMutableArray arrayWithObjects:
                                                      ...
                                                      gHEADER_ID,
                                                      gSPR14__Resolution_Customer_By__c,
                                                      gSPR14__Restoration_Customer_By__c,
                    ...
                    NSString * resolution = [hdrData objectForKey:gSPR14__Resolution_Customer_By__c];
                    if ((resolution == nil) || [resolution isKindOfClass:[NSNull class]])
                        resolution = @"";
                    NSString * restoration = [hdrData objectForKey:gSPR14__Restoration_Customer_By__c];
                    if ((restoration == nil) || [restoration isKindOfClass:[NSNull class]])
                        restoration = @"";
                    
                    NSMutableArray * hdrLayoutObjects = [NSMutableArray arrayWithObjects:
                                                         (header.headerLayout.SPR14__Page_Layout_ID__c != nil)?header.headerLayout.SPR14__Page_Layout_ID__c:@"",
                                                         (header.headerLayout.SPR14__Name__c != nil)?header.headerLayout.SPR14__Name__c
                                                                                        :@"",
                                                         (header.headerLayout.SPR14__Object_Name__c != nil)?header.headerLayout.SPR14__Object_Name__c:@"",
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Allow_New_Lines__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Allow_Delete_Lines__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__IsStandard__c.boolValue],
                                                         (header.headerLayout.SPR14__Action_On_Zero_Lines__c != nil)?header.headerLayout.SPR14__Action_On_Zero_Lines__c:@"",
                                                         hdrSections,
                                                         ...
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Enable_Attachments__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Enable_Chatter__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Enable_Troubleshooting__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Enable_Service_Report_View__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Enable_Service_Report_Generation__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Show_All_Sections_By_Default__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Show_Product_History__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Show_Account_History__c.boolValue],
                                                         @"",
                                                         @"",
                                                         resolution,
                                                         restoration,
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Hide_Quick_Save__c.boolValue],
                                                         [NSNumber numberWithBool:header.headerLayout.SPR14__Hide_Save__c.boolValue],
                                                         hdrData,
                                                         sfmPageEvents,
                                                         nil];
                    [hdrSections release];
            ...
            @autoreleasepool
            {
               ...
               SBJsonParser *parser = [[SBJsonParser alloc] init];
                ...
                for(int counter =0;counter < [array count];counter++){
                    ...
                    if ([key isEqualToString:@"SPR14__Site__c"]) {
            ...
            for (int i = 0; i < [array count]; i++)
            {
                ...
                else if ( [key isEqualToString:@"ERROR"])
                {
                    ...
                    for (int j = 0; j < [valueMap count]; j++)
                    {
                        ...
                        {
                            INTF_WebServicesDefServiceSvc_SVMXMap * error_SPR14_map = [errorvaluemap objectAtIndex:w];
                            local_id = (error_SPR14_map.key!= nil )?error_SPR14_map.key:@"";
                            sf_id    = (error_SPR14_map.value != nil)? error_SPR14_map.value:@"";
                        }
...
- (NSMutableArray *) getProductHistoryFromResponse:(INTF_WebServicesDefBindingResponse *)response
{
    ...
    for (int i = 0; i < [bodyParts count]; i++)
    {
        ...
        {
            INTF_WebServicesDefServiceSvc_SPR14__Service_Order__c * serviceOrder = [historyInfo objectAtIndex:j];
            NSMutableArray * objects = [NSMutableArray arrayWithObjects:
                                        (serviceOrder.CreatedDate != nil)?serviceOrder.CreatedDate:@"",
                                        (serviceOrder.SPR14__Problem_Description__c != nil)?serviceOrder.SPR14__Problem_Description__c:@"",
                                   ...
                                   //     (serviceOrder.SPR14__Top_Level__c != nil)?serviceOrder.SPR14__Top_Level__c:@"",
                                        nil];
...
- (NSMutableArray *) getAccountHistoryFromResponse:(INTF_WebServicesDefBindingResponse *)response
{
    ...
    {
        INTF_WebServicesDefServiceSvc_SPR14__Service_Order__c * serviceOrder = [historyInfo objectAtIndex:i];
...
- (void) describeObjectFromResponse:(INTF_WebServicesDefBindingResponse *)response
{
    ...
    INTF_WebServicesDefServiceSvc_INTF_NamedSearchInfo * namedSearchInfo = [namedSearch objectAtIndex:0];
    INTF_WebServicesDefServiceSvc_SPR14__ServiceMax_Processes__c * namedSearchHdr = [namedSearchInfo namedSearchHdr];
    NSString * sourceObject = [namedSearchHdr SPR14__Source_Object_Name__c];
...
- (NSMutableDictionary *) getDescribeObjects:(NSMutableDictionary *)bodyParts
{
    ...
    INTF_WebServicesDefServiceSvc_SPR14__Page_Layout__c * headerLayout = nil; 
    ...
    if (headerLayout != nil)
        objectName = headerLayout.SPR14__Object_Name__c;
    else
        objectName = @"";
    ...
    for (int h = 0; h < [hdrSections count]; h++)
    {
        ...
        for (int f = 0; f < [fields count]; f++)
        {
            ...
            INTF_WebServicesDefServiceSvc_SPR14__Page_Layout_Detail__c * fieldDetail = field.fieldDetail;
            if ([fieldDetail.SPR14__DataType__c isEqualToString:@"reference"])
                [describeObjectsArray addObject:fieldDetail.SPR14__Related_Object_Name__c];
        }
    }
    ...
    for (int d = 0; d < [dtl count]; d++)
    {
        ...
        NSString * objName = pageDetail.DetailLayout.SPR14__Object_Name__c;
        BOOL flag = YES;
...
- (void) getDictionaryFromPageLayout:(NSMutableDictionary *)bodyParts withDescribedObjects:(NSMutableArray *)describeObjects
{
  ...
  @try{
    ...
    for (int itr = 0; itr < [describeObjects count]; itr++)
    {
        ...
        if ([[sObj name] isEqualToString:hdr.headerLayout.SPR14__Object_Name__c])
            break;
    }
    ...
    for (int i = 0; i < [hdr.sections count]; i++)
    {
        ...
        for (int j = 0; j < [fields count]; j++)
        {
            ...
            NSMutableArray * hdrSectionFieldValues = [NSMutableArray arrayWithObjects:
                                               ...
                                               ([[sObj fieldWithName:uiField.fieldDetail.SPR14__Field_API_Name__c] label] != nil)?[[sObj fieldWithName:uiField.fieldDetail.SPR14__Field_API_Name__c] label]:@"",
    ...
    NSMutableArray * hdrLayoutObjects = [NSMutableArray arrayWithObjects:
                                         (hdr.headerLayout.SPR14__Object_Name__c != nil)?hdr.headerLayout.SPR14__Object_Name__c:@"",
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Allow_New_Lines__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Allow_Delete_Lines__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__IsStandard__c.boolValue],
                                         (hdr.headerLayout.SPR14__Action_On_Zero_Lines__c != nil)?hdr.headerLayout.SPR14__Action_On_Zero_Lines__c:@"",
                                         hdrSections,
                                         hdrButtons,
                                         sfmPageEvents,
                                         ...
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Enable_Attachments__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Enable_Chatter__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Enable_Troubleshooting__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Enable_Service_Report_View__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Enable_Service_Report_Generation__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Show_All_Sections_By_Default__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Show_Product_History__c.boolValue],
                                         [NSNumber numberWithBool:hdr.headerLayout.SPR14__Show_Account_History__c.boolValue],
    ...
    for (int d = 0; d < [dtl count]; d++)
    {
        ...
        {
            sObj = [describeObjects objectAtIndex:itr];
            if ([[sObj name] isEqualToString:pageDetail.DetailLayout.SPR14__Object_Name__c])
                break;   
        }
        ...
        for (int f = 0; f < [pageDetail.fields count]; f++)
        {
            ...
            NSMutableArray * detailFieldObjects = [NSMutableArray arrayWithObjects:
                                            (field.fieldDetail.SPR14__Field_API_Name__c != nil)?field.fieldDetail.SPR14__Field_API_Name__c:@"",
                                            (field.fieldDetail.SPR14__Display_Column__c != nil)?field.fieldDetail.SPR14__Display_Column__c:@"",
                                            (field.fieldDetail.SPR14__Display_Row__c != nil)?field.fieldDetail.SPR14__Display_Row__c:@"",
                                            [NSNumber numberWithBool:field.fieldDetail.SPR14__Readonly__c.boolValue],
                                            [NSNumber numberWithBool:field.fieldDetail.SPR14__Required__c.boolValue],
                                            (field.fieldDetail.SPR14__Lookup_Context__c != nil)?field.fieldDetail.SPR14__Lookup_Context__c:@"",
                                            (field.fieldDetail.SPR14__Lookup_Query_Field__c != nil)?field.fieldDetail.SPR14__Lookup_Query_Field__c:@"",
                                            (field.fieldDetail.SPR14__Sequence__c != nil)?field.fieldDetail.SPR14__Sequence__c:@"",
                                            (field.fieldDetail.SPR14__Named_Search__c != nil) ? field.fieldDetail.SPR14__Named_Search__c:@"",
                                            (field.fieldDetail.SPR14__Related_Object_Name__c != nil)?field.fieldDetail.SPR14__Related_Object_Name__c:@"",
                                            (field.fieldDetail.SPR14__DataType__c != nil)?field.fieldDetail.SPR14__DataType__c:@"",
                                            ([[sObj fieldWithName:field.fieldDetail.SPR14__Field_API_Name__c] label] != nil)?[[sObj fieldWithName:field.fieldDetail.SPR14__Field_API_Name__c] label]:@"",
                                            ...
                                            [NSNumber numberWithInt:field.fieldDetail.SPR14__Override_Related_Lookup__c.boolValue],
                                            nil];
    ...
    if ([sfmPageObjectName isEqualToString:@"SPR14X1__SERVICE_ORDER__C"])
    {
...
- (void)sendRequestToGetData:(NSString *)workOrderId {
    ...
    @try{
        ...
        valueMapforObject.key=@"Object_Name";
        valueMapforObject.value=@"SPR14__Service_Order__c";
...
- (NSArray *) getCreateProcessesDictionaryArray:(INTF_WebServicesDefBindingResponse *)response
{
    ...
    {
        INTF_WebServicesDefServiceSvc_SPR14__ServiceMax_Processes__c * create_process = [create_processes objectAtIndex:i];
        ...
        NSArray * createInfoObjects = [NSArray arrayWithObjects:
                                     (create_process.SPR14__Name__c != nil)?create_process.SPR14__Name__c:@"",
                                     (create_process.SPR14__ProcessID__c != nil)?create_process.SPR14__ProcessID__c:@"",
                                     (create_process.SPR14__Description__c != nil) ? create_process.SPR14__Description__c:@"",
                                     (create_process.SPR14__Source_Object_Name__c != nil)? create_process.SPR14__Source_Object_Name__c:@"",
                                     nil];
    ...
    {
        NSDictionary * dict = [array objectAtIndex:i];
        NSString * str = [dict objectForKey:SPR14_OBJECT_NAME];  
...
- (NSArray *) getViewLayoutArray:(INTF_WebServicesDefBindingResponse *)response
{
    ...
    for (int i = 0; i < [viewLayoutsInfo count]; i++)
    {
        ...
        {
            INTF_WebServicesDefServiceSvc_SPR14__ServiceMax_Processes__c * viewInfo = [layoutsInfo objectAtIndex:j];
            NSArray * viewInfokeys = [NSArray arrayWithObjects:
                                      VIEW_OBJECTNAME,
                                      VIEW_SPR14_Name, 
                                      VIEW_SPR14_ProcessID, 
                                      nil];
            
            NSArray * viewInfoObjects = [NSArray arrayWithObjects:
                                         (objectName != nil)?objectName:@"",
                                         (viewInfo.SPR14__Name__c != nil)?viewInfo.SPR14__Name__c:@"",
                                         (viewInfo.SPR14__ProcessID__c != nil)?viewInfo.SPR14__ProcessID__c:@"",
                                         nil];
...
- (void) didGetNameField:(ZKQueryResult *)result error:(NSError *)error context:(id)context
{
    ...
    for (int j = 0; j < [appDelegate.wsInterface.viewLayoutsArray count]; j++)
    {
        ...
        {
            [appDelegate.createObjectContext setValue:[viewLayoutDict objectForKey:@"SPR14__ProcessID__c"] forKey:PROCESSID];
            appDelegate.newProcessId = [viewLayoutDict objectForKey:@"SPR14__ProcessID__c"];
            break;
        }
    }
