...
-(INTF_WebServicesDefServiceSvc_INTF_SFMRequest *) Put:(NSString *)event_name
{
	...
	@try
	{
		...
		if([event_name isEqualToString:@"PUT_UPDATE"] && [event_type isEqualToString:@"SYNC"])//PUT_UPDATE
		{
			...
			SPR14Map_lastModified.value = [appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_UPDATE_RESONSE_TIME] == nil ?@"":[appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_UPDATE_RESONSE_TIME];
		...
		else if([event_name isEqualToString:@"PUT_INSERT"] && [event_type isEqualToString:@"SYNC"])
		{
			...
			INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_lastModified =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];         
			SPR14Map_lastModified.key = @"SYNC_TIME_STAMP";
			SPR14Map_lastModified.value = [appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_INSERT_RESONSE_TIME] == nil ?@"":[appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_INSERT_RESONSE_TIME];
			...
			SPR14Map_startTime.value = [appDelegate.wsInterface getSyncTimeStampWithTheIntervalof15days:START_TIME] == nil ? @"" :[appDelegate.wsInterface getSyncTimeStampWithTheIntervalof15days:START_TIME];
			...
			SPR14Map_endTime.value = [appDelegate.wsInterface getSyncTimeStampWithTheIntervalof15days:END_TIME]== nil ? @"" :[appDelegate.wsInterface getSyncTimeStampWithTheIntervalof15days:END_TIME];
		...
		else if ([event_name isEqualToString:@"PUT_DELETE"] && [event_type isEqualToString:@"SYNC"])
		{
			INTF_WebServicesDefServiceSvc_SVMXMap * SPR14Map_lastModified =  [[[INTF_WebServicesDefServiceSvc_SVMXMap alloc] init] autorelease];
			SPR14Map_lastModified.key = @"SYNC_TIME_STAMP";
			SPR14Map_lastModified.value = [appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_DELETE_RESPONSE_TIME] == nil ?@"":[appDelegate.wsInterface get_SYNCHISTORYTime_ForKey:LAST_DELETE_RESPONSE_TIME];
			[sfmRequest.valueMap addObject:SPR14Map_lastModified];
