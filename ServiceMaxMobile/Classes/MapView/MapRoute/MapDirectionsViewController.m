...
- (void) showRecentVisits:(NSArray *)_recentVisitsArray
{
    ...
    for (int i = 0; i < [recentVisitsArray count]; i++)
    {
        ...
        coordinate.latitude = [[[[recentVisitsArray objectAtIndex:i] fields] objectForKey:SPR14LATITUDE] doubleValue];
        coordinate.longitude = [[[[recentVisitsArray objectAtIndex:i] fields] objectForKey:SPR14LONGITUDE] doubleValue];
