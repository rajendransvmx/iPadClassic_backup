...
- (void) getProductNameForProductID:(NSString *)productTd
{
	...
	NSLog(@"getProductNameForProductID = %@", _query);
...
{    
    ...
    if([records count] > 0)
    {
        ...
        NSLog(@"Exception Name Troubleshooting :didGetProductName %@",exp.name);
        NSLog(@"Exception Reason Troubleshooting :didGetProductName %@",exp.reason);
    }
    @finally { 
...
- (void) didSelectProductName:(ZKQueryResult *)result error:(NSError *)error context:(id)context
{
    ...
    if([records count] > 0)
    {
        ...
        NSLog(@"Exception Name Troubleshooting :didSelectProductName %@",exp.name);
        NSLog(@"Exception Reason Troubleshooting :didSelectProductName %@",exp.reason);
    }
    @finally {
    [activity stopAnimating];
	}
...
- (void) didQueryTroubleshootingForProductName:(ZKQueryResult *)result error:(NSError *)error context:(id)context
{
    ...
    for (int i = 0; i < [_array count]; i++ )
    {
        ...
        NSLog(@"Exception Name Troubleshooting :didQueryTroubleshootingForProductName %@",exp.name);
        NSLog(@"Exception Reason Troubleshooting :didQueryTroubleshootingForProductName %@",exp.reason);
    }
...
- (NSString *) showTroubleshootingForIndex:(NSUInteger)index
{
	...
	NSLog(@"Exception Name Troubleshooting :showTroubleshootingForIndex %@",exp.name);
	NSLog(@"Exception Reason Troubleshooting :showTroubleshootingForIndex %@",exp.reason);
    }
...
- (void) didQueryTroubleshootingBodyForDocument:(ZKQueryResult *)result error:(NSError *)error context:(id)context
{
	...
	NSLog(@"Exception Name Troubleshooting :didQueryTroubleshootingBodyForDocument %@",exp.name);
	NSLog(@"Exception Reason Troubleshooting :didQueryTroubleshootingBodyForDocument %@",exp.reason);
    }
