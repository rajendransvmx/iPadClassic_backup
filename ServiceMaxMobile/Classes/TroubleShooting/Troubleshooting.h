...
UISearchBarDelegate>
{
    ...
    IBOutlet UIImageView *servimaxLogo;
    IBOutlet UIButton *productManual;
    IBOutlet UIButton *chatter;
    IBOutlet UIButton *helpButton;
    IBOutlet UIButton *webviewBack;
    IBOutlet UIButton *webviewForward;
}
