...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // NSLog(@"User Search Data = %@",self.masterViewController.searchString.text);
    ...
    //[resultViewController release];
        ...
        NSLog(@"Exception Name DetailViewControllerForSFM :didSelectRowAtIndexPath %@",exp.name);
        NSLog(@"Exception Reason DetailViewControllerForSFM :didSelectRowAtIndexPath %@",exp.reason);
