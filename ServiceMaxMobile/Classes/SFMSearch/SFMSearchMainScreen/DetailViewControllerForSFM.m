...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [[_sfmArray objectAtIndex:indexPath.row] objectForKey:@"SPR14__Name__c"];
    NSString *DescriptionText=[[_sfmArray objectAtIndex:indexPath.row] objectForKey:@"SPR14__Description__c"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // SMLog(kLogLevelVerbose,@"User Search Data = %@",self.masterViewController.searchString.text);
    ...
    resultViewController.masterTableHeader = [processDict objectForKey:@"SPR14__Name__c"];
