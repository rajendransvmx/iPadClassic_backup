...
#import "AccessibilitySFMSearchMasterViewConstants.h"
 ...
 didFinishPickingMediaWithInfo: (NSDictionary*) info
{
    ...
    [reader dismissViewControllerAnimated: YES completion:nil];
        ...
        SMLog(kLogLevelError,@"Exception Name MasterViewController :imagePickerController %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason MasterViewController :imagePickerController %@",exp.reason);
