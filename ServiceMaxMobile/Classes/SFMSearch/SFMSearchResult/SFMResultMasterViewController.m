 ...
 didFinishPickingMediaWithInfo: (NSDictionary*) info
{
    ...
    [self performSelector:@selector(refineSearch:)];
        ...
        NSLog(@"Exception Name SFMResultMasterViewController :imagePickerController %@",exp.name);
        NSLog(@"Exception Reason SFMResultMasterViewController :imagePickerController %@",exp.reason);
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSLog(@"Exception Name SFMResultMasterViewController :cellForRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason SFMResultMasterViewController :cellForRowAtIndexPath %@",exp.reason);
    }
