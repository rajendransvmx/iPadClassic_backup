...
- (NSArray *) constructTableHeader : (NSArray *)data
{
    ...
    {
        [header addObject:[NSString stringWithFormat:@"%@.%@",[obj objectForKey:@"SPR14__Object_Name2__c"],[obj objectForKey:@"SPR14__Field_Name__c"]]];
    }
	}@catch (NSException *exp) {
...
- (NSMutableArray *)getResultsForObject:(NSString *)object withConfigData:(NSDictionary *)dataForObject
{
    ...
    @try
    {
        ...
        {   
            ...
            {
                NSString *key = [NSString stringWithFormat:@"%@.%@",[displaydict objectForKey:@"SPR14__Object_Name2__c"], [displaydict objectForKey:@"SPR14__Field_Name__c"]];
...
//            SMLog(kLogLevelVerbose,@"%s",field1);
    ...
    for (int v = 0; v < [appDelegate.view_layout_array count]; v++)
    {
        ...
        {
            processId = ([dict objectForKey:VIEW_SPR14_ProcessID]!=nil)?[dict objectForKey:VIEW_SPR14_ProcessID]:@"";
            break;
        }
    }
