...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    if([self.masterView.searchFilterSwitch isOn])
    {
        ...
        NSLog(@"Exception Name SFMResultDetailViewController :numberOfRowsInSection %@",exp.name);
        NSLog(@"Exception Reason SFMResultDetailViewController :numberOfRowsInSection %@",exp.reason);
        }
    }
    else {
        noOfRows = [cellArray count];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    @try
    {
        ...
        {
            NSLog(@"Array Count = %d",[cellArray count]);
    ...
    //        }
        ...
        NSLog(@"Exception Name SFMResultDetailViewController :cellForRowAtIndexPath %@",exp.name);
        NSLog(@"Exception Reason SFMResultDetailViewController :cellForRowAtIndexPath %@",exp.reason);
    }
...
//        NSLog(@"Data = %@",fullDataDict);
     ...
     [self.mainView presentViewController:resultController animated:YES completion:nil];
		...
		NSLog(@"Exception Name SFMResultDetailViewController :didSelectRowAtIndexPath %@",exp.name);
		NSLog(@"Exception Reason SFMResultDetailViewController :didSelectRowAtIndexPath %@",exp.reason);    
       }
    @finally {
...
- (NSArray *) constructTableHeader : (NSArray *)data
{
	...
	NSLog(@"Exception Name SFMResultDetailViewController :constructTableHeader %@",exp.name);
	NSLog(@"Exception Reason SFMResultDetailViewController :constructTableHeader %@",exp.reason);
    }
...
- (NSMutableArray *)getResultsForObject:(NSString *)object withConfigData:(NSDictionary *)dataForObject
{
    ...
    @try
    {
        ...
        {   
            ...
            NSLog(@"Exception Name SFMResultDetailViewController :getResultsForObject %@",exp.name);
            NSLog(@"Exception Reason SFMResultDetailViewController :getResultsForObject %@",exp.reason);
       ...
       forAllObjects:(BOOL) makeOnlineSearch
{
    ...
    if([self.masterView.searchFilterSwitch isOn] && makeOnlineSearch)
    {
        ...
        while (CFRunLoopRunInMode(kCFRunLoopDefaultMode, kRunLoopTimeInterval, YES))
        {
            ...
            NSLog(@"SFMResultDetailViewController.m : showObject: SFM Search");
#endif
        ...
        NSLog(@"onlineresultsObjectDict %@",onlineresultsObjectDict);
    }
...
//	[mainView.resultmasterView reloadTableWithOnlineData:onlineDataDict]; Kirti
	...
	NSLog(@"Exception Name SFMResultDetailViewController :showObjects %@",exp.name);
	NSLog(@"Exception Reason SFMResultDetailViewController :showObjects %@",exp.reason);
    }
...
- (NSArray *) getOfflineRecordsForObjectID:(NSString *) objectID
{
	...
	NSLog(@"Exception Name SFMResultDetailViewController :getOfflineRecordsForObjectID %@",exp.name);
	NSLog(@"Exception Reason SFMResultDetailViewController :getOfflineRecordsForObjectID %@",exp.reason);
    }
...
- (BOOL) isRecordPresentInOfflineResults:(NSArray *) offlineRecords record:(NSString *) onlineRecordId
{
	...
	NSLog(@"Exception Name SFMResultDetailViewController :isRecordPresentInOfflineResults %@",exp.name);
	NSLog(@"Exception Reason SFMResultDetailViewController :isRecordPresentInOfflineResults %@",exp.reason);
    }
...
//[appDelegate.sfmPageController release];
        ...
        NSLog(@"Exception Name SFMResultDetailViewController :onDemandDataFecthing %@",exp.name);
        NSLog(@"Exception Reason SFMResultDetailViewController :onDemandDataFecthing %@",exp.reason);
    }
...
//            NSLog(@"%s",field1);
	...
	// //appDelegate.sfmPageController = nil;
        ...
        NSLog(@"Exception Name SFMResultDetailViewController :accessoryButtonTapped %@",exp.name);
        NSLog(@"Exception Reason SFMResultDetailViewController :accessoryButtonTapped %@",exp.reason);
