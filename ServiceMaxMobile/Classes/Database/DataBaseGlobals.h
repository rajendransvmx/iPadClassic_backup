...
#define SORT_CRITERIA            @"SVMXDEV__Values__c"
...
//9366 - Defect Fix
#define MSFW_WIZARD_LAYOUT              @"SFM_wizard_layout"
...
#define ATTACHMENT_DICT                          @"Attachments"
#define IMAGES_DICT                              @"IMAGES"
#define DOCUMENT_DICT                            @"DOCUMENT"  
#define OBJECT_LIST                              @"objects"  
#define K_ATTACHMENT_ID                          @"AttachmentId"
#define K_CONTEN_TYPE                            @"ContentType"
#define K_NAME                                   @"Name"
#define K_SIZE                                   @"Size"
#define K_DESCRIPTION                            @"Description"
#define K_ACTION                                 @"Action"
#define K_STATUS                                 @"Status"
#define K_PERCENTPROGRESS                        @"percentProgress"
#define K_PARENT_SFId                            @"Parent_sfId"
#define K_PARENT_LOCALId                         @"parent_localid"
#define K_PRIORITY                               @"Priority"
#define K_TYPE                                   @"Type"
#define K_SECTION                                @"Section"
#define K_LASTMODIFIEDDATE                       @"lastModifiedDate"
#define ATTACHMENT_PHOTOS                        @"photo"
#define ATTACHMENT_VIDEO                         @"video"
#define DELETED_IDS                              @"deleted_ids"
#define NEW_IDS                                  @"new_Added_ids"
#define K_ATTACHMENT_SFID                        @"attachment_sfid"
#define DELETE_ATTACHMENT                        @"delete_Attachment"
#define NEW_ATTACHMENT                           @"new_Attachment"

#define ATTACHMENT_ERROR                         @"AttachmentError"
#define ATTACHMENT_TRAILER                       @"SFAttachmentTrailer"  //10339 Defect Fix
