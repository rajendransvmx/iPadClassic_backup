...
#define OBJECT_ID                                       @"Id"
#define FIELD_NAME                                      @"SVMXDEV__Field_Name__c"
#define OBJECT_NAME2                                    @"SVMXDEV__Object_Name2__c"
#define LOOKUP_FIELD_API_NAME                           @"SVMXDEV__Lookup_Field_API_Name__c"
#define FIELD_RELATIONSHIP_NAME                         @"SVMXDEV__Field_Relationship_Name__c"
#define OBJECT_FIELD_NAME                               @"SVMXDEV__Object_Name__c"
#define DISPLAY_TYPE                                    @"SVMXDEV__Display_Type__c"
#define OPERAND                                         @"SVMXDEV__Operand__c"
#define OPERATOR                                        @"SVMXDEV__Operator__c"
// SFM Search
