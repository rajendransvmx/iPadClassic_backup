...
#define OBJECT_ID                                       @"Id"
#define FIELD_NAME                                      @"SPR14__Field_Name__c"
#define OBJECT_NAME2                                    @"SPR14__Object_Name2__c"
#define LOOKUP_FIELD_API_NAME                           @"SPR14__Lookup_Field_API_Name__c"
#define FIELD_RELATIONSHIP_NAME                         @"SPR14__Field_Relationship_Name__c"
#define OBJECT_FIELD_NAME                               @"SPR14__Object_Name__c"
#define DISPLAY_TYPE                                    @"SPR14__Display_Type__c"
#define OPERAND                                         @"SPR14__Operand__c"
#define OPERATOR                                        @"SPR14__Operator__c"
// SFM Search
