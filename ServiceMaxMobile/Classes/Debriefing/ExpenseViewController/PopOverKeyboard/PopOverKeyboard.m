...
- (IBAction) EnterNumber:(id)sender
{
	...
	SMLog(kLogLevelError,@"Exception Name PopOverKeyboard :EnterNumber %@",exp.name);
	SMLog(kLogLevelError,@"Exception Reason PopOverKeyboard :EnterNumber %@",exp.reason);
    }
...
- (IBAction) BackSpace:(id)sender
{
	...
	SMLog(kLogLevelError,@"Exception Name PopOverKeyboard :BackSpace %@",exp.name);
	SMLog(kLogLevelError,@"Exception Reason PopOverKeyboard :BackSpace %@",exp.reason);
    }
