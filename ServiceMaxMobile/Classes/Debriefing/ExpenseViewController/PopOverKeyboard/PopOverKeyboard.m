...
- (IBAction) EnterNumber:(id)sender
{
	...
	NSLog(@"Exception Name PopOverKeyboard :EnterNumber %@",exp.name);
	NSLog(@"Exception Reason PopOverKeyboard :EnterNumber %@",exp.reason);
    }
...
- (IBAction) BackSpace:(id)sender
{
	...
	NSLog(@"Exception Name PopOverKeyboard :BackSpace %@",exp.name);
	NSLog(@"Exception Reason PopOverKeyboard :BackSpace %@",exp.reason);
    }
