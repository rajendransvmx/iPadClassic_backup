...
- (void)viewDidLoad
{
  ...
  /*  NSFileManager * fileManager = [NSFileManager defaultManager];
	...
	NSLog(@"Exception Name SummaryViewController :viewDidLoad %@",exp.name);
	NSLog(@"Exception Reason SummaryViewController :viewDidLoad %@",exp.reason);
    }
...
//	Expenses = [[NSMutableArray alloc] initWithCapacity:0];
	...
	for( int i = 0; i < [allkeys count]; i++ )
	{
        ...
        NSLog(@"Exception Name SummaryViewController :PopulateData %@",exp.name);
        NSLog(@"Exception Reason SummaryViewController :PopulateData %@",exp.reason);
    }
    // Analyser
    @finally {
        [_Parts release];
...
- (IBAction) createPDF;
{
   /* if (![appDelegate isInternetConnectionAvailable])
	...
	NSLog(@"Exception Name SummaryViewController :createPDF %@",exp.name);
	NSLog(@"Exception Reason SummaryViewController :createPDF %@",exp.reason);
    }
...
- (void) setTotalCost
{
    ...
    for (int i = 0; i < count; i++)
    {
		...
		NSLog(@"Exception Name SmmaryViewController :setTotalCost %@",exp.name);
		NSLog(@"Exception Reason SummaryViewController :setTotalCost %@",exp.reason);
    }
...
{    
	...
	NSLog(@"Exception Name SummaryViewController :cellForRowAtIndexPath %@",exp.name);
	NSLog(@"Exception Reason SummaryViewController :cellForRowAtIndexPath %@",exp.reason);
    }
