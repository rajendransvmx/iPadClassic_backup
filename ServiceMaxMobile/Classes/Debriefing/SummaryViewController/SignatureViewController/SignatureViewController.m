...
#import "AccessibilitySignatureConstants.h"
...
- (void) setAccessibilityIdentifierForInstanceVariable
{
    ...
    [cancelButton setAccessibilityIdentifier:kAccSignatureCancel];
    
    doneButton.isAccessibilityElement = YES;
    [doneButton setAccessibilityIdentifier:kAccSignatureDone];
    
    eraseSignature.isAccessibilityElement = YES;
    [eraseSignature setAccessibilityIdentifier:kAccSignatureErase];
    
    watermark.isAccessibilityElement = YES;
    [watermark setAccessibilityIdentifier:kAccWaterMark];
    
    [drawImage setIsAccessibilityElement:YES];
    [drawImage setAccessibilityIdentifier:kAccSignatureImage];
}
        ...
        
    {
        ...
        oldSize = [newData sizeWithFont:[UIFont boldSystemFontOfSize:31]
                   ...
                   constrainedToSize:CGSizeMake(MAX_WIDTH, MAX_HEIGHT)
                       ...
                       lineBreakMode:UILineBreakModeWordWrap];
        SMLog(kLogLevelVerbose,@"Range Position = %d Data Length = %d",range.location,[data length]);
...
//    [drawImage setAccessibilityIdentifier:@"SigntaureImageView"];
    [drawImage setAccessibilityIdentifier:kAccSignatureImage]; /*Accessibility Changes*/
