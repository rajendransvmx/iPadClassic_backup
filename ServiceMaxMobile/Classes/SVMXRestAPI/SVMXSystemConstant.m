...
NSString * const kDataPurgeCustomPriceBook                      = @"SPR14__Service_Pricebook__c";
NSString * const kDataPurgeCustomPriceBookEntry                 = @"SPR14__Service_Pricebook_Entry__c";
...
NSString * const kDataPurgeCustomPriceBookColumnName            = @"SPR14__Price_Book__c";
