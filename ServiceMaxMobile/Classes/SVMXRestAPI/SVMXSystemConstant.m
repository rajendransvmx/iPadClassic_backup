...
NSString * const kDataPurgeCustomPriceBook                      = @"SVMXDEV__Service_Pricebook__c";
NSString * const kDataPurgeCustomPriceBookEntry                 = @"SVMXDEV__Service_Pricebook_Entry__c";
...
NSString * const kDataPurgeCustomPriceBookColumnName            = @"SVMXDEV__Price_Book__c";
