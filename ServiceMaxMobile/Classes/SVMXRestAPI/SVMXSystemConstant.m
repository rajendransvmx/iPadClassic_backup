...
NSString * const kDataPurgeCustomPriceBook                      = @"SVMXC__Service_Pricebook__c";
NSString * const kDataPurgeCustomPriceBookEntry                 = @"SVMXC__Service_Pricebook_Entry__c";
...
NSString * const kDataPurgeCustomPriceBookColumnName            = @"SVMXC__Price_Book__c";
