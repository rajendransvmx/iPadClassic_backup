...
- (void) PopulateDateFromDay:(NSInteger) weekday totalDays:(NSInteger) numDays
{
    ...
    */
	...
	NSLog(@"Exception Name CalendarController :PopulateDateFromDay %@",exp.name);
	NSLog(@"Exception Reason CalendarController :PopulateDateFromDay %@",exp.reason);
                                 ...
                                 isPrevMonth:(BOOL) prevMonth
{
	...
	NSLog(@"Exception Name CalendarController :getRemainingDaysInMonth %@",exp.name);
	NSLog(@"Exception Reason CalendarController :getRemainingDaysInMonth %@",exp.reason);
	 [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
...
- (IBAction) DateClicked:(id)sender
{
	...
	NSLog(@"Exception Name CalendarController :DateClicked %@",exp.name);
	NSLog(@"Exception Reason CalendarController :DateClicked %@",exp.reason);
	 [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
...
- (NSMutableArray *) getWeeksArray
{
	...
	NSLog(@"Exception Name CalendarController :getWeeksArray %@",exp.name);
	NSLog(@"Exception Reason CalendarController :getWeeksArray %@",exp.reason);
	 [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
...
- (NSDictionary *) getWeekDetails
{
    ...
    @catch(NSException *exp)
    {
        NSLog(@"Exception Name CalendarController :getWeekDetails %@",exp.name);
        NSLog(@"Exception Reason CalendarController :getWeekDetails %@",exp.reason);
         [appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
    return dict;
}
...
- (NSArray *) getWeekBoundaries:(NSString *)date
{
	...
	NSLog(@"Exception Name CalendarConroller :getWeekBoundaries %@",exp.name);
	NSLog(@"Exception Reason CalendarConroller :getWeekBoundaries %@",exp.reason);
	[appDelegate CustomizeAletView:nil alertType:APPLICATION_ERROR Dict:nil exception:exp];
    }
