...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [bgImage release];
        ...
        SMLog(kLogLevelError,@"Exception Name CreateObjectRoot :cellForRowAtIndexPath %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason CreateObjectRoot :cellForRowAtIndexPath %@",exp.reason);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        SMLog(kLogLevelError,@"Create Object Error: %@", error.description);
