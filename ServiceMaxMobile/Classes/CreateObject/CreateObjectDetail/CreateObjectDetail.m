...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString * row_tittle = [dict objectForKey:SPR14_Name];
    ...
    NSString * object_description = [dict objectForKey:SPR14_Description];
    CGFloat height ;
    CGSize size;
    ...
    description.text =  [dict objectForKey:SPR14_Description];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    @try{
    NSDictionary * dict = [[appDelegate.StandAloneCreateProcess objectAtIndex:selectedRootViewRow] objectAtIndex:indexPath.row];
    NSString * processTitle = [dict objectForKey:SPR14_Name];
    processId = [dict objectForKey:SPR14_ProcessID];
    SMLog(kLogLevelVerbose,@"%@", processId);
    
    //sahana offline
    NSString * object_name = [dict objectForKey:SPR14_OBJECT_NAME];
