...
- (CGRect) getIntersectedEventWithLocation:(CGPoint)point
{
   ...
   @try
    ...
    for (int i = 0; i < [eventPositions count]; i++)
    {
        ...
        NSLog(@"Exception Name WeeklyViewEvent :getIntersectedEventWithLocation %@",exp.name);
        NSLog(@"Exception Reason WeeklyViewEvent :getIntersectedEventWithLocation %@",exp.reason);
...
- (BOOL) isEventInRect:(CGRect)_rect
{
    ...
    for (int i = 0; i < [eventPositions count]; i++)
    {
        ...
        NSLog(@"Exception Name WeeklyViewEvent :isEventInRect %@",exp.name);
        NSLog(@"Exception Reason WeeklyViewEvent :isEventInRect %@",exp.reason);
...
- (BOOL) canMoveToLocation
{
    ...
    for (int i = 0; i < [eventPositions count]; i++)
    {
        ...
        NSLog(@"Exception Name WeeklyViewEvent :canMoveToLocation %@",exp.name);
        NSLog(@"Exception Reason WeeklyViewEvent :canMoveToLocation %@",exp.reason);
