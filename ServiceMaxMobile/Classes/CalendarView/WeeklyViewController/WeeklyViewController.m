...
#import "AccessibilityWeeklyViewConstants.h"
...
{
    /*Accessibility Changes*/
    curWeek.isAccessibilityElement = YES;
    [curWeek setAccessibilityIdentifier:kAccCurrentWeek];
    
    prevWeek.isAccessibilityElement = YES;
    [ prevWeek setAccessibilityIdentifier:kAccPrevWeek];
    
    nextWeek.isAccessibilityElement = YES;
    [nextWeek setAccessibilityIdentifier:kAccNextWeek];
    
    monthYear.isAccessibilityElement = YES;
    [monthYear setAccessibilityIdentifier:kAccMonthYearLabel];
    
    day1Label.isAccessibilityElement = YES;
    [day1Label setAccessibilityIdentifier:kAccWeekMondayLabel];
    
    day2Label.isAccessibilityElement = YES;
    [day2Label setAccessibilityIdentifier:kAccWeekTuesdayLabel];
    
    day3Label.isAccessibilityElement = YES;
    [day3Label setAccessibilityIdentifier:kAccWeekWedLabel];
    
    day4Label.isAccessibilityElement = YES;
    [day4Label setAccessibilityIdentifier:kAccWeekThursdayLabel];
    
    day5Label.isAccessibilityElement = YES;
    [day5Label setAccessibilityIdentifier:kAccWeekFridayLabel];
    
    day6Label.isAccessibilityElement = YES;
    [day6Label setAccessibilityIdentifier:kAccWeekSatLabel];
    
    day7Label.isAccessibilityElement = YES;
    [day7Label setAccessibilityIdentifier:kAccWeekSundayLabel];
    
    sliderImage.isAccessibilityElement = YES;
    [sliderImage setAccessibilityIdentifier:kAccWeekSlider];
}
...
- (void) didInternetConnectionChange:(NSNotification *)notification
{
    ...
    if (isReachable)
    {
        SMLog(kLogLevelVerbose,@"Reachable");
        isInternetConnectionAvailable = YES;
    }
    else
    {
        SMLog(kLogLevelVerbose,@"Not Reachable");
...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    SMLog(kLogLevelVerbose,@"VIEW WILL APPEAR IN WEEKVIEW");
...
- (void)contiuePopulateWeekView {
    ...
    @synchronized(self){
    SMLog(kLogLevelVerbose,@"populateWeekView %d", [appDelegate.wsInterface.eventArray count]);
    @try{
        ...
        for ( int i = 0; i < [appDelegate.wsInterface.eventArray count]; i++ )
        {
            ...
            SMLog(kLogLevelVerbose,@"%@", [dict objectForKey:SUBJECT]);
            events.processId = @"";
            ...
            for (int v = 0; v < [appDelegate.view_layout_array count]; v++)
            {
                ...
                {
                    events.processId = [dict objectForKey:VIEW_SVMXDEV_ProcessID];
                    break;
                }
            }
            ...
            if (flag)
            {
                ...
                SMLog(kLogLevelWarning,@"shouldNotHappen");
            }
            /*Shravya-Calendar view 7408 */
            [events release];
            events = nil;
        ...
        SMLog(kLogLevelError,@"Exception Name WeeklyViewController :populateWeekView %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :populateWeekView %@",exp.reason);
    }
	@finally {
    [activity stopAnimating];
	}
...
{
    SMLog(kLogLevelVerbose,@"Swipe Recorgnized weeklyview");
}
...
{
    // SMLog(kLogLevelVerbose,@"viewWillDisappear");
}

- (void) viewDidDisappear:(BOOL)animated
{
    // SMLog(kLogLevelVerbose,@"viewDidDisappear");
}
...
- (NSArray *) getWeekStartEndDatesAtOptionalIndex:(NSString *)optionalIndex
{
	...
	SMLog(kLogLevelError,@"Exception Name WeeklyViewController :getWeekStartEndDatesAtOptionalIndex %@",exp.name);
	SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :getWeekStartEndDatesAtOptionalIndex %@",exp.reason);
    }
...
/*Accessibility Changes*/
- (void) setAccessibilityIdentifier:(NSArray *)array
{
    /*Accessibility Changes*/
    sunday.isAccessibilityElement = YES;
    [sunday setAccessibilityIdentifier:[NSString stringWithFormat:@"%@%@", kAccDateWeekLabel, [array objectAtIndex:0]]];
    
    monday.isAccessibilityElement = YES;
    [monday setAccessibilityIdentifier:[NSString stringWithFormat:@"%@%@", kAccDateWeekLabel, [array objectAtIndex:1]]];
    
    tuesday.isAccessibilityElement = YES;
    [tuesday setAccessibilityIdentifier:[NSString stringWithFormat:@"%@%@", kAccDateWeekLabel, [array objectAtIndex:2]]];
    
    wednesday.isAccessibilityElement = YES;
    [wednesday setAccessibilityIdentifier:[NSString stringWithFormat:@"%@%@", kAccDateWeekLabel, [array objectAtIndex:3]]];
    
    thursday.isAccessibilityElement = YES;
    [thursday setAccessibilityIdentifier:[NSString stringWithFormat:@"%@%@", kAccDateWeekLabel, [array objectAtIndex:4]]];
    
    friday.isAccessibilityElement = YES;
    [friday setAccessibilityIdentifier:[NSString stringWithFormat:@"%@%@", kAccDateWeekLabel, [array objectAtIndex:5]]];
    
    saturday.isAccessibilityElement = YES;
    [saturday setAccessibilityIdentifier:[NSString stringWithFormat:@"%@%@", kAccDateWeekLabel, [array objectAtIndex:6]]];
}
...
- (void) setDays
{
    ...
    /*Accessibility Changes*/
    [self setAccessibilityIdentifier:array];
	...
	SMLog(kLogLevelError,@"Exception Name WeeklyViewController :setDays %@",exp.name);
	SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :setDays %@",exp.reason);
    }
...
- (void) setDaysAtSliderLocationIndex:(NSUInteger)index
{
   ...
   sunday.text = [array objectAtIndex:0];
    ...
    [self setupEvents];
        ...
        SMLog(kLogLevelError,@"Exception Name WeeklyViewController :setDaysAtSliderLocationIndex %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :setDaysAtSliderLocationIndex %@",exp.reason);
    }
}
...
- (NSString *) getFirstLastFromWeek:(NSMutableArray *)array
{
    ...
    for (int i = 0; i < 7; i++)
    {
        ...
        SMLog(kLogLevelError,@"Exception Name WeeklyViewController :getFirstLastFromWeek %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :getFirstLastFromWeek %@",exp.reason);
    }
...
- (IBAction) NextWeek
{
   /* if (![appDelegate isInternetConnectionAvailable])
    ...
    if (currentSliderPositionIndex < ([sliderBoundsArray count]-1))
    {
        ...
        {
            // SMLog(kLogLevelVerbose,@"Location contains Rect %f, %f, %f, %f", sliderImage.frame.origin.x, sliderImage.frame.origin.y, sliderImage.frame.size.width, sliderImage.frame.size.height);
...
- (void) setupEvents
{
 ...
 //   SMLog(kLogLevelVerbose,@"%@ %@", startDate, endDate);
    ...
    //[appDelegate.wsInterface getEventsForStartDate:startDate EndDate:endDate];
        ...
        SMLog(kLogLevelError,@"Exception Name WeeklyViewController :setupEvents %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :setupEvents %@",exp.reason);
    }
...
- (void) clearWeekView
{
    ...
    [weeklyEventPositionArray removeAllObjects];
        ...
        SMLog(kLogLevelError,@"Exception Name WeeklyViewController :clearWeekView %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :clearWeekView %@",exp.reason);
    }
...
- (void) didQueryWorkOrder:(NSDictionary *)dictionary
{
    ...
    for (int i = 0; i < [workOrderArray count]; i++)
    {
        ...
        NSArray * event = [[NSArray arrayWithObjects:
                        ...
                        [[[workOrderArray objectAtIndex:i] objectForKey:SVMXDEVACCOUNTNAME] isKindOfClass:[NSString class]]?[[workOrderArray objectAtIndex:i] objectForKey:SVMXDEVACCOUNTNAME]:@"",
                             nil
                             ] retain];
	...
	didLoadWeekData = TRUE;
            ...
            SMLog(kLogLevelError,@"Exception Name WeeklyViewController :didQueryWorkOrder %@",exp.name);
            SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :didQueryWorkOrder %@",exp.reason);
    }
...
- (void) movedEvent:(WeeklyViewEvent *)event
{
    ...
    SMLog(kLogLevelVerbose,@"PrevDate = %d and Next Date =%d",prevDate,[date intValue]);
    ...
    updatestartDateTime = [updatestartDateTime stringByReplacingOccurrencesOfString:@"Z" withString:@""];
        ...
        SMLog(kLogLevelError,@"Exception Name WeeklyViewController :movedEvent %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :movedEvent %@",exp.reason);
    }
     @finally {
    [self enableUI];
	 }
...
{
    SMLog(kLogLevelVerbose,@"Created objects");
}
...
{
    // SMLog(kLogLevelVerbose,@"week view - willAnimateRotationToInterfaceOrientation");
}
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event {
    ...
    for (int i = 0; i < [eventViewArray count]; i++)
    {
        ...
        if ([touch view] == eventView.view)
        {
            ...
            flag = YES;
            didTap = YES;
            // SMLog(kLogLevelVerbose,@"EventView %d tapped", i);
...
//            else
    ...
    if ([touch view] == calEvent.view)
    {
        ...
        {
            [self disableUI];
            SMLog(kLogLevelVerbose,@"%@", weeklyEventPositionArray);
            [calEvent moveTo:calEvent.view.frame];
            ...
            if(ContinueRescheduling == TRUE)
            {
                ...
                {
                    SMLog(kLogLevelVerbose,@"Start Time = %@ and End Time = %@",updatestartDateTime,updateendDateTime);
                    ...
                    eventModificationObserver = [[PageModificationObserver alloc] initWithModifiedEventStartDate:updatestartDateTime
                                                                                                        ...
                                                                                                        recordId:calEvent.local_id
                                                                                                         andSfId:calEvent.eventId];
                   ...
                   NSString * local_id = [appDelegate.databaseInterface getLocalIdFromSFId:calEvent.eventId tableName:@"Event"];
                    SMLog(kLogLevelVerbose,@"Local Id = %@ For Event Id = %@",local_id,calEvent.eventId);
                    ...
                    [appDelegate.databaseInterface successiveSyncEntryForLocalId:local_id sfId:calEvent.eventId operation:UPDATE recordType:MASTER objName:@"Event" parentObjName:@"" parentLocalId:@"" headerLocalId:@"" syncType:AGRESSIVESYNC dataDict:eventDict  syncFlag:@"false" valuemapping:YES];
        ...
        SMLog(kLogLevelError,@"Exception Name WeeklyViewController :touchesEnded %@",exp.name);
        SMLog(kLogLevelError,@"Exception Reason WeeklyViewController :touchesEnded %@",exp.reason);
    }
