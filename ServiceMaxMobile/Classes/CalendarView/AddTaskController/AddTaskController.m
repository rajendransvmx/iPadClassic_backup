...
#import "AccessibilityAddTaskConstants.h"
...
- (void) setAccessibilityIdentifierForInstanceVariable
{
    ...
    [doneButton setAccessibilityIdentifier:kAccDone];
    
    cancelBuuton.isAccessibilityElement = YES;
    [cancelBuuton setAccessibilityIdentifier:kAccCancel];
...
- (NSMutableArray *) getTask
{
    ...
    if ([trimmed length] == 0) {
        SMLog(kLogLevelWarning,@"Empty String");
    }
