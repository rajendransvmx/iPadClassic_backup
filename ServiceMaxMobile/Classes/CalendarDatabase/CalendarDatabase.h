...
#define DATABASETYPE   @"sqlite"
#define _ID                                       @"Id"
#define SPR14__PRODUCT__C                         @"SPR14__Product__c"
#define SPR14__ACTUAL_QUANTITY2__C                @"SPR14__Actual_Quantity2__c"
#define SPR14__ACTUAL_PRICE2__C                   @"SPR14__Actual_Price2__c"
#define SPR14__WORK_DESCRIPTION__C                @"SPR14__Work_Description__c"
#define SPR14__DISCOUNT__C                        @"SPR14__Discount__c"
#define SPR14__PRODUCT2__NAME                     @"SPR14__Product2__Name"
#define SPR14__ACTIVITY_TYPE__C                   @"SPR14__Activity_Type__c"
#define SPR14__EXPENSE_TYPE__C                    @"SPR14__Expense_Type__c"
...
#define SPR14_BILLABLE_QUANTITY                   @"SPR14__Billable_Quantity__c"
#define SPR14_BILLABLE_PRICE                      @"SPR14__Billable_Line_Price__c"
...
//Service Report
#define SPR14__NAME__C                           @"SPR14__Name__c"
#define SPR14__DESCRIPTION__C                    @"SPR14__Description__c"
#define SPR14__MODULEID__C                       @"SPR14__ModuleID__c" 
#define SPR14__ISSTANDARD__C                     @"SPR14__IsStandard__c"
#define SPR14__SUBMODULEID__C                    @"SPR14__SubmoduleID__c"
#define SPR14__SETTINGID__C                      @"SPR14__SettingID__c"
#define SPR14__SETTING_UNIQUE_ID__C              @"SPR14__Setting_Unique_ID__c"
#define SPR14__SETTINGS_NAME__C                  @"SPR14__Settings_Name__c"
#define SPR14__DATA_TYPE__C                      @"SPR14__Data_Type__c"
#define SPR14__VALUES__C                         @"SPR14__Values__c"
#define SPR14__DEFAULT_VALUE__C                  @"SPR14__Default_Value__c"
#define SPR14__SETTING_TYPE__C                   @"SPR14__Setting_Type__c"
#define SPR14__SEARCH_ORDER__C                   @"SPR14__Search_Order__c"
#define SPR14__ISPRIVATE__C                      @"SPR14__IsPrivate__c"
#define SPR14__ACTIVE__C                         @"SPR14__Active__c"
#define SPR14__PROFILE_NAME__C                   @"SPR14__Profile_Name__c"
#define SPR14__ISDEFAULT__C                      @"SPR14__IsDefault__c"
#define SPR14__SETTING_CONFIGURATION_PROFILE__C  @"SPR14__Setting_Configuration_Profile__c"
#define SPR14__SETTING_ID__C                     @"SPR14__Setting_ID__c"
#define SPR14__INTERNAL_VALUE__C                 @"SPR14__Internal_Value__c"
#define SPR14__DISPLAY_VALUE__C                  @"SPR14__Display_Value__c"
#define SPR14__SUBMODULE__C                      @"SPR14__Submodule__c"
#define API_NAME                                 @"api_name"
#define TYPE                                     @"type"
#define LABEL                                    @"label"
#define SPR14__BILLABLE_COST2__C                 @"SPR14__Billable_Cost2__c"
