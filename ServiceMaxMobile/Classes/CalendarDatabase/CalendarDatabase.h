...
//delete signature by name for OPDoc
...
#define DATABASETYPE   @"sqlite"
#define _ID                                       @"Id"
#define SVMXDEV__PRODUCT__C                         @"SVMXDEV__Product__c"
#define SVMXDEV__ACTUAL_QUANTITY2__C                @"SVMXDEV__Actual_Quantity2__c"
#define SVMXDEV__ACTUAL_PRICE2__C                   @"SVMXDEV__Actual_Price2__c"
#define SVMXDEV__WORK_DESCRIPTION__C                @"SVMXDEV__Work_Description__c"
#define SVMXDEV__DISCOUNT__C                        @"SVMXDEV__Discount__c"
#define SVMXDEV__PRODUCT2__NAME                     @"SVMXDEV__Product2__Name"
#define SVMXDEV__ACTIVITY_TYPE__C                   @"SVMXDEV__Activity_Type__c"
#define SVMXDEV__EXPENSE_TYPE__C                    @"SVMXDEV__Expense_Type__c"
...
#define SVMXDEV_BILLABLE_QUANTITY                   @"SVMXDEV__Billable_Quantity__c"
#define SVMXDEV_BILLABLE_PRICE                      @"SVMXDEV__Billable_Line_Price__c"
...
//Service Report
#define SVMXDEV__NAME__C                           @"SVMXDEV__Name__c"
#define SVMXDEV__DESCRIPTION__C                    @"SVMXDEV__Description__c"
#define SVMXDEV__MODULEID__C                       @"SVMXDEV__ModuleID__c" 
#define SVMXDEV__ISSTANDARD__C                     @"SVMXDEV__IsStandard__c"
#define SVMXDEV__SUBMODULEID__C                    @"SVMXDEV__SubmoduleID__c"
#define SVMXDEV__SETTINGID__C                      @"SVMXDEV__SettingID__c"
#define SVMXDEV__SETTING_UNIQUE_ID__C              @"SVMXDEV__Setting_Unique_ID__c"
#define SVMXDEV__SETTINGS_NAME__C                  @"SVMXDEV__Settings_Name__c"
#define SVMXDEV__DATA_TYPE__C                      @"SVMXDEV__Data_Type__c"
#define SVMXDEV__VALUES__C                         @"SVMXDEV__Values__c"
#define SVMXDEV__DEFAULT_VALUE__C                  @"SVMXDEV__Default_Value__c"
#define SVMXDEV__SETTING_TYPE__C                   @"SVMXDEV__Setting_Type__c"
#define SVMXDEV__SEARCH_ORDER__C                   @"SVMXDEV__Search_Order__c"
#define SVMXDEV__ISPRIVATE__C                      @"SVMXDEV__IsPrivate__c"
#define SVMXDEV__ACTIVE__C                         @"SVMXDEV__Active__c"
#define SVMXDEV__PROFILE_NAME__C                   @"SVMXDEV__Profile_Name__c"
#define SVMXDEV__ISDEFAULT__C                      @"SVMXDEV__IsDefault__c"
#define SVMXDEV__SETTING_CONFIGURATION_PROFILE__C  @"SVMXDEV__Setting_Configuration_Profile__c"
#define SVMXDEV__SETTING_ID__C                     @"SVMXDEV__Setting_ID__c"
#define SVMXDEV__INTERNAL_VALUE__C                 @"SVMXDEV__Internal_Value__c"
#define SVMXDEV__DISPLAY_VALUE__C                  @"SVMXDEV__Display_Value__c"
#define SVMXDEV__SUBMODULE__C                      @"SVMXDEV__Submodule__c"
#define API_NAME                                 @"api_name"
#define TYPE                                     @"type"
#define LABEL                                    @"label"
#define SVMXDEV__BILLABLE_COST2__C                 @"SVMXDEV__Billable_Cost2__c"
