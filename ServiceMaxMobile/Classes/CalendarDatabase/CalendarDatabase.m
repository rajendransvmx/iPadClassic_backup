...
-(void)syncOutPutDoc
{
    ...
    for(NSMutableDictionary *dict in opdocsArray) {
        ...
        NSString *opdocName = [NSString stringWithFormat:@"%@",docName]; /*** Changed the recreation of doc name for sum'13 OPDoc change implementation 17/09/2013 ***/
