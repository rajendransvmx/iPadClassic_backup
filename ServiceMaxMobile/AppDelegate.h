...
#define kMinPkgForSVMXJobLogs                   @"12.10000"
#define kMinPkgForAttachment                    @"12.10000"//9270
#define kMinPkgForDataPurge                     @"14.19100"  //Modified the value for Data Purge version check

//OAuth
#define KEYCHAIN_SERVICE						@"ServiceMaxMobile"
#define kMinPkgForLookupFilters                 11.2
#define kWSExecutionDuration                    5.0
...
<UIApplicationDelegate, UIActionSheetDelegate, WSInterfaceDelegate,MFMailComposeViewControllerDelegate,DetailViewControllerDelegate>
{
    ...
    INTF_WebServicesDefServiceSvc_SVMXDEVlient  * SVMXDEV_client;
    
    //sync_override
    DATA_SYNC_TYPE data_sync_type;
}

@property (nonatomic,retain) AttachmentDatabase *attachmentDataBase;
//7444
...
@property (nonatomic, assign)BOOL isEventSyncTimerTriggered;
...
@property (nonatomic,retain) NSArray * code_snippet_ids;
...
@property (nonatomic, assign) BOOL eventSyncRunning, metaSyncRunning, dataSyncRunning, pushLogRunning;
...
/** Pushpak 10734
 * Flag to know whether to retrigger datasync on invalid session
 */
@property BOOL didDataSyncFailWithInvalidSession;
/** Pushpak 10734
 * Flag to know whether is autorestarted datasync on invalid session
 */
@property BOOL didAutoRestartedDataSyncFailedWithInvalidSession;
 ...
 * Centralized method to know whether remote access is revoked.
 */
...
//008303 - Defect Fix
@property (nonatomic , retain) NSString * expressionId;
