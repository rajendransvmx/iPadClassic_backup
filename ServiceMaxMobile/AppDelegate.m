...
- (NSMutableArray *) getWeekdates:(NSString *)date
{
    ...
    //Defect - 11946
    NSDate *newDate = [beginningOfWeek dateByAddingTimeInterval:-(60*60*24)];
  ...
  //  NSDate *endOfWeek = [beginningOfWeek dateByAddingTimeInterval:86400*6];
    NSDate *endOfWeek = [beginningOfWeek dateByAddingTimeInterval:86400*8];
    NSString *end = [formatter stringFromDate:endOfWeek];
    
    // NSDate *newEndDate = [endOfWeek dateByAddingTimeInterval:(60*60*24)];
