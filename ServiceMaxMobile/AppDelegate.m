...
/**
 * Pushpak
 * Modification as required for defect 10734 : GE issue - 13942
 */
...
//Copying method from sum 14 IOS8 for Defect: 011946
...
- (NSMutableArray *) getWeekdates:(NSString *)date
{
    ...
    //Defect - 11946
    //Here we are subtracting 1 day from Start date
    ...
    //Here we are Adding 2 day from Start date for 1 day margin both side
...
- (void) setSyncStatus:(SYNC_STATUS)_SyncStatus_
{
	...
	[self performSelectorOnMainThread:@selector(setSyncStatus2) withObject:nil waitUntilDone:YES];
}
