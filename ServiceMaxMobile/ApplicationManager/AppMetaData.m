...
- (void)loadApplicationMetaData
{
    ...
    currentOSVersion= [currentDevice systemVersion];
    
    currentApplicationVersion = [[NSBundle mainBundle]
                            objectForInfoDictionaryKey:(NSString *)kCFBundleVersionKey];
    
    NSString *devVersion = deviceName();
    
    currentDeviceVersion = devVersion;
    ...
    clientInfo = [NSMutableDictionary dictionary];
