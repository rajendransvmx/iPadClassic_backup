...
- (void) setSignImageData:(NSData *)imageData
{
    ...
    NSString * fileName = appDelegate.sfmPageController.detailView.currentRecordId;
    if ([fileName length] > 15){
        fileName = [appDelegate.sfmPageController.detailView.currentRecordId substringToIndex:15];
    }
