...
- (void) SignatureDone
{
    ...
    NSInteger id_value = [workOrderNumber intValue];
    
    [AppDelegate.calDataBase insertSignatureData:encryptedImage WithId:id_value RecordId:recordId apiName:objectApiName WONumber:WONumner];
}
