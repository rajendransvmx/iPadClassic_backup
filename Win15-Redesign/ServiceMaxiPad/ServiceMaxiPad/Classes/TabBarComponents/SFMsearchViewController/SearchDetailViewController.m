...
#define kIncludeOnlineItemsProgressTag 20
...
- (void) addTableViewFooter {
    ...
    UIActivityIndicatorView *searchProgressIndicator = [[UIActivityIndicatorView alloc] initWithFrame:frame];
    ...
    searchProgressIndicator.tag = kIncludeOnlineItemsProgressTag;
...
-(void)startOnlineSearchProgress:(BOOL)status {
    UIActivityIndicatorView *indicatorView = (UIActivityIndicatorView *)[self.view viewWithTag:kIncludeOnlineItemsProgressTag];
    if (status) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!isOnlineRecord) {
        ...
        normalImage = [UIImage imageNamed:@"File in Cloud - 70"];
    }
