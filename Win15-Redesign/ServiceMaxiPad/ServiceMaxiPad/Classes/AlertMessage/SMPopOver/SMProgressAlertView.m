...
- (void)drawMessages:(NSArray *)messages
{
    for (int i = 0; i < [messages count]; i++)
    {
        ...
        label.font= [UIFont fontWithName:@"HelveticaNeue-Regular" size:kFontSize15];
        ...
        {
            heightToAdjust = heightToAdjust + label.frame.size.height;
        }
        else
        {
            heightToAdjust = heightToAdjust + label.frame.size.height + 22.0f;
        }
