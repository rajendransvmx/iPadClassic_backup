...
-(void)saveRescheduledInfo:(id)sender
{
    ...
    if ([lStartDateTime compare:lEndDateTime] == NSOrderedSame) {
        UIAlertView *lAlert = [[UIAlertView alloc] initWithTitle:@"" message:@"Start time cannnot be equal to end time." delegate:nil cancelButtonTitle:[[TagManager sharedInstance]tagByName:kTagAlertErrorOk] otherButtonTitles: nil];
    ...
    {
        UIAlertView *lAlert = [[UIAlertView alloc] initWithTitle:@"" message:@"Start time cannnot later than the end time." delegate:nil cancelButtonTitle:[[TagManager sharedInstance]tagByName:kTagAlertErrorOk] otherButtonTitles: nil];
