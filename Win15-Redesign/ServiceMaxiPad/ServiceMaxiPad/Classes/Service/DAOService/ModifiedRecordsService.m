...
// added 'operation type' field
    DBRequestSelect * requestSelect = [[DBRequestSelect alloc] initWithTableName:[self tableName] andFieldNames:[NSArray arrayWithObjects:kSyncRecordLocalId,kSyncRecordObjectname,kSyncRecordType,kSyncRecordSFId,kSyncRecordOperation, nil] whereCriteria:criteriaObj];
