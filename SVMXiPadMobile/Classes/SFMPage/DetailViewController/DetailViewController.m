...
- (void) didSwitchProcess:(NSDictionary *)objectDictionary
{
    ...
    if(status)
        [self didSubmitProcess:newProcess forRecord:currentRecordId];
    else 
    {
...
-(void)fillSFMdictForOfflineforProcess:(NSString *) processId forRecord:(NSString *)recordId
{
   ...
   // databaseIntefaceSfm * database = [[databaseIntefaceSfm alloc] init];
    ...
    if([process_type isEqualToString:@"VIEWRECORD"] )
    {
        ...
        NSMutableDictionary * process_components = [appDelegate.databaseInterface  getValueMappingForlayoutId:layout_id process_id:processId objectName:headerObjName];
        ...
        for(int j= 0; j < [details count]; j++)
        {
            ...
            NSMutableDictionary * process_components = [appDelegate.databaseInterface  getValueMappingForlayoutId:detail_layout_id process_id:process_id objectName:detailObjectName];
            NSString * expressionId = [process_components objectForKey:EXPRESSION_ID];
            
            NSMutableArray * detail_values = [appDelegate.databaseInterface queryLinesInfo:details_api_keys detailObjectName:detailObjectName headerObjectName:headerObjName detailaliasName:detailaliasName headerRecordId:appDelegate.sfmPageController.recordId expressionId:expressionId];
        ...
        if([object_api_name isEqualToString:work_order] && [processType isEqualToString:@"VIEWRECORD"])
        {
            ...
            if(account_history == TRUE)
            {
                ...
                {
                    NSMutableArray * accountHistory = [appDelegate.databaseInterface getAccountHistoryForanWorkOrder:appDelegate.sfmPageController.recordId account_id:account_id tableName:headerObjName ];
            ...
            if(product_history == TRUE)
            {
                ...
                {
                    productHistory = [appDelegate.databaseInterface getProductHistoryForanWorkOrder:appDelegate.sfmPageController.recordId filedName:@"SVMXC__Top_Level__c" tableName:headerObjName fieldValue:toplevelId];
                }
                if(componentId != nil && [componentId length] != 0)
                {
                    productHistory = [appDelegate.databaseInterface getProductHistoryForanWorkOrder:appDelegate.sfmPageController.recordId filedName:@"SVMXC__Component__c" tableName:headerObjName fieldValue:componentId];
                }
   ...
   // [self didReceivePageLayoutForOffline:page_layoutInfo withDescribeObjectsForOffline:nil];
...
- (void) action:(id)sender
{
    ...
    NSMutableArray * headerButtons = [[headerDataDictionary objectForKey:gHEADER_BUTTONS] mutableCopy];
    ...
    if(appDelegate.isWorkinginOffline)
    {
        ...
        NSMutableDictionary * wizard_dict =[appDelegate.databaseInterface getWizardInformationForObjectname:heder_object_name record_id:appDelegate.sfmPageController.recordId];
        NSMutableArray * buttonsArray_offline  = [wizard_dict objectForKey:SFW_WIZARD_BUTTONS];
        
        
        // Insert 3 buttons at the beginning
        NSMutableArray * keys = nil, * objects = nil, *keys_event = nil, *objects_event = nil;
        ...
        if ([[appDelegate.SFMPage objectForKey:gPROCESSTYPE] isEqualToString:@"VIEWRECORD"]) 
        {
            ...
            NSString  *  header_object_name = [header_sfm objectForKey:gHEADER_OBJECT_NAME];

            [buttonsArray_offline addObject:dict_events_summury];
    ...
    else
    {
        ...
        keys_event = [NSMutableArray arrayWithObjects:gBUTTON_EVENT_CALL_TYPE,gBUTTON_EVENT_TYPE,gBUTTON_EVENT_TARGET_CALL,nil];
        objects_event = [NSMutableArray arrayWithObjects:gBUTTON_TYPE_TDM_IPAD_ONLY, @"standard", cancel, nil];
        NSMutableDictionary * dict_events_cancel = [NSMutableDictionary dictionaryWithObjects:objects_event forKeys:keys_event];
        NSArray * dict_events_cancel_array = [NSArray arrayWithObjects:dict_events_cancel, nil];

        keys_event = [NSMutableArray arrayWithObjects:gBUTTON_EVENT_CALL_TYPE,gBUTTON_EVENT_TYPE,gBUTTON_EVENT_TARGET_CALL,nil];
        objects_event = [NSMutableArray arrayWithObjects:gBUTTON_TYPE_TDM_IPAD_ONLY, @"standard", save, nil];
        NSMutableDictionary * dict_events_save = [NSMutableDictionary dictionaryWithObjects:objects_event forKeys:keys_event];
        NSArray * dict_events_save_array = [NSArray arrayWithObjects:dict_events_save, nil];

        keys_event = [NSMutableArray arrayWithObjects:gBUTTON_EVENT_CALL_TYPE,gBUTTON_EVENT_TYPE,gBUTTON_EVENT_TARGET_CALL,nil];
        objects_event = [NSMutableArray arrayWithObjects:gBUTTON_TYPE_TDM_IPAD_ONLY, @"standard", quick_save, nil];
        NSMutableDictionary * dict_events_quick_save = [NSMutableDictionary dictionaryWithObjects:objects_event forKeys:keys_event];
        NSArray * dict_events_quick_save_array = [NSArray arrayWithObjects:dict_events_quick_save, nil];

        keys_event = [NSMutableArray arrayWithObjects:gBUTTON_EVENT_CALL_TYPE,gBUTTON_EVENT_TYPE,gBUTTON_EVENT_TARGET_CALL,nil];
        objects_event = [NSMutableArray arrayWithObjects:gBUTTON_TYPE_TDM_IPAD_ONLY, @"standard", summary, nil];
        NSMutableDictionary * dict_events_summary = [NSMutableDictionary dictionaryWithObjects:objects_event forKeys:keys_event];
        NSArray * dict_events_summary_array = [NSArray arrayWithObjects:dict_events_summary, nil];

        keys_event = [NSMutableArray arrayWithObjects:gBUTTON_EVENT_CALL_TYPE,gBUTTON_EVENT_TYPE,gBUTTON_EVENT_TARGET_CALL,nil];
        objects_event = [NSMutableArray arrayWithObjects:gBUTTON_TYPE_TDM_IPAD_ONLY, @"standard", troubleShooting, nil];
        NSMutableDictionary * dict_troubleshooting = [NSMutableDictionary dictionaryWithObjects:objects_event forKeys:keys_event];
        NSArray * dict_troubleshooting_array = [NSArray arrayWithObjects:dict_troubleshooting, nil];

        keys_event = [NSMutableArray arrayWithObjects:gBUTTON_EVENT_CALL_TYPE,gBUTTON_EVENT_TYPE,gBUTTON_EVENT_TARGET_CALL,nil];
        objects_event = [NSMutableArray arrayWithObjects:gBUTTON_TYPE_TDM_IPAD_ONLY, @"standard", chatter, nil];
        NSMutableDictionary * dict_chatter = [NSMutableDictionary dictionaryWithObjects:objects_event forKeys:keys_event];
        NSArray * dict_chatter_array = [NSArray arrayWithObjects:dict_chatter, nil];
        ...
        if ([[appDelegate.SFMPage objectForKey:gPROCESSTYPE] isEqualToString:@"VIEWRECORD"]) 
        {
           ...
           //if process type is work Order then  add trouble shooting
            NSDictionary *  header_sfm = [appDelegate.SFMPage objectForKey:@"header"];
            NSString  *  header_object_name = [header_sfm objectForKey:gHEADER_OBJECT_NAME];
            ...
            if([header_object_name hasSuffix:@"Service_Order__c"])
            {
                ...
                BOOL enable_troubleshooting = [[header_sfm objectForKey:gENABLE_TROUBLESHOOTING] boolValue];
                if(enable_troubleshooting)
                {
                    keys = [NSMutableArray arrayWithObjects:gBUTTON_TITLE,gBUTTON_EVENTS, nil];
                    objects = [NSMutableArray arrayWithObjects:troubleShooting,dict_troubleshooting_array, nil];
                    dict = [NSMutableDictionary dictionaryWithObjects:objects forKeys:keys];
                    [headerButtons insertObject:dict atIndex:0];
                }
                
                BOOL enable_summary = [[header_sfm objectForKey:gENABLE_SUMMARY] boolValue];
                if(enable_summary)
                {
                    keys = [NSMutableArray arrayWithObjects:gBUTTON_TITLE,gBUTTON_EVENTS, nil];
                    objects = [NSMutableArray arrayWithObjects:summary,dict_events_summary_array, nil];
                    dict = [NSMutableDictionary dictionaryWithObjects:objects forKeys:keys];
                    [headerButtons addObject:dict];
                }
            }
            
            //  if chatter - enabled
            BOOL enable_chatter = [[header_sfm objectForKey:gENABLE_CHATTER] boolValue];
            if(enable_chatter)
            {
                keys = [NSMutableArray arrayWithObjects:gBUTTON_TITLE,gBUTTON_EVENTS, nil];
                objects = [NSMutableArray arrayWithObjects:chatter,dict_chatter_array, nil];
                dict = [NSMutableDictionary dictionaryWithObjects:objects forKeys:keys];
                [headerButtons insertObject:dict atIndex:0];
            }
        }  
        ...
        {
            keys = [NSMutableArray arrayWithObjects:gBUTTON_TITLE,gBUTTON_EVENTS, nil];
            objects = [NSMutableArray arrayWithObjects:cancel,dict_events_cancel_array, nil];
            NSMutableDictionary * dict = [NSMutableDictionary dictionaryWithObjects:objects forKeys:keys];
            [headerButtons insertObject:dict atIndex:0];
            
            keys = [NSMutableArray arrayWithObjects:gBUTTON_TITLE, gBUTTON_EVENTS, nil];
            objects = [NSMutableArray arrayWithObjects:save,dict_events_save_array, nil];
            dict = [NSMutableDictionary dictionaryWithObjects:objects forKeys:keys];
            [headerButtons insertObject:dict atIndex:0];
            
            keys = [NSMutableArray arrayWithObjects:gBUTTON_TITLE,gBUTTON_EVENTS, nil];
            objects = [NSMutableArray arrayWithObjects:quick_save,dict_events_quick_save_array, nil];
            dict = [NSMutableDictionary dictionaryWithObjects:objects forKeys:keys];
            [headerButtons insertObject:dict atIndex:0];
        }  
        if([[appDelegate.SFMPage objectForKey:gPROCESSTYPE] isEqualToString:@"STANDALONECREATE"] || [[appDelegate.SFMPage objectForKey:gPROCESSTYPE] isEqualToString:@"SOURCETOTARGET"]||[[appDelegate.SFMPage objectForKey:gPROCESSTYPE] isEqualToString:@"SOURCETOTARGETONLYCHILDROWS"])
    ...
    if (appDelegate.SFMPage != nil)
    {
        //actionMenu.buttons = headerButtons;
        //[headerButtons release];
...
- (void) didFinishWithError:(SOAPFault *)sFault
{
    ...
    UIAlertView * _alert = [[UIAlertView alloc] initWithTitle:response_error message:sFault.faultstring delegate:nil cancelButtonTitle:alert_ok otherButtonTitles:nil];
    [_alert show];
    [_alert release];
}
...
- (void) didInvokeWebService:(NSString *)targetCall
{
    ...
    while (CFRunLoopRunInMode( kCFRunLoopDefaultMode, 1, FALSE))
    {
        NSLog(@"didInvokeWebService In While Loop");
        if (!appDelegate.isInternetConnectionAvailable)
        {
            [activity stopAnimating];
            [appDelegate displayNoInternetAvailable];
...
- (void) startSummaryDataFetch
{
    ...
    if(isworkingInOffline)
    {
        ...
        Parts = [appDelegate.database queryForParts:currentRecordId];
        
        Expenses =[appDelegate.database queryForExpenses:currentRecordId];
        
        
        LabourValuesDictionary = [appDelegate.database  queryForLabor:currentRecordId];
        
        reportEssentials  = [[appDelegate.database getReportEssentials:currentRecordId] retain];
		...
		else // Display the column values for the row
		{
...

            {
                ...
                for (int j = 0; j < columns; j++)
                {
                        ...
                        {
                            UIImageView *v1;
                            if ([value isEqualToString:@"True"] || [value isEqualToString:@"true"] ) 
                            {
...
//        isCellNew = NO;
	...
	else if (selectedSection == SHOW_LINES_ROW || selectedSection == SHOWALL_LINES)
	{
		...
		else //display the column values for the row
		{
			...
			for (int j = 0; j < columns && j < [detail_values count]; j++)
			{
                CGRect frame =  CGRectMake(j*field_width, 6, field_width-4,control_height-6);
                ...
                if ( [field_data_type isEqualToString:@"boolean"] )
                {
                    ...
                    if ([control_value isEqualToString:@"True"] || [control_value isEqualToString:@"true"]) 
                    {
                        v1 = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"SFM-Screen-boolean-tick-Icon.png"]] autorelease];
                        v1.backgroundColor = [UIColor clearColor];
...
//        oldBackgroundView = [[cell.contentView subviews] objectAtIndex:0];
    ...
    if ([control_type isEqualToString:@"reference"] && [fieldAPIName isEqualToString:@"RecordTypeId"])
    {
        ...
        if([refObjSearchId isEqualToString:@""])
        {
            ...
            while (CFRunLoopRunInMode(kCFRunLoopDefaultMode, 0, FALSE)) 
            {
                NSLog(@"SFMEditDetailCellForTable in while loop");
                if (!appDelegate.isInternetConnectionAvailable)
                {
                    [activity stopAnimating];
                    appDelegate.wsInterface.sfm_response = FALSE;
...
- (void) accessoryTapped:(id)sender
{
    if(appDelegate.isWorkinginOffline)
    {
        ...
        NSMutableDictionary * process_components = [appDelegate.databaseInterface  getValueMappingForlayoutId:layout_id process_id:process_id objectName:detailObjectName];
...
-(void)offlineActions:(NSDictionary *)buttonDict
{
   ...
   // NSString * targetCall = [buttonDict objectForKey:gBUTTON_EVENT_TARGET_CALL];
   // NSString * callType   = [buttonDict objectForKey:gBUTTON_EVENT_CALL_TYPE];
    //NSString * eventType  = [buttonDict objectForKey:gBUTTON_EVENT_TYPE];
        ...
        if([targetCall isEqualToString:save])
        {
            ...
            if(data_inserted)
            {
                ...
                for (int i=0;i<[details count];i++) //parts, labor, expense for instance
                {
                    ...
                    NSMutableDictionary * process_components = [appDelegate.databaseInterface  getValueMappingForlayoutId:detail_layout_id process_id:processId objectName:detail_object_name];
                    ...
                    NSString *parent_column_name = [appDelegate.databaseInterface getParentColumnNameFormChildInfoTable:SFChildRelationShip childApiName:detail_object_name parentApiName:headerObjName];
                ...
                [created_object_info setObject:headerObjName forKey:OBJECT_NAME];
                [created_object_info setObject:@"1CustIPAD-012" forKey:gPROCESS_ID];
                [created_object_info setObject:date_str forKey:gDATE_TODAY];
                [created_object_info setObject:header_record_local_id forKey:RESULTID];
                [created_object_info setObject:@"Work Order" forKey:NAME_FIELD];
                [created_object_info setObject:object_label forKey:OBJECT_LABEL];
                
                [self initAllrequriredDetailsForProcessId:@"1CustIPAD-012" recordId:header_record_local_id object_name:headerObjName];
                [appDelegate.wsInterface saveDictionaryToPList:created_object_info];
                
                [self fillSFMdictForOfflineforProcess:@"1CustIPAD-012" forRecord:header_record_local_id ];
                [self didReceivePageLayoutOffline];
