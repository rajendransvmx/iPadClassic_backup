...
- (void) addNewTask:(NSMutableArray*)task;
{
   ...
   // [tasks addObject:task];
    ...
    //Shrinivas
    [appDelegate.database insertTasksIntoDB:task WithDate:activityDate];
    NSString *Id = [appDelegate.database retreiveCurrentTaskIdCreated];
...
- (void) tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [appDelegate.database deleteTaskFromDB:[[tasks objectAtIndex:indexPath.row] objectAtIndex:3]];
