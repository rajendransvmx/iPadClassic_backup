...
-(IBAction)callLogin:(id)sender
{
   ...
   // BOOL retVal = [appDelegate.calDataBase isUsernamePresent:txtUsernameLandscape.text password:txtPasswordLandscape.text];
    ...
    if ( retVal == YES )
    {
       // appDelegate.wsInterface.tagsDictionary = [appDelegate.wsInterface getDefaultTags];
        ...
        appDelegate.wsInterface.eventArray = [appDelegate.calDataBase GetEventsFromDBWithStartDate:startDate  endDate:endDate];
